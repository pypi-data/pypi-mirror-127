...
class ServerDB:
    ...
    class ActiveUsers:
        def __init__(self, user_id, ip_address, login_time):
            self.user = user_id
    ...
    def user_login(self, username, ip_address, key):
        ...
        new_active_user = self.ActiveUsers(user.id, ip_address, datetime.datetime.now())
        self.session.add(new_active_user)

        history = self.LoginHistory(user.id, datetime.datetime.now(), ip_address)
