...
class MaterializedFeatureView(FeatureDefinition):
    ...
    def run(
        ...
        **mock_inputs: DataFrame,
        ...
        :param aggregate_tiles: This only works with aggregate FeatureView types. Enables the result aggregation for the
            rows within the same slide as specified in param:aggregation_slide_period in FeatureView definition.
            This flag will be ignored if fully_rollup_tiles is set.
        :param fully_rollup_tiles: This only works with aggregate FeatureView types. Enables the full aggregation over
        ...
        """
        if (aggregate_tiles or fully_rollup_tiles) and not self._args.HasField("temporal_aggregate_args"):
            raise FV_UNSUPPORTED_ARG("aggregate_tiles, fully_rollup_tiles")
        ...
        if not (aggregate_tiles or fully_rollup_tiles):
            return df
