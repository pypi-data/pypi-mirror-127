Thai Language Toolkit Project  version 1.4.0
============================================
...
Updates:
--------
Version 1.4 update for gensim 4.0, Users can load a Thai corpus using Corpus() and create a model from W2V_train(), D2V_train(). TNC pretained w2v model is TNCc5model2.bin  
...
>>tltk.corpus.Corpus(DIR,filetype="xxx") create a list of paragraphs from files in DIR. The default file type is .txt  Files have to be word-segmented before, e.g. w1|w2|w3|w4 ...
