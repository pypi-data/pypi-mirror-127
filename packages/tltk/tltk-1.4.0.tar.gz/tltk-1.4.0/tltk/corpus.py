...
# -*- coding: utf-8 -*-
#########################################################
## Thai Language Toolkit : version  1.4.0
## Chulalongkorn University
## written by Wirote Aroonmanakun
## Implemented :
##      upgrade to gensim 4.0
##      Corpus(DIR), W2V_train(Corpus), D2V_train(Corpus)
...
def Corpus(dir, sep="par", lang="th",stopword="y", filetype="txt"):
...
def w2v_load():
    ...
    ATA_PATH = os.path.dirname(path)
    try:
        w2v_model = Word2Vec.load(ATA_PATH +'/' +"TNCc5model2.bin")
    except IOError:
        w2v_model = Word2Vec.load("TNCc5model2.bin")
    return(1)
...
pars = Corpus('/Users/macbook/Cloud/Dropbox/Corpus/Thaipublica/wsg',filetype="wsg")
print(pars[0:3])
#train Doc2Vec model
