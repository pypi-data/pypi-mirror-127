...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=NpIsT
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:NpIsE)->NpIsE:
  pass
 @NpIsA
 def get(cls,requested_file_locator:NpIsE):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=NpIsT
 @NpIsA
 def get(cls,state_file_locator:NpIsE,requested_storage:NpIsE,serializers:Dict[NpIsE,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[NpIsE,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:NpIsE)->NpIsE:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:NpIsE)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:NpIsE)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:NpIsE)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:NpIsE)->NpIsE:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[NpIsE]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:NpIsE,new_key:NpIsE,referenced_by_version:NpIsE=NpIsT):
  pass
 @abc.abstractmethod
 def version_exists(self,key:NpIsE)->NpIsW:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:NpIsE,key:NpIsE):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:NpIsE,new_key:NpIsE,base_path:NpIsE)->NpIsW:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[NpIsE]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[NpIsE,NpIsE],remote_location:NpIsE=NpIsT)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[NpIsE]:
  ...
  for cpvcs_obj in args:
   if NpIsw(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif NpIsw(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[NpIsE,NpIsE],remote_location:NpIsE=NpIsT)->List[Union[Revision,Version]]:
