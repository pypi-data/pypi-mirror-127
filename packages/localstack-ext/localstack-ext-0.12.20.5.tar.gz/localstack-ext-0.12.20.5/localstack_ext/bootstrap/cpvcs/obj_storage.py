...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=YWUuq
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:YWUus)->YWUus:
  pass
 @YWUuJ
 def get(cls,requested_file_locator:YWUus):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=YWUuq
 @YWUuJ
 def get(cls,state_file_locator:YWUus,requested_storage:YWUus,serializers:Dict[YWUus,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[YWUus,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:YWUus)->YWUus:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:YWUus)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:YWUus)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:YWUus)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:YWUus)->YWUus:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[YWUus]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:YWUus,new_key:YWUus,referenced_by_version:YWUus=YWUuq):
  pass
 @abc.abstractmethod
 def version_exists(self,key:YWUus)->YWUue:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:YWUus,key:YWUus):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:YWUus,new_key:YWUus,base_path:YWUus)->YWUue:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[YWUus]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[YWUus,YWUus],remote_location:YWUus=YWUuq)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[YWUus]:
  ...
  for cpvcs_obj in args:
   if YWUun(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif YWUun(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[YWUus,YWUus],remote_location:YWUus=YWUuq)->List[Union[Revision,Version]]:
