...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=LWkJv
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:LWkJA)->LWkJA:
  pass
 @LWkJr
 def get(cls,requested_file_locator:LWkJA):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=LWkJv
 @LWkJr
 def get(cls,state_file_locator:LWkJA,requested_storage:LWkJA,serializers:Dict[LWkJA,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[LWkJA,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:LWkJA)->LWkJA:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:LWkJA)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:LWkJA)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:LWkJA)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:LWkJA)->LWkJA:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[LWkJA]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:LWkJA,new_key:LWkJA,referenced_by_version:LWkJA=LWkJv):
  pass
 @abc.abstractmethod
 def version_exists(self,key:LWkJA)->LWkJm:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:LWkJA,key:LWkJA):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:LWkJA,new_key:LWkJA,base_path:LWkJA)->LWkJm:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[LWkJA]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[LWkJA,LWkJA],remote_location:LWkJA=LWkJv)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[LWkJA]:
  ...
  for cpvcs_obj in args:
   if LWkJx(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif LWkJx(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[LWkJA,LWkJA],remote_location:LWkJA=LWkJv)->List[Union[Revision,Version]]:
