...
def register_localstack_plugins():
 ...
 if EfkdM([is_api_enabled(api)for api in EXTERNAL_PORT_APIS]):
...
def load_plugin_files():
 try:
  ...
  if "No module named" not in EfkdB(e):
...
def api_key_configured():
 return Efkdj(os.environ.get("LOCALSTACK_API_KEY"))
