...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=ANHXv
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:ANHXE)->ANHXE:
  pass
 @ANHXa
 def get(cls,requested_file_locator:ANHXE):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=ANHXv
 @ANHXa
 def get(cls,state_file_locator:ANHXE,requested_storage:ANHXE,serializers:Dict[ANHXE,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[ANHXE,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:ANHXE)->ANHXE:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:ANHXE)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:ANHXE)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:ANHXE)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:ANHXE)->ANHXE:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[ANHXE]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:ANHXE,new_key:ANHXE,referenced_by_version:ANHXE=ANHXv):
  pass
 @abc.abstractmethod
 def version_exists(self,key:ANHXE)->ANHXl:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:ANHXE,key:ANHXE):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:ANHXE,new_key:ANHXE,base_path:ANHXE)->ANHXl:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[ANHXE]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[ANHXE,ANHXE],remote_location:ANHXE=ANHXv)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[ANHXE]:
  ...
  for cpvcs_obj in args:
   if ANHXU(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif ANHXU(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[ANHXE,ANHXE],remote_location:ANHXE=ANHXv)->List[Union[Revision,Version]]:
