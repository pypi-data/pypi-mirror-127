...
class InvoiceSDK:
    ...
    def generate_B2C_invoice_data(self) -> Dict[str, Any]:
        ...
        invoice_data = {
            ...
            "Print": "0",
            "Donation": self.checkout.get("donation", "0"),
            "LoveCode": self.checkout.get("love_code", None),
            "CarrierType": self.checkout.get("carrier_type", "1"),
            "CarrierNum": self.checkout.get("carrier_num", ""),
            "TaxType": self.checkout.get("tax_type", "1"),
            "SalesAmount": self.checkout.get("total", 0),
            "Items": self.generate_B2C_invoice_item(items, extra_items, discount_items),
            "InvType": self.checkout.get("tax_type", "") == "4" and "08" or "07",
        }
    ...
    def generate_B2B_invoice_data(self) -> Dict[str, Any]:
        ...
        invoice_data = {
            "RelateNumber": self.checkout.get("order_number", ""),
            "CustomerIdentifier": self.checkout.get("uni_no", ""),
            "CustomerEmail": self.checkout.get("buyer_email", ""),
            "TaxType": self.checkout.get("tax_type", "1"),
