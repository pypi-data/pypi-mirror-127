...
class PREMEarth(Earth):
    ...
    def PREMLayer(self, r: "double") -> "int":
        return _darkprop.PREMEarth_PREMLayer(self, r)

    def PREM_Mass_Density(self, r: "double") -> "double":
        return _darkprop.PREMEarth_PREM_Mass_Density(self, r)
