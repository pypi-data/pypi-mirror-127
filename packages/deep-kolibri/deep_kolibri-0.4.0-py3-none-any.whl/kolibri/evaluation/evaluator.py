...
class ClassifierEvaluator(object):
    ...
    def get_performance_report(y_true=None, y_pred=None, target_names=None):
        ...
        report['f1_score_micro'] = f1_score(y_true, y_pred, average='micro')
        report['f1_score_macro'] = f1_score(y_true, y_pred, average='macro')
        report['f1_score_weighted'] = f1_score(y_true, y_pred,  average='weighted')
        report['recall_score_micro'] = recall_score(y_true=y_true, y_pred=y_pred, average='micro')
        report['recall_score_macro'] = recall_score(y_true=y_true, y_pred=y_pred, average='macro')
