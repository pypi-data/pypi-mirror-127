class Translated:
    ...
    """
    def __init__(self, src, dest, origin, text, pronunciation=None, extra_data=None):
        self.src = src
        self.dest = dest
        self.origin = origin
        self.text = text
    ...
    def __unicode__(self):  # pragma: nocover
        return (
            u'Translated(src={src}, dest={dest}, text={text}, '
            u'original_text={origin} ,extra_data={extra_data})'.format(
                src=self.src, dest=self.dest, text=self.text, origin=self.origin,
