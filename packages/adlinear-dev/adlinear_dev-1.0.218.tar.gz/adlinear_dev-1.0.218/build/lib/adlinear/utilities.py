...
def generate_random_correl_matrix(size: int, corr_max: float):
    """
     ...
     generate a random correlation matrix having an absolute maximum
...
def generate_clusterized_vectors(size: int, nbvect: int, max_inter_corr: float, min_inter_corr: float):
