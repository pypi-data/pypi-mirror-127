...
from farbox_bucket.bucket.token.utils import get_logined_bucket_by_token, get_logined_bucket_by_token_readonly_allowed
...
def sync_download_file_by_web_request(record_id, bucket=None):
    ...
    bucket = bucket or get_logined_bucket_by_token_readonly_allowed()  # by api token
    if not bucket:
