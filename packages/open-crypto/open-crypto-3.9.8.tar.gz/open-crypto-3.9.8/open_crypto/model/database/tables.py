...
from sqlalchemy import Column, Integer, String, Boolean, ForeignKey, CheckConstraint, Float, select, BigInteger
...
class Trade(Base):
    ...
    best_ask = Column(Float)
    price = Column(Float)
    _direction = Column("direction", String(5)) # This is changes from Integer to String as the Hybrid Property method
