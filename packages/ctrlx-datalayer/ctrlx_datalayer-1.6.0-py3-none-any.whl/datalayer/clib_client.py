...
import datalayer
from datalayer.clib import C_DLR_RESULT, address_c_char_p, userData_c_void_p, C_DLR_CONVERTER
...
datalayer.clib.libcomm_datalayer.DLR_clientReadJsonSync.argtypes = (
    C_DLR_CLIENT, C_DLR_CONVERTER, ctypes.c_char_p, C_DLR_VARIANT, ctypes.c_int32, ctypes.c_char_p)
datalayer.clib.libcomm_datalayer.DLR_clientReadJsonSync.restype = C_DLR_RESULT
...
datalayer.clib.libcomm_datalayer.DLR_clientWriteJsonSync.argtypes = (
    C_DLR_CLIENT, C_DLR_CONVERTER, ctypes.c_char_p, ctypes.c_char_p, C_DLR_VARIANT, ctypes.c_char_p)
datalayer.clib.libcomm_datalayer.DLR_clientWriteJsonSync.restype = C_DLR_RESULT
