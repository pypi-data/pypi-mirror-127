...
# provider_node
datalayer.clib.libcomm_datalayer.DLR_providerNodeCreate.argtypes = (
    C_DLR_PROVIDER_NODE_CALLBACKS,)
datalayer.clib.libcomm_datalayer.DLR_providerNodeCreate.restype = C_DLR_PROVIDER_NODE

datalayer.clib.libcomm_datalayer.DLR_providerNodeDelete.argtypes = (
    C_DLR_PROVIDER_NODE,)
datalayer.clib.libcomm_datalayer.DLR_providerNodeDelete.restype = None
