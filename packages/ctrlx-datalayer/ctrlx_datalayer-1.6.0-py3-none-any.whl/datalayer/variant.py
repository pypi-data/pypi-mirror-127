...
class Result(Enum):
    ...
    def _missing_(cls, value):
        ...
        if (i >= 0x80060001) and (i <= 0x80060008):
            return cls(i)
        if (i >= 0x80070001) and (i <= 0x80070004):
            return cls(i)
        return value
...
class Variant:
    ...
    def __init__(self, c_variant: C_DLR_VARIANT = None):
        ...
        if c_variant is None:
            self._variant = datalayer.clib.libcomm_datalayer.DLR_variantCreate()
        else:
            self.__closed = True
    ...
    def close(self):
        ...
        if self.__closed:
            return
        self.__closed = True
        datalayer.clib.libcomm_datalayer.DLR_variantDelete(self._variant)
    ...
    def get_type(self) -> VariantType:
        ...
        @returns <VariantType>
        """
        return VariantType(datalayer.clib.libcomm_datalayer.DLR_variantGetType(self._variant))
    ...
    def get_data(self) -> bytearray:
        ...
        """
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetSize(
            self._variant)
        c_data = ctypes.string_at(
            datalayer.clib.libcomm_datalayer.DLR_variantGetData(self._variant), length)
    ...
    def get_size(self) -> int:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetSize(self._variant)
    ...
    def get_count(self) -> int:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetCount(self._variant)
    ...
    def check_convert(self, datatype: VariantType) -> Result:
        ...
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantCheckConvert(
    ...
    def copy(c_variant: C_DLR_VARIANT):
        ...
        """
        dest = Variant()
        result = Result(datalayer.clib.libcomm_datalayer.DLR_variantCopy(
    ...
    def get_bool8(self) -> bool:
        ...
        @returns [True, False]
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetBOOL8(self._variant)
    ...
    def get_int8(self) -> int:
        ...
        @returns [-128, 127]
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetINT8(self._variant)
    ...
    def get_uint8(self) -> int:
        ...
        @returns [0, 255]
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetUINT8(self._variant)
    ...
    def get_int16(self) -> int:
        ...
        @returns [-32768, 32767]
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetINT16(self._variant)
    ...
    def get_uint16(self) -> int:
        ...
        @returns [0, 65.535]
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetUINT16(self._variant)
    ...
    def get_int32(self) -> int:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetINT32(self._variant)
    ...
    def get_uint32(self) -> int:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetUINT32(self._variant)
    ...
    def get_int64(self) -> int:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetINT64(self._variant)
    ...
    def get_uint64(self) -> int:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetUINT64(self._variant)
    ...
    def get_float32(self) -> float:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetFLOAT32(self._variant)
    ...
    def get_float64(self) -> float:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_variantGetFLOAT64(self._variant)
    ...
    def get_string(self) -> str:
        ...
        if self.check_convert(VariantType.STRING) != Result.OK:
            return None
        b = datalayer.clib.libcomm_datalayer.DLR_variantGetSTRING(
            self._variant)
        if b is None:
            return b
    ...
    def get_array_bool8(self) -> typing.List[bool]:
        ...
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfBOOL8(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
    ...
    def get_array_int8(self) -> typing.List[int]:
        ...
        if self.check_convert(VariantType.ARRAY_INT8) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfINT8(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_uint8(self) -> typing.List[int]:
        ...
        if self.check_convert(VariantType.ARRAY_UINT8) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfUINT8(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_int16(self) -> typing.List[int]:
        ...
        if self.check_convert(VariantType.ARRAY_INT16) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfINT16(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_uint16(self) -> typing.List[int]:
        ...
        if self.check_convert(VariantType.ARRAY_UINT16) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfUINT16(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_int32(self) -> typing.List[int]:
        ...
        if self.check_convert(VariantType.ARRAY_INT32) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfINT32(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_uint32(self) -> typing.List[int]:
        ...
        if self.check_convert(VariantType.ARRAY_UINT32) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfUINT32(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_int64(self) -> typing.List[int]:
        ...
        if self.check_convert(VariantType.ARRAY_INT64) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfINT64(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_uint64(self) -> typing.List[int]:
        ...
        if self.check_convert(VariantType.ARRAY_UINT64) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfUINT64(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_float32(self) -> typing.List[float]:
        ...
        if self.check_convert(VariantType.ARRAY_FLOAT32) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfFLOAT32(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_float64(self) -> typing.List[float]:
        ...
        if self.check_convert(VariantType.ARRAY_FLOAT64) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfFLOAT64(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
        return [c_data[i] for i in range(length)]
    ...
    def get_array_string(self) -> typing.List[str]:
        ...
        if self.check_convert(VariantType.ARRAY_STRING) != Result.OK:
            return None
        c_data = datalayer.clib.libcomm_datalayer.DLR_variantGetArrayOfSTRING(
            self._variant)
        length = datalayer.clib.libcomm_datalayer.DLR_variantGetCount(
            self._variant)
    ...
    def set_bool8(self, data: bool) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetBOOL8(self._variant, data))
    ...
    def set_int8(self, data: int) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetINT8(self._variant, data))
    ...
    def set_uint8(self, data: int) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetUINT8(self._variant, data))
    ...
    def set_int16(self, data: int) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetINT16(self._variant, data))
    ...
    def set_uint16(self, data: int) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetUINT16(self._variant, data))
    ...
    def set_int32(self, data: int) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetINT32(self._variant, data))
    ...
    def set_uint32(self, data: int) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetUINT32(self._variant, data))
    ...
    def set_int64(self, data: int) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetINT64(self._variant, data))
    ...
    def set_uint64(self, data: int) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetUINT64(self._variant, data))
    ...
    def set_float32(self, data: float) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetFLOAT32(self._variant, data))
    ...
    def set_float64(self, data: float) -> Result:
        ...
        @returns <Result>, status of function call
        """
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetFLOAT64(self._variant, data))
    ...
    def set_string(self, data: str) -> Result:
        ...
        return Result(datalayer.clib.libcomm_datalayer.DLR_variantSetSTRING(self._variant, b_data))
    ...
    def set_flatbuffers(self, data: bytearray) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetFlatbuffers(
    ...
    def set_array_bool8(self, data: typing.List[bool]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_BOOL8(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_int8(self, data: typing.List[int]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_INT8(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_uint8(self, data: typing.List[int]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_UINT8(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_int16(self, data: typing.List[int]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_INT16(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_uint16(self, data: typing.List[int]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_UINT16(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_int32(self, data: typing.List[int]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_INT32(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_uint32(self, data: typing.List[int]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_UINT32(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_int64(self, data: typing.List[int]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_INT64(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_uint64(self, data: typing.List[int]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_UINT64(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_float32(self, data: typing.List[float]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_FLOAT32(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_float64(self, data: typing.List[float]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_FLOAT64(
            self._variant, c_data, len(data)))
        del c_data
        return r
    ...
    def set_array_string(self, data: typing.List[str]) -> Result:
        ...
        r = Result(datalayer.clib.libcomm_datalayer.DLR_variantSetARRAY_OF_STRING(
            self._variant, c_data, len(data)))
        del c_data
        return r
