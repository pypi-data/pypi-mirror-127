...
class System:
    ...
    def __init__(self, ipc_path: str):
        ...
        self.__system = datalayer.clib.libcomm_datalayer.DLR_systemCreate(
            b_ipc_path)
        self.__closed = False
    ...
    def close(self):
        ...
        self.__closed = True
        self.stop(True)
        datalayer.clib.libcomm_datalayer.DLR_systemDelete(self.__system)
    ...
    def stop(self, bo_force_provider_stop: bool) -> bool:
        ...
        """
        return datalayer.clib.libcomm_datalayer.DLR_systemStop(
