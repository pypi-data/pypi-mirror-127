...
class AESCipherGCMSTREAMwIV_Base(AESCipherGCMSTREAM_Base):
...
class AESCipherGCMSTREAMwoIV_Base(AESCipherGCMSTREAM_Base):
    def encrypt(self, raw: str_or_bytes) -> str:
        raw = try_utf8e(raw)
        return self._cipher.encrypt(raw)
...
class AESCipherGCMSTREAM(AESCipherGCMSTREAMwIV_Base, AESCipherGCM):
    _iv: bytes = None
...
class AESCipherGCMSTREAMnoHASH(AESCipherGCMSTREAMwIV_Base, AESCipherGCMnoHASH):
    _iv: bytes = None
...
class AESCipherGCMSTREAMwoIV(AESCipherGCMSTREAMwoIV_Base, AESCipherGCMwoIV):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._cipher = self._cipher()


class AESCipherGCMSTREAMnoHASHwoIV(AESCipherGCMSTREAMwoIV_Base, AESCipherGCMnoHASHwoIV):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._cipher = self._cipher()
