...
from nanamilang.shortcuts import (
    ...
    ASSERT_LIST_LENGTH_IS_EVEN, ASSERT_EVERY_COLLECTION_ITEM_IS_INSTANCE_OF
)
...
class BuiltinMacro:
    ...
    def fn_macro(tree_slice: list, ev_func, token_cls) -> list:
        ...
        ASSERT_EVERY_COLLECTION_ITEM_IS_INSTANCE_OF(
            [x.dt() for x in but_first],
            datatypes.Undefined, 'fn: each element of fn arguments form needs to be an Undefined')
