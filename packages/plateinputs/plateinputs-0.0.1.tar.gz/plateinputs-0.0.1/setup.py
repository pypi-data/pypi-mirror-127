...
packs = find_packages(include=["plateinputs", "plateinputs.*"])
...
if __name__ == "__main__":
    setup(
        ...
        url="https://github.com/Geodels/plateInputs",
        version=PYPI_VERSION,
        license="GPLv3",
        description="A Python interface to build paleogeography forcing in goSPL",
