...
class Matrix():
    ...
    def __eq__(self, other):
        ...
        if self.dim != other.dim:
            raise ValueError(
                "Cannot compare two matrices with different dimensions")
        first = self.elements
    ...
    def __pow__(self, var):
        ...
        Args:
            var (int): the var is power chosen for the matrix
        ...
        if m == 2 and n == 2:
            ...
            raise ValueError(
                "This operation only works for 2x2 real matrix for now")
