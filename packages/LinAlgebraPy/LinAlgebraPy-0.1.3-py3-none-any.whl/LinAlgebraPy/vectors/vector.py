...
class Vector():
    ...
    def __add__(self, var):
        ...
        if type(var) in types:
            if type(var) == Vector:
                if self.dim != var.dim:
                    raise ValueError(
                        "Vectors cannot add with different number of dimensions.")
                else:
    ...
    def __eq__(self, other):
        if self.isLine and other.isLine:
            ...
            raise ValueError(
                "The dimensions of the two vectors are not equal for comparing")
...
def colinear(vect1, vect2):
    if vect1.isColumn and vect2.isColumn:
        vect1 = vect1.tranpose()
        vect2 = vect2.tranpose()
