...
class AddContactDialog(QDialog):
    ...
    def __init__(self, transport, database):
        ...
        self.setWindowTitle('Choose a contact to be added:')
        self.setAttribute(Qt.WA_DeleteOnClose)
        self.setModal(True)

        self.selector_label = QLabel('Choose a contact to be added:', self)
        ...
        self.btn_refresh = QPushButton('List update', self)
    ...
    # Обновляет таблицу известных пользователей, затем содержимое
    ...
    def update_possible_contacts(self):
        ...
        try:
            ...
            LOGGER.debug("Update users server's list has been done")
            self.possible_contacts_update()
