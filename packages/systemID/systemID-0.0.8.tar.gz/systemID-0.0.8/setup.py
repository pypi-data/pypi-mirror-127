...
setup(
    ...
    packages=["systemID", "systemID.ClassesDynamics", "systemID.ClassesGeneral", "systemID.ClassesSparseID", "systemID.ClassesSystemID", "systemID.Plotting", "systemID.SparseIDAlgorithms", "systemID.SystemIDAlgorithms"],
