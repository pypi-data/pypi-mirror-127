...
def main_Koopman(order, full_deviation_dx0, x0):
    ...
    dynamics = DuffingOscillatorDynamics(delta, alpha, beta, nominal=True, initial_states=initial_states, nominal_u=nominal_input_signal, dt=dt, tspan=tspan)
    ...
    era = ERAFromInitialConditionResponse(free_decay_experiments_deviated.output_signals, augmented_dimension, 1, p=10, q=10)
...
full_deviation_dx0 = []
number_test_trajectories = 20
number_increments = 40
r = np.linspace(0.005, 0.05, number_increments)
t = np.linspace(1, number_test_trajectories, number_test_trajectories) * 2 * np.pi / number_test_trajectories

for i in range(number_increments):
    for j in range(number_test_trajectories):
        full_deviation_dx0.append(np.array([r[i] * np.cos(t[j]), r[i] * np.sin(t[j])]))
...
for o in range(1, max_order + 1):
    ...
    output_orders.append([true_output_signals, identified_output_signals_tvera, identified_output_signals_era, free_decay_experiments, nominal_output_signal])
    for i in range(number_increments):
        for j in range(number_test_trajectories):
...
# ax.plot(true_output_signals[id].data[0, :], true_output_signals[id].data[1, :], color=colors[5], label='True')
# ax.plot(true_output_signals_order1[id].data[0, :], true_output_signals_order1[id].data[1, :], '--', color=colors[1], label='Linearized order 1')
# ax.plot(true_output_signals_order2[id].data[0, :], true_output_signals_order2[id].data[1, :], '--', color=colors[2], label='Linearized order 2')
# ax.plot(true_output_signals_order3[id].data[0, :], true_output_signals_order3[id].data[1, :], '--', color=colors[3], label='Linearized order 3')
# ax.plot(true_output_signals_order4[id].data[0, :], true_output_signals_order4[id].data[1, :], '--', color=colors[4], label='Linearized order 4')
# # ax.plot(true_output_signal_order1.data[0, :-end], true_output_signal_order1.data[1, :-end], '--', color=colors[9], label='Linearized order 1')
# # ax.plot(true_output_signal_order2.data[0, :-450], true_output_signal_order2.data[1, :-450], '--', color=colors[8], label='Linearized order 2')
# plt.xlabel(r'$x_1$')
# plt.ylabel(r'$x_2$')
...
ax.plot(nominal_output_signal.data[0, :], nominal_output_signal.data[1, :], color=colors[0], label='Nominal')
ax.plot(true_output_signals[id].data[0, :], true_output_signals[id].data[1, :], color=colors[5], label='True')
ax.plot(true_output_signals_order1[id].data[0, :], true_output_signals_order1[id].data[1, :], '--', color=colors[1], label='Taylor order 1')
ax.plot(true_output_signals_order2[id].data[0, :], true_output_signals_order2[id].data[1, :], '--', color=colors[2], label='Linearized order 2')
ax.plot(true_output_signals_order3[id].data[0, :], true_output_signals_order3[id].data[1, :], '--', color=colors[3], label='Linearized order 3')
ax.plot(true_output_signals_order4[id].data[0, :], true_output_signals_order4[id].data[1, :], '--', color=colors[4], label='Linearized order 4')
ax.plot(output_orders[0][1][id].data[0, :-end], output_orders[0][1][id].data[1, :-end], color=colors[1], label='TVKO order 1')
ax.plot(output_orders[1][1][id].data[0, :-end], output_orders[1][1][id].data[1, :-end], color=colors[2], label='TVKO order 2')
ax.plot(output_orders[2][1][id].data[0, :-end], output_orders[2][1][id].data[1, :-end], color=colors[3], label='TVKO order 3')
ax.plot(output_orders[3][1][id].data[0, :-end], output_orders[3][1][id].data[1, :-end], color=colors[4], label='TVKO order 4')
# ax.plot(output_orders[4][1][id].data[0, :-end], output_orders[4][1][id].data[1, :-end], color=colors[6], label='TVKO order 5')
# ax.plot(output_orders[5][1][id].data[0, :-end], output_orders[5][1][id].data[1, :-end], color=colors[7], label='TVKO order 6')
# ax.plot(output_orders[6][1][id].data[0, :-end], output_orders[6][1][id].data[1, :-end], color=colors[8], label='TVKO order 7')
# ax.plot(output_orders[7][1][id].data[0, :-end], output_orders[7][1][id].data[1, :-end], color=colors[9], label='TVKO order 8')
plt.xlabel(r'$x_1$')
plt.ylabel(r'$x_2$')
ax.legend(loc='upper left')
plt.tight_layout()
...
ax = plt.subplot(211)
ax.plot(np.linspace(0, 20, 2001), nominal_output_signal.data[0, :], color=colors[0], label='Nominal')
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[0, :], color=colors[5], label='True')
ax.plot(np.linspace(0, 20, 2001), true_output_signals_order1[id].data[0, :], '--', color=colors[1], label='Taylor order 1')
ax.plot(np.linspace(0, 20, 2001), true_output_signals_order2[id].data[0, :], '--', color=colors[2], label='Taylor order 2')
ax.plot(np.linspace(0, 20, 2001), true_output_signals_order3[id].data[0, :], '--', color=colors[3], label='Taylor order 3')
ax.plot(np.linspace(0, 20, 2001), true_output_signals_order4[id].data[0, :], '--', color=colors[4], label='Taylor order 4')
ax.plot(np.linspace(0, 18, 1901), output_orders[0][1][id].data[0, :-end], color=colors[1], label='TVKO order 1')
ax.plot(np.linspace(0, 18, 1901), output_orders[1][1][id].data[0, :-end], color=colors[2], label='TVKO order 2')
ax.plot(np.linspace(0, 18, 1901), output_orders[2][1][id].data[0, :-end], color=colors[3], label='TVKO order 3')
ax.plot(np.linspace(0, 18, 1901), output_orders[3][1][id].data[0, :-end], color=colors[4], label='TVKO order 4')
# ax.plot(np.linspace(0, 18, 901), output_orders[4][1][id].data[0, :-end], color=colors[6], label='TVKO order 5')
# ax.plot(np.linspace(0, 18, 901), output_orders[5][1][id].data[0, :-end], color=colors[7], label='TVKO order 6')
# ax.plot(np.linspace(0, 18, 901), output_orders[6][1][id].data[0, :-end], color=colors[8], label='TVKO order 7')
# ax.plot(np.linspace(0, 18, 901), output_orders[7][1][id].data[0, :-end], color=colors[9], label='TVKO order 8')
plt.xlabel(r'Time ')
plt.ylabel(r'$x_1$')
ax.legend(loc='lower left')
ax = plt.subplot(212)
ax.plot(np.linspace(0, 20, 2001), nominal_output_signal.data[1, :], color=colors[0], label='Nominal')
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[1, :], color=colors[5], label='True')
ax.plot(np.linspace(0, 20, 2001), true_output_signals_order1[id].data[1, :], '--', color=colors[1], label='Taylor order 1')
ax.plot(np.linspace(0, 20, 2001), true_output_signals_order2[id].data[1, :], '--', color=colors[2], label='Taylor order 2')
ax.plot(np.linspace(0, 20, 2001), true_output_signals_order3[id].data[1, :], '--', color=colors[3], label='Taylor order 3')
ax.plot(np.linspace(0, 20, 2001), true_output_signals_order4[id].data[1, :], '--', color=colors[4], label='Taylor order 4')
ax.plot(np.linspace(0, 18, 1901), output_orders[0][1][id].data[1, :-end], color=colors[1], label='TVKO order 1')
ax.plot(np.linspace(0, 18, 1901), output_orders[1][1][id].data[1, :-end], color=colors[2], label='TVKO order 2')
ax.plot(np.linspace(0, 18, 1901), output_orders[2][1][id].data[1, :-end], color=colors[3], label='TVKO order 3')
ax.plot(np.linspace(0, 18, 1901), output_orders[3][1][id].data[1, :-end], color=colors[4], label='TVKO order 4')
# ax.plot(np.linspace(0, 18, 901), output_orders[4][1][id].data[1, :-end], color=colors[6], label='TVKO order 5')
# ax.plot(np.linspace(0, 18, 901), output_orders[5][1][id].data[1, :-end], color=colors[7], label='TVKO order 6')
# ax.plot(np.linspace(0, 18, 901), output_orders[6][1][id].data[1, :-end], color=colors[8], label='TVKO order 7')
# ax.plot(np.linspace(0, 18, 901), output_orders[7][1][id].data[1, :-end], color=colors[9], label='TVKO order 8')
plt.xlabel(r'Time ')
plt.ylabel(r'$x_2$')
ax.legend(loc='lower left')
plt.tight_layout()
...
# Error time plots
fig = plt.figure(21, figsize=(16, 12))
ax = plt.subplot(211)
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[0, :] - true_output_signals_order1[id].data[0, :], '--', color=colors[1], label='Taylor order 1')
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[0, :] - true_output_signals_order2[id].data[0, :], '--', color=colors[2], label='Taylor order 2')
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[0, :] - true_output_signals_order3[id].data[0, :], '--', color=colors[3], label='Taylor order 3')
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[0, :] - true_output_signals_order4[id].data[0, :], '--', color=colors[4], label='Taylor order 4')
ax.plot(np.linspace(0, 18, 1901), true_output_signals[id].data[0, :-end] - output_orders[0][1][id].data[0, :-end], color=colors[1], label='TVKO order 1')
ax.plot(np.linspace(0, 18, 1901), true_output_signals[id].data[0, :-end] - output_orders[1][1][id].data[0, :-end], color=colors[2], label='TVKO order 2')
ax.plot(np.linspace(0, 18, 1901), true_output_signals[id].data[0, :-end] - output_orders[2][1][id].data[0, :-end], color=colors[3], label='TVKO order 3')
ax.plot(np.linspace(0, 18, 1901), true_output_signals[id].data[0, :-end] - output_orders[3][1][id].data[0, :-end], color=colors[4], label='TVKO order 4')
# ax.plot(np.linspace(0, 18, 901), true_output_signals[id].data[0, :-end] - output_orders[4][1][id].data[0, :-end], color=colors[6], label='TVKO order 5')
# ax.plot(np.linspace(0, 18, 901), true_output_signals[id].data[0, :-end] - output_orders[5][1][id].data[0, :-end], color=colors[7], label='TVKO order 6')
# ax.plot(np.linspace(0, 18, 901), true_output_signals[id].data[0, :-end] - output_orders[6][1][id].data[0, :-end], color=colors[8], label='TVKO order 7')
# ax.plot(np.linspace(0, 18, 901), true_output_signals[id].data[0, :-end] - output_orders[7][1][id].data[0, :-end], color=colors[9], label='TVKO order 8')
plt.xlabel(r'Time ')
plt.ylabel(r'$x_1$')
ax.legend(loc='lower left')
ax = plt.subplot(212)
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[1, :] - true_output_signals_order1[id].data[1, :], '--', color=colors[1], label='Taylor order 1')
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[1, :] - true_output_signals_order2[id].data[1, :], '--', color=colors[2], label='Taylor order 2')
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[1, :] - true_output_signals_order3[id].data[1, :], '--', color=colors[3], label='Taylor order 3')
ax.plot(np.linspace(0, 20, 2001), true_output_signals[id].data[1, :] - true_output_signals_order4[id].data[1, :], '--', color=colors[4], label='Taylor order 4')
ax.plot(np.linspace(0, 18, 1901), true_output_signals[id].data[1, :-end] - output_orders[0][1][id].data[1, :-end], color=colors[1], label='TVKO order 1')
ax.plot(np.linspace(0, 18, 1901), true_output_signals[id].data[1, :-end] - output_orders[1][1][id].data[1, :-end], color=colors[2], label='TVKO order 2')
ax.plot(np.linspace(0, 18, 1901), true_output_signals[id].data[1, :-end] - output_orders[2][1][id].data[1, :-end], color=colors[3], label='TVKO order 3')
ax.plot(np.linspace(0, 18, 1901), true_output_signals[id].data[1, :-end] - output_orders[3][1][id].data[1, :-end], color=colors[4], label='TVKO order 4')
# ax.plot(np.linspace(0, 18, 901), true_output_signals[id].data[1, :-end] - output_orders[4][1][id].data[1, :-end], color=colors[6], label='TVKO order 5')
# ax.plot(np.linspace(0, 18, 901), true_output_signals[id].data[1, :-end] - output_orders[5][1][id].data[1, :-end], color=colors[7], label='TVKO order 6')
# ax.plot(np.linspace(0, 18, 901), true_output_signals[id].data[1, :-end] - output_orders[6][1][id].data[1, :-end], color=colors[8], label='TVKO order 7')
# ax.plot(np.linspace(0, 18, 901), true_output_signals[id].data[1, :-end] - output_orders[7][1][id].data[1, :-end], color=colors[9], label='TVKO order 8')
plt.xlabel(r'Time ')
plt.ylabel(r'$x_2$')
ax.legend(loc='lower left')
plt.tight_layout()
...
ax.semilogy(r, np.mean(RMSE_STT[0, :, :], axis=1), '--', color=colors[1], label='First order')
ax.semilogy(r, np.mean(RMSE_STT[1, :, :], axis=1), '--', color=colors[2], label='Second order')
ax.semilogy(r, np.mean(RMSE_STT[2, :, :], axis=1), '--', color=colors[3], label='Third order')
...
# Plot All testing trajectories
fig = plt.figure(40, figsize=(12, 8))
ax = plt.subplot(111)
ax.plot(true_output_signals[0].data[0, :], true_output_signals[0].data[1, :], color=colors[9], label='All 800 testing trajectories')
for i in range(1, 800):
    ax.plot(true_output_signals[i].data[0, :], true_output_signals[i].data[1, :], color=colors[9])
ax.plot(nominal_output_signal.data[0, :], nominal_output_signal.data[1, :], color=colors[0], label='Nominal')
ax.plot(true_output_signals[30*20 + 7].data[0, :], true_output_signals[30*20 + 7].data[1, :], color=colors[5], label='Ring 30, IC 7')
ax.plot(true_output_signals[30*20 + 2].data[0, :], true_output_signals[30*20 + 2].data[1, :], '--', color=colors[2], label='Ring 30, IC 2')
plt.xlabel(r'$x_1$')
plt.ylabel(r'$x_2$')
ax.legend(loc='upper left')
plt.tight_layout()
