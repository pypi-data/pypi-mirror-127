...
from ClassesDynamics.ClassDuffingOscillatorDynamics import DuffingOscillatorDynamics2
...
## Import Dynamics
dynamics = DuffingOscillatorDynamics2()
...
## Plotting
plotSignals([[nominal_output_signal, true_output_signal, identified_output_signal], [subtract2Signals(true_output_signal, identified_output_signal)]], 5, percentage=0.05)
