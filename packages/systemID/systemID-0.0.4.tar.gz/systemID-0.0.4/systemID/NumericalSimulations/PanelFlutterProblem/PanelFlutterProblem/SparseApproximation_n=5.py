...
# Create System
initial_state = [(np.array([0.001, 0, 0, 0, 0]), 0)]
...
for i in range(number_trajectories):
    ...
    system = ContinuousNonlinearSystem(dynamics.state_dimension, dynamics.input_dimension, dynamics.output_dimension, [(np.array([init_state, 0, 0, 0, 0]), 0)], 'System ' + str(i), dynamics.F, dynamics.G)
...
for i in range(number_trajectories):
    experiments.input_signals[i] = DiscreteSignal(5, 'Prime term ' + str(i), total_time, frequency)
...
l2 = l1
alpha = 1.5
delta = [0.5, 0.5, 0.5, 0.5, 1]
epsilon = 1e-20
max_iterations = 5
shift = 1
x0s_testing = [np.array([0.0000562, 0, 0, 0, 0]), np.array([0.0000148, 0, 0, 0, 0])]
...
## Plotting results
output_signal_training_1 = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=experiments.output_signals[0].data[:, 0:int(number_steps-frequency*shift)])
output_signal_training_2 = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=experiments.output_signals[1].data[:, 0:int(number_steps-frequency*shift)])
...
output_signal_testing_1 = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=nominal_output_signal_testing_1.data[:, 0:int(number_steps-frequency*shift)])
output_signal_testing_2 = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=nominal_output_signal_testing_2.data[:, 0:int(number_steps-frequency*shift)])
output_signal_training_1_LS = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=SA.LS_signals[0].data[:, 0:int(number_steps-frequency*shift)])
output_signal_training_2_LS = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=SA.LS_signals[1].data[:, 0:int(number_steps-frequency*shift)])
output_signal_testing_1_LS = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=SA.LS_signals_testing[0].data[:, 0:int(number_steps-frequency*shift)])
output_signal_testing_2_LS = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=SA.LS_signals_testing[1].data[:, 0:int(number_steps-frequency*shift)])
output_signal_training_1_SP = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=SA.Sparse_signals[0].data[:, 0:int(number_steps-frequency*shift)])
output_signal_training_2_SP = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=SA.Sparse_signals[1].data[:, 0:int(number_steps-frequency*shift)])
output_signal_testing_1_SP = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=SA.Sparse_signals_testing[0].data[:, 0:int(number_steps-frequency*shift)])
output_signal_testing_2_SP = DiscreteSignal(5, 'S2_nom', total_time - shift, frequency, signal_shape='External', data=SA.Sparse_signals_testing[1].data[:, 0:int(number_steps-frequency*shift)])
...
plt.xlabel('\# in the dictionnary')
plt.ylabel('Absolute value of coefficients')
plt.legend(['LS Solution', 'Sparse Solution'], loc='lower right')
plt.title(r"Coefficients for $q_1'$")
...
plt.semilogy(np.abs(SA.THETA_LS[:, 4]), '*', color=colors[7])
plt.semilogy(np.abs(SA.THETA_SPARSE[:, 4]), '.', color=colors[5])
plt.xlabel('\# in the dictionnary')
plt.ylabel('Absolute value of coefficients')
plt.legend(['LS Solution', 'Sparse Solution'], loc='upper right')
plt.title(r"Coefficients for $R_T$")

plt.tight_layout()
plt.savefig('coeff_pf_n=5.eps', format='eps')
...
ax.plot(tspan_plot, output_signal_training_1.data[4, :], color=colors[0])
ax.plot(tspan_plot, output_signal_training_1_LS.data[4, :], color=colors[7], linestyle='--')
ax.plot(tspan_plot, output_signal_training_1_SP.data[4, :], color=colors[5], linestyle='-.')
plt.xlabel('Time [sec]')
plt.ylabel(r"$R_T$")
plt.legend(['True Signal', 'LS approx.', 'Sparse approx.'])
ax = fig.add_subplot(gs[8, 1])
ax.plot(tspan_plot, output_signal_training_1.data[4, :] - output_signal_training_1_LS.data[4, :], color=colors[8], linestyle='--')
plt.xlabel('Time [sec]')
plt.ylabel(r"Error in $R_T$")
plt.legend(['Error LS'])
ax = fig.add_subplot(gs[9, 1])
ax.plot(tspan_plot, output_signal_training_1.data[4, :] - output_signal_training_1_SP.data[4, :], color=colors[6], linestyle='-.')
plt.xlabel('Time [sec]')
plt.ylabel(r"Error in $R_T$")
plt.legend(['Error Sparse'])

ax = fig.add_subplot(gs[8:10, 2])
ax.plot(tspan_plot, output_signal_testing_1.data[4, :], color=colors[0])
ax.plot(tspan_plot, output_signal_testing_1_LS.data[4, :], color=colors[7], linestyle='--')
ax.plot(tspan_plot, output_signal_testing_1_SP.data[4, :], color=colors[5], linestyle='-.')
plt.xlabel('Time [sec]')
plt.ylabel(r"$R_T$")
plt.legend(['True Signal', 'LS approx.', 'Sparse approx.'])
ax = fig.add_subplot(gs[8, 3])
ax.plot(tspan_plot, output_signal_testing_1.data[4, :] - output_signal_testing_1_LS.data[4, :], color=colors[8], linestyle='--')
plt.xlabel('Time [sec]')
plt.ylabel(r"Error in $R_T$")
plt.legend(['Error LS'])
ax = fig.add_subplot(gs[9, 3])
ax.plot(tspan_plot, output_signal_testing_1.data[4, :] - output_signal_testing_1_SP.data[4, :], color=colors[6], linestyle='-.')
plt.xlabel('Time [sec]')
plt.ylabel(r"Error in $R_T$")
plt.legend(['Error Sparse'])
...
plt.savefig('prop_pf_n=5.eps', format='eps')
