""" Main class for raw data treatment from IN16B at the ILL.
...
class IN16B_nexus:
    """This class can handle raw data from IN16B.

    Further, specalized treatment is performed by the 
    :py:class:`IN16B_FWS`, :py:class:IN16B_QENS` and
    :py:class:IN16B_BATS` classes.
