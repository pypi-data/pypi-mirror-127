...
class SimpleFileUpload(BaseResource):
    ...
    curl -X POST -H "Content-Type: multipart/form-data" -u "admin:pass" -F "file=@file-path.ext" "http://localhost:7777/api/simpleupload/..."
    """
    RESOURCE_URL = "/api/simpleupload/<path:path>"
