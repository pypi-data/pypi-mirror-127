...
_dll_name = "dds.dll" if os.name == "nt" else "libdds.so"
...
try:
	...
	raise RuntimeError("Unable to load the dds library (should be located in " + 
		_dll_path + "), you may need to reinstall the library.")
