...
if default_initialization:
    ...
    coeff = 0.2 ## should be same as cap_matchrate or no?
    coeff_overlap1212 = 0.2
...
class MyPopup_image(QWidget):
    def __init__(self, th_exp, chi_exp, intensity, tth_sim, chi_sim, ix, iy, file):
        ...
        intensity = intensity / np.amax(intensity) * 100.0
...
class AnotherWindowLivePrediction(QWidget):#QWidget QScrollArea
    ...
    def onclickImage(self, event):
        ...
        try:
            ...
            if material_ != None:
                sim_twotheta, sim_chi = simulate_spots(rotation_matrix, 
