...
from viper_hrunner.vhrun.builtin.functions import get_process_thread_id
import pytest

from viper_hrunner.vhrun.utils import print_info
from viper_hrunner.vhrun.models import SSHRequestData, SSHResponseData
from viper_hrunner.vhrun.models import SessionData, SSHReqRespData
import copy
import traceback

try:
    import allure
    from viper_hrunner.vhrun.report.allure_report.allure_step import teststep_allure_step
...
from viper_hrunner.vhrun.report.aggregate import aggregate
from viper_hrunner.vhrun import utils, exceptions
from viper_hrunner.vhrun.client import HttpSession
from viper_hrunner.vhrun.exceptions import ValidationFailure, ParamsError
from viper_hrunner.vhrun.ext.uploader import prepare_upload_step
from viper_hrunner.vhrun.loader import load_project_meta, load_testcase_file
from viper_hrunner.vhrun.parser import build_url, parse_data, parse_variables_mapping
from viper_hrunner.vhrun.response import ResponseObject, SSHResponseObject
from viper_hrunner.vhrun.testcase import Config, Step
from viper_hrunner.vhrun.utils import merge_variables
from viper_hrunner.vhrun.models import (
    TConfig,
    TStep,
    VariablesMapping,
    StepData,
...
from viper_hrunner.vhrun.client import SSH
from viper_hrunner.vhrun.cli import case_summary_list
        ...
        try:
            ...
            try:
                ...
                if hasattr(self.__session, "data") and protocol is None:
                    # viper_hrunner.vhrun.client.HttpSession, not locust.clients.HttpSession
