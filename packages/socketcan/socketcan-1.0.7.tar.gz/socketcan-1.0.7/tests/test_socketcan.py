...
def receive_from_can_isotp_socket(interface, rx_addr, tx_addr, bufsize, use_padding, listen_only, fc_stmin, use_canfd, q):
    """
...
class TestCanIsoTpSocket:
    ...
    def test_can_fd(self, can_interface):
        ...
        use_padding = True
        use_canfd = True
        s = CanIsoTpSocket(interface=can_interface, rx_addr=rx_addr, tx_addr=tx_addr, use_padding=use_padding, use_canfd=use_canfd)
