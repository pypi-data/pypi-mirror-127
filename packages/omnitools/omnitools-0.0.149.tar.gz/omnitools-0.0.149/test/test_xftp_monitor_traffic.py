...
s.handler.dtp_handler.alter_recv = lambda *args: print("data received", args[1]) or args[1]
s.handler.dtp_handler.alter_send = lambda *args: print("data being sent", args[1]) or args[1]
