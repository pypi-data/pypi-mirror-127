...
readme = os.path.join("omnitools", "__metadata__", readme)
install_requires = os.path.join("omnitools", "__metadata__", install_requires)
extras_require = os.path.join("omnitools", "__metadata__", extras_require)
...
setup(
    ...
    package_data={
        "": ["pkg_data.*", "example/*.*", "requirements.txt", "requirements_extra.json", "*.md", "LICENSE"],
    },
