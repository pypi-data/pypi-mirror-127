...
__all__ = [
    ...
    'get_dict', 'del_dict_keys', 'get_deep', 'set_deep', 'merge_dict', 'get_obj_map', 'get_dict_map',
...
def merge_list(item_list, *others):
    """
...
def get_obj_map(obj_list, attr, deep=False):
    """
...
def get_dict_map(dict_list, key='id', key_join="+"):
    """
...
def bulk_append_child(items, parent_map, item_parent_key='parent_id', children_key="children", parent_map_key='id'):
    ...
    if isinstance(parent_map, list):
        parent_map = get_dict_map(parent_map, parent_map_key)
