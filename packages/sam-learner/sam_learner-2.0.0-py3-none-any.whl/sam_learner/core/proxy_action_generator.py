...
class LightProxyActionGenerator:
    ...
    def create_proxy_actions(self, action_name: str, action_signature: SignatureType,
                             precondition_cnfs: Dict[str, Set[ComparablePredicate]],
        ...
        :param precondition_cnfs: the CNFs of the preconditions that were learned during the learning process.
        ...
        surely_preconditions = self.get_precondition_fluents(precondition_cnfs)
