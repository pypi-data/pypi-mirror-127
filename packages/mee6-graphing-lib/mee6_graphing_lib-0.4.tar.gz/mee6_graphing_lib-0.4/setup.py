...
setup(
    ...
    packages=["mee6_graphing_lib"],  # Cshose the same as "name"
    ...
    download_url="https://github.com/StarkOdinson612/MEE6-Levelling-Calculator/archive/refs/tags/v0.4.tar.gz",  # I explain this later on
    keywords=[
        "MEE6",
        "Graphing",
        "Discord",
