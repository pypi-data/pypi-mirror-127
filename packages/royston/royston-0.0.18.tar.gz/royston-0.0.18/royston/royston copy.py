...
class Royston:
    ...
    def train_doc2vec(self):
        print('train_doc2vec start', len(self.doc2vec_docs))
        ...
        print('created self.doc2vec_docs')

        self.doc2vec_model.build_vocab(self.doc2vec_docs)
        print('vocabbed self.doc2vec_docs', len(self.doc2vec_docs),str(self.doc2vec_model.corpus_count))
        self.doc2vec_model.train(
            self.doc2vec_docs,
            total_examples=self.doc2vec_model.corpus_count,
            epochs=epochs_count#self.doc2vec_model.epochs,
        )
