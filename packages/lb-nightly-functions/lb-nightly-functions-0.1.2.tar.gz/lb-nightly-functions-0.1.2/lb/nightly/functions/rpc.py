...
def build(
    ...
    build_env[
        "CMAKE_PREFIX_PATH"
    ] = f"/cvmfs/lhcb.cern.ch/lib/lhcb:/cvmfs/lhcb.cern.ch/lib/lcg/releases:{CMAKE_DIR}:/cvmfs/projects.cern.ch/intelsw/psxe/linux/x86_64/2019/vtune_amplifier"
...
def test(
    ...
    try:
        os.remove(os.path.join(project.baseDir, "build", "CMakeCache.txt"))
