...
def us_time_conversion(sdatestr):
    ...
    :param sdatestr: 日期，str，如'19900101'
...
def get_monday_firday(sdatestr):
    """
    返回星期一和星期五的日期
    :param sdatestr: 初始时间，如'19900101'
...
def date_compare(sdatestr,edatestr):
    ...
    :param start: 日期，字符串格式'20210101'
    :param end: 日期，字符串格式'20210102'
...
def get_date_by_times(sdatestr, edatestr):
    ...
    :param sdatestr: 日期，字符串格式'20210101'
    :param edatestr: 日期，字符串格式'20210101'
...
def get_date_by_offset(sdatestr,before_day):
    ...
    :param sdatestr: 日期，str,如'20210101'，开始日期
    :param before_day: 前before_day天，int，如5
    :return: re_date-日期，str,如'20210101'，结束日期
    """
    try:
        datestart = datetime.datetime.strptime(sdatestr, "%Y%m%d")
    except Exception as e:
