...
class MazeView extends base_1.DOMWidgetView {
    ...
    render() {
        ...
        if (!this.world_model) {
            this.world_model = new world_model_1.WorldModel(this.handle_zoom_level.bind(this));
        }
        this.initOutput();
        //set methods
