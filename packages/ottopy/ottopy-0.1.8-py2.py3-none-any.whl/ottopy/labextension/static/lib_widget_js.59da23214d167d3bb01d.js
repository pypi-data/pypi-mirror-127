...
class WorldModel {
    ...
    skeleton() {
      ...
      <div class="grid-slider ${this.zoom_level * 10}">
        <div class="grid">
          <div class="stats">
...
class MazeView extends base_1.DOMWidgetView {
    ...
    render() {
        ...
        if (!this.world_model) {
            this.world_model = new world_model_1.WorldModel(this.model.get('zoom') || 10, this.handle_zoom_level.bind(this));
        }
        this.initOutput();
        //set methods
...
//# sourceMappingURL=lib_widget_js.59da23214d167d3bb01d.js.map