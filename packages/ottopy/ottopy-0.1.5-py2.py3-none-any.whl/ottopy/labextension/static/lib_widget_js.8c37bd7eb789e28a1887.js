...
class WorldModel {
    ...
    getZoomClasses() {
        ...
        let classess = (_a = $outputArea.attr('class')) === null || _a === void 0 ? void 0 : _a.split(' ');
        console.log('🚀 ~ file: world_model.ts ~ line 146 ~ WorldModel ~ changeZoomClass ~ classess', classess);
    }
    init_output_window() {
        let $outputArea = jquery_1.default('#outputArea');
    ...
    initOutput() {
        if (jquery_1.default('#outputArea').length === 0) {
            ...
            let $outputArea = jquery_1.default('<div/>', {
                id: 'outputArea',
                class: this.model.get('floating') ? 'floating zoom-10' : 'non-floating zoom-10',
            });
...
//# sourceMappingURL=lib_widget_js.8c37bd7eb789e28a1887.js.map