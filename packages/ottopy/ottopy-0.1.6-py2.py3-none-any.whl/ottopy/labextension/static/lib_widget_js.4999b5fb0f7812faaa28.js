    ...
    skeleton() {
      ...
      <div class="output-header clr-info">
        ...
        <div class="output-actions btn-group">
          <button class="output-action-zoom_in">&plus;</button>
          <button class="output-action-zoom_out">&minus;</button>
...
//# sourceMappingURL=lib_widget_js.4999b5fb0f7812faaa28.js.map