...
from packet_server.server import StatWindow
from packet_server.server import ConfigWindow
from packet_server.server import RegisterUser
from packet_server.server import DelUserDialog
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, database, server, config):
        ...
        self.refresh_button = QAction('Update a list', self)
        ...
        # Кнопка отображения истории сообщений
        ...
        self.label = QLabel('The list of connected clients:', self)
    ...
    def create_users_model(self):
        ...
        list_users = self.database.online_users_list()
        list = QStandardItemModel()
        list.setHorizontalHeaderLabels(
            ['Client name', 'IP Address', 'Port', 'Time of connection'])
