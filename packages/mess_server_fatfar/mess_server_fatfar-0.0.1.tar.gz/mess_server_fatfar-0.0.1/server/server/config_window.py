...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.db_file_label = QLabel('Name of database file: ', self)
        ...
        self.ip_label = QLabel('Outcoming message IP:', self)
        self.ip_label.move(10, 148)
        self.ip_label.setFixedSize(180, 15)

        # Метка с напоминанием о пустом поле.
        self.ip_label_note = QLabel(
            'Leave this filed empty to get connections from any addresses', self)
        ...
        try:
            ...
            if 1023 < port < 65536:
                ...
                with open(f"{dir_path}/{'server.ini'}", 'w') as conf:
                    ...
                    message.information(
                        self, 'OK', 'Settings are successfully saved!')
            else:
                message.warning(
                    self, 'Error', 'Port must a number in range of 1024 and 65536')
