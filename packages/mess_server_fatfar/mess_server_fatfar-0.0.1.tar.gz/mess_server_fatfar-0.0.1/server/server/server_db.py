""" Структура базы данных серверной части """
...
class ServerDB:
    ...
    def __init__(self, path):
        ...
        online_users_table = Table(
            'Online_Users', self.metadata, Column(
    ...
    def user_login(self, username, ip_address, port, key):
        ...
        # входа.
        new_online_user = self.OnlineUsers(
    ...
    def remove_user(self, name):
        ...
        self.session.query(self.OnlineUsers).filter_by(user=user.id).delete()
    ...
    def login_history(self, username=None):
        """ Метод, возвращающий историю входов пользователей. """
...
#     trial_db = ServerDB('../server_database.db3')
#     trial_db.user_login('client_1', '123.456.7.8', 1234, 1)
#     trial_db.user_login('client_2', '910.111.2.1', 5678, 2)
#     trial_db.user_login('test_3', '910.111.2.54', 9876, 3)
#     print(trial_db.users_list())
#     print(trial_db.online_users_list())
#     trial_db.user_logout('client_1')
#     print(trial_db.login_history('client_2'))
#     trial_db.add_contact('client_1', 'client_2')
#     trial_db.add_contact('client_1', 'test_3')
#     trial_db.add_contact('client_2', 'test_3')
#     print(trial_db.get_contacts('client_1'))
#     print(trial_db.get_contacts('client_2'))
#     trial_db.remove_contact('client_1', 'client_2')
#     trial_db.remove_contact('client_1', 'test_3')
#     trial_db.process_message('client_1', 'client_2')
#     print(trial_db.get_contacts('client_1'))
#     print(trial_db.message_history())
#     print(trial_db.login_history('test_3'))
