...
class FTSADatabaseLibrary(DatabaseLibrary):
    ...
    def insert(self, table_name=None, columns="", values=None, script_file_name=None):
        ...
        _Examples:_
        | INSERT | ``table_name=`` person | ``columns=`` (id, first_name, last_name) | ``values=`` (101, Joao, Goes) |
        ...
        if script_file_name is not None:
            ...
            return self._execute(f'INSERT INTO {table_name} {columns} VALUES {values}')
