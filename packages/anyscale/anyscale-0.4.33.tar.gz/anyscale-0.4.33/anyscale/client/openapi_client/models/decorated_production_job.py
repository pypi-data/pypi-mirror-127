...
class DecoratedProductionJob(object):
    ...
    def __init__(self, id=None, name=None, description=None, created_at=None, creator_id=None, config=None, state=None, project_id=None, last_job_run_id=None, project=None, creator=None, cost_dollars=None, local_vars_configuration=None):  # noqa: E501
