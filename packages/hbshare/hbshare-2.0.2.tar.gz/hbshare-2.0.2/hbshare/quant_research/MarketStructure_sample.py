...
from hbshare.quant_research.MarketStructure import MarketHist, get_market_turnover, AlphaSeries, MarketStructure
...
def run_factor_test(start_date, end_date):
...
if __name__ == '__main__':
    run_daily_plot('20210101', '20211117')
    # df = run_factor_test('20190101', '20211112')
    # print(df)
