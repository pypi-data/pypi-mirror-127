...
def hsjy_fut_wr(exchanges=None, table='hsjy_fut_wr', db_path=None, sql_info=None, page_size=None):
...
def hsjy_fut_com_info(exchanges=None, table='hsjy_fut_info_c', db_path=None, sql_info=None, page_size=None):
    if page_size is None:
        page_size = page_size_con
...
def hsjy_fut_pro_info(exchanges=None, table='hsjy_fut_info_p', db_path=None, sql_info=None, page_size=None):
    if page_size is None:
        page_size = page_size_con
...
def hsjy_fut_com(
        exchanges=None, table='hsjy_fut_com', table_info='hsjy_fut_info_c', db_path=None, sql_info=None, page_size=None
):
    if page_size is None:
        page_size = page_size_con
...
def hsjy_fut_member(table='hsjy_fut_memberrank', db_path=None, sql_info=None, page_size=None):
    if page_size is None:
        page_size = page_size_con
