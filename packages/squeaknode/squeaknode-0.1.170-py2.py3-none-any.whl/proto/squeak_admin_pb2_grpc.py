...
class SqueakAdminStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetSqueakProfileUseCustomPrice = channel.unary_unary(
                '/squeaknode.SqueakAdmin/SetSqueakProfileUseCustomPrice',
                request_serializer=proto_dot_squeak__admin__pb2.SetSqueakProfileUseCustomPriceRequest.SerializeToString,
                response_deserializer=proto_dot_squeak__admin__pb2.SetSqueakProfileUseCustomPriceReply.FromString,
                )
        self.SetSqueakProfileCustomPrice = channel.unary_unary(
                '/squeaknode.SqueakAdmin/SetSqueakProfileCustomPrice',
                request_serializer=proto_dot_squeak__admin__pb2.SetSqueakProfileCustomPriceRequest.SerializeToString,
                response_deserializer=proto_dot_squeak__admin__pb2.SetSqueakProfileCustomPriceReply.FromString,
                )
...
def add_SqueakAdminServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetSqueakProfileUseCustomPrice': grpc.unary_unary_rpc_method_handler(
                    servicer.SetSqueakProfileUseCustomPrice,
                    request_deserializer=proto_dot_squeak__admin__pb2.SetSqueakProfileUseCustomPriceRequest.FromString,
                    response_serializer=proto_dot_squeak__admin__pb2.SetSqueakProfileUseCustomPriceReply.SerializeToString,
            ),
            'SetSqueakProfileCustomPrice': grpc.unary_unary_rpc_method_handler(
                    servicer.SetSqueakProfileCustomPrice,
                    request_deserializer=proto_dot_squeak__admin__pb2.SetSqueakProfileCustomPriceRequest.FromString,
                    response_serializer=proto_dot_squeak__admin__pb2.SetSqueakProfileCustomPriceReply.SerializeToString,
            ),
...
class SqueakAdmin(object):
    ...
    @staticmethod
    def SetSqueakProfileUseCustomPrice(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squeaknode.SqueakAdmin/SetSqueakProfileUseCustomPrice',
            proto_dot_squeak__admin__pb2.SetSqueakProfileUseCustomPriceRequest.SerializeToString,
            proto_dot_squeak__admin__pb2.SetSqueakProfileUseCustomPriceReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def SetSqueakProfileCustomPrice(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squeaknode.SqueakAdmin/SetSqueakProfileCustomPrice',
            proto_dot_squeak__admin__pb2.SetSqueakProfileCustomPriceRequest.SerializeToString,
            proto_dot_squeak__admin__pb2.SetSqueakProfileCustomPriceReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
