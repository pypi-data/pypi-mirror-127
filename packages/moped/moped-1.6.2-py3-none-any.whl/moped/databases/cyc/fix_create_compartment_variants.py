...
def _split_location(*, location: str, compartment_map: Dict[str, str]) -> Dict[str, str]:
    ...
    try:
        ...
        out_ = split[2]
        in_ = "CYTOSOL"
    out_ = _map_compartment_to_model_compartments(compartment=out_, compartment_map=compartment_map)
    in_ = _map_compartment_to_model_compartments(compartment=in_, compartment_map=compartment_map)
