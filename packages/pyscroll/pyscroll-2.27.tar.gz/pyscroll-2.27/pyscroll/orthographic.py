...
class BufferedRenderer:
    ...
    def __init__(
        ...
        NOTE: `colorkey` and `alpha` are special purpose and not related to the
              transparency values for tiles. In 99.99% of cases, you do not need
              to set them
        ...
        if self.tall_sprites != 0:
            log.warning('using pyscroll "tall_sprites" feature is no longer supported')
    ...
    def _create_buffers(self, view_size: Vector2DInt, buffer_size: Vector2DInt):
        """
