...
MapTensorData = _reflection.GeneratedProtocolMessageType('MapTensorData', (_message.Message,), {

  'SubtensorsEntry' : _reflection.GeneratedProtocolMessageType('SubtensorsEntry', (_message.Message,), {
...
_TENSOR.fields_by_name['dcomplex_val']._options = None
