...
class ServingDiscovery(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def WatchApplications(request_iterator,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/hydrosphere.serving.discovery.ServingDiscovery/WatchApplications',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            hydro__serving__grpc_dot_serving_dot_discovery_dot_api__pb2.ApplicationDiscoveryEvent.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def WatchServables(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/hydrosphere.serving.discovery.ServingDiscovery/WatchServables',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            hydro__serving__grpc_dot_serving_dot_discovery_dot_api__pb2.ServableDiscoveryEvent.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def WatchMetricSpec(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/hydrosphere.serving.discovery.ServingDiscovery/WatchMetricSpec',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            hydro__serving__grpc_dot_serving_dot_discovery_dot_api__pb2.MetricSpecDiscoveryEvent.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
