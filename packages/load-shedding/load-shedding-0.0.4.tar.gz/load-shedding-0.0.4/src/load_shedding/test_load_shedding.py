...
from .load_shedding import get_schedule, get_area_schedule, list_to_dict
from .mock_eskom import MockEskom
from .eskom import Province, Stage, Suburb
...
class Test(TestCase):
    ...
    def test_get_area_schedule(self):
        ...
        got = get_area_schedule(self.eskom, province=Province(id=Province.WESTERN_CAPE), suburb=Suburb(id=1058852),
                                cached=True)
        self.assertEqual(dict, type(got))
        self.assertDictEqual(want, got)

    def test_get_schedule(self):
        self.assertRaises(Exception, get_schedule, self.eskom, province=Province(id=Province.WESTERN_CAPE),
                          suburb=Suburb(id=1058852), cached=True)
