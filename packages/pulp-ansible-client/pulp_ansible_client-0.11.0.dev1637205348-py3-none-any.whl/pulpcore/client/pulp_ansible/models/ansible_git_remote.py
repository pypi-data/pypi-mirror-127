...
class AnsibleGitRemote(object):
    ...
    def __init__(self, rate_limit=None, password=None, client_key=None, proxy_password=None, max_retries=None, sock_connect_timeout=None, ca_cert=None, proxy_url=None, username=None, sock_read_timeout=None, client_cert=None, total_timeout=None, headers=None, proxy_username=None, connect_timeout=None, name=None, download_concurrency=None, pulp_labels=None, tls_validation=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
