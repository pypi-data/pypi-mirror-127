...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, headers=None, ca_cert=None, connect_timeout=None, max_retries=None, pulp_href=None, rate_limit=None, download_concurrency=None, pulp_labels=None, total_timeout=None, proxy_url=None, pulp_created=None, url=None, sock_read_timeout=None, name=None, client_cert=None, tls_validation=None, pulp_last_updated=None, sock_connect_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
