...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, proxy_url=None, pulp_href=None, tls_validation=None, client_cert=None, pulp_labels=None, sock_read_timeout=None, pulp_last_updated=None, connect_timeout=None, sock_connect_timeout=None, name=None, headers=None, pulp_created=None, download_concurrency=None, max_retries=None, total_timeout=None, ca_cert=None, rate_limit=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
