...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, rate_limit=None, pulp_last_updated=None, max_retries=None, sock_connect_timeout=None, ca_cert=None, proxy_url=None, sock_read_timeout=None, client_cert=None, total_timeout=None, headers=None, connect_timeout=None, name=None, download_concurrency=None, pulp_labels=None, tls_validation=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
