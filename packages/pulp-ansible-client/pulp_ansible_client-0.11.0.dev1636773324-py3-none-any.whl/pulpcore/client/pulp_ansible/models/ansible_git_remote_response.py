...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, sock_connect_timeout=None, name=None, sock_read_timeout=None, max_retries=None, rate_limit=None, total_timeout=None, proxy_url=None, connect_timeout=None, pulp_last_updated=None, pulp_labels=None, headers=None, pulp_created=None, ca_cert=None, client_cert=None, tls_validation=None, pulp_href=None, download_concurrency=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
