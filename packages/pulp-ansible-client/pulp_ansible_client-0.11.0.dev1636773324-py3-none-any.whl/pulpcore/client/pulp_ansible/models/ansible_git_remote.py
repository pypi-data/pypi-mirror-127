...
class AnsibleGitRemote(object):
    ...
    def __init__(self, url=None, sock_connect_timeout=None, name=None, client_key=None, sock_read_timeout=None, username=None, max_retries=None, rate_limit=None, total_timeout=None, proxy_url=None, connect_timeout=None, pulp_labels=None, proxy_username=None, headers=None, password=None, ca_cert=None, client_cert=None, proxy_password=None, tls_validation=None, download_concurrency=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
