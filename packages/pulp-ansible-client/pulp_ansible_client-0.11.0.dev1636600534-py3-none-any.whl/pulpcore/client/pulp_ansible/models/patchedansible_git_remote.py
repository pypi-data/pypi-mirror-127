...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, password=None, proxy_username=None, username=None, proxy_password=None, proxy_url=None, ca_cert=None, client_key=None, max_retries=None, sock_read_timeout=None, total_timeout=None, download_concurrency=None, name=None, client_cert=None, rate_limit=None, url=None, headers=None, tls_validation=None, connect_timeout=None, sock_connect_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
