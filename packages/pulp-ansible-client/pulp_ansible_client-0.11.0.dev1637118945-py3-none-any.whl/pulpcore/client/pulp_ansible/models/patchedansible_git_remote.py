...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, ca_cert=None, connect_timeout=None, headers=None, name=None, proxy_username=None, tls_validation=None, proxy_url=None, client_key=None, proxy_password=None, sock_read_timeout=None, pulp_labels=None, download_concurrency=None, url=None, password=None, rate_limit=None, max_retries=None, username=None, total_timeout=None, sock_connect_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
