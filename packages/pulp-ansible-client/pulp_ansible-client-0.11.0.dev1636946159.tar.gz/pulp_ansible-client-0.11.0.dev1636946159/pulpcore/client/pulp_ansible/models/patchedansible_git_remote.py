...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, headers=None, proxy_url=None, total_timeout=None, url=None, username=None, password=None, proxy_username=None, client_cert=None, sock_connect_timeout=None, tls_validation=None, rate_limit=None, max_retries=None, client_key=None, proxy_password=None, sock_read_timeout=None, name=None, ca_cert=None, pulp_labels=None, download_concurrency=None, connect_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
