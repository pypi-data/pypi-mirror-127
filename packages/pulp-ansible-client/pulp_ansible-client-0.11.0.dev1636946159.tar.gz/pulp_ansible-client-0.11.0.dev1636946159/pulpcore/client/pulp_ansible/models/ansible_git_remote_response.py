...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, headers=None, proxy_url=None, total_timeout=None, url=None, pulp_href=None, client_cert=None, sock_connect_timeout=None, tls_validation=None, pulp_last_updated=None, rate_limit=None, max_retries=None, sock_read_timeout=None, name=None, ca_cert=None, pulp_created=None, pulp_labels=None, download_concurrency=None, connect_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
