...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, download_concurrency=None, rate_limit=None, name=None, proxy_url=None, sock_read_timeout=None, sock_connect_timeout=None, ca_cert=None, pulp_created=None, total_timeout=None, pulp_last_updated=None, headers=None, pulp_labels=None, tls_validation=None, url=None, max_retries=None, connect_timeout=None, client_cert=None, pulp_href=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
