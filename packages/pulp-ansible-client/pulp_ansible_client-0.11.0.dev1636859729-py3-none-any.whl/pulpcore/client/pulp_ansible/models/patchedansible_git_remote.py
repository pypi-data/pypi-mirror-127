...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, download_concurrency=None, password=None, client_key=None, rate_limit=None, name=None, proxy_url=None, username=None, sock_read_timeout=None, proxy_username=None, sock_connect_timeout=None, ca_cert=None, total_timeout=None, headers=None, proxy_password=None, pulp_labels=None, tls_validation=None, url=None, max_retries=None, connect_timeout=None, client_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
