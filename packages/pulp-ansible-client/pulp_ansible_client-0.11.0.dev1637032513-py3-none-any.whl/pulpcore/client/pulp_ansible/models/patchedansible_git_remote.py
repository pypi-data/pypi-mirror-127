...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, headers=None, ca_cert=None, connect_timeout=None, proxy_username=None, max_retries=None, username=None, client_key=None, rate_limit=None, download_concurrency=None, pulp_labels=None, total_timeout=None, proxy_password=None, proxy_url=None, url=None, sock_read_timeout=None, name=None, client_cert=None, tls_validation=None, password=None, sock_connect_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
