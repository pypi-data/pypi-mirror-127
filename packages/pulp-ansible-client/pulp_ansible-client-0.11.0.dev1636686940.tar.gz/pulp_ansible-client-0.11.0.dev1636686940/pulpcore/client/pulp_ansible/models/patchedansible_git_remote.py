...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, url=None, proxy_url=None, username=None, proxy_username=None, tls_validation=None, password=None, client_cert=None, proxy_password=None, client_key=None, pulp_labels=None, sock_read_timeout=None, connect_timeout=None, sock_connect_timeout=None, name=None, headers=None, download_concurrency=None, max_retries=None, total_timeout=None, ca_cert=None, rate_limit=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
