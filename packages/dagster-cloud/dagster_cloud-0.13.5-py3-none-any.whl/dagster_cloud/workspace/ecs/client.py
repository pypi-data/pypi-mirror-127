...
class Client:
    ...
    def create_service(self, name, image, command, task_role_arn=None, env=None, tags=None):
    ...
    def _create_service_registry(self, service_name):
    ...
    def _create_service(self, service_name, service_registry_arn, task_definition_arn, tags=None):
        if not tags:
            tags = {}
