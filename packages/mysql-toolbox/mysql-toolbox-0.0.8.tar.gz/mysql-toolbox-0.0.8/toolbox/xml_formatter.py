...
def xml_formatter_main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="super wrap mode. widthhint will be disabled in this mode.",
    )
    parser.add_argument(
        "--timeout",
        dest="timeout",
    ...
    try:
        ...
        print("# error parsing XML contents : {}".format(
    ...
    if args.widthhint or args.page != 2**30 or args.superwrap:
    ...
    if args.pivot:
        ...
        if args.nowrap:
            expr = "\n".join([ln[:termwidth] for ln in expr.splitlines()])
        print(expr)
