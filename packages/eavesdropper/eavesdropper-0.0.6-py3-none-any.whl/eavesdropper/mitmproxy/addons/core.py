...
from eavesdropper.mitmproxy import optmanager
from eavesdropper.mitmproxy import platform
from eavesdropper.mitmproxy.net import server_spec
from eavesdropper.mitmproxy.net.http import status_codes
...
class Core:
    ...
    @command.argument("attr", type=eavesdropper.mitmproxy.types.Choice("flow.set.options"))
    def flow_set(
        self,
    ...
    @command.argument("encoding", type=eavesdropper.mitmproxy.types.Choice("flow.encode.options"))
    def encode(
        self,
        flows: typing.Sequence[flow.Flow],
        part: str,
    ...
    def options_load(self, path: eavesdropper.mitmproxy.types.Path) -> None:
        """
    ...
    def options_save(self, path: eavesdropper.mitmproxy.types.Path) -> None:
        """
