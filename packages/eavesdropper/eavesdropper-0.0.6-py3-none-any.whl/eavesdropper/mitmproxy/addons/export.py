...
from eavesdropper.mitmproxy import ctx, http
from eavesdropper.mitmproxy import exceptions
from eavesdropper.mitmproxy import flow
from eavesdropper.mitmproxy.net.http.http1 import assemble
...
class Export():
    ...
    def file(self, format: str, flow: flow.Flow, path: eavesdropper.mitmproxy.types.Path) -> None:
        """
