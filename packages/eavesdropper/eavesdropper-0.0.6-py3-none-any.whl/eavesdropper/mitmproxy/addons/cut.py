...
from eavesdropper.mitmproxy import certs
...
class Cut:
    ...
    def cut(
        ...
        cuts: eavesdropper.mitmproxy.types.CutSpec,
    ) -> eavesdropper.mitmproxy.types.Data:
        """
    ...
    def save(
        ...
        flows: typing.Sequence[flow.Flow],
        cuts: eavesdropper.mitmproxy.types.CutSpec,
        path: eavesdropper.mitmproxy.types.Path
    ) -> None:
        """
        ...
        if path.startswith("+"):
            ...
            path = eavesdropper.mitmproxy.types.Path(epath)
        try:
