...
from eavesdropper.mitmproxy.tools import cmdline
from eavesdropper.mitmproxy import exceptions, master
from eavesdropper.mitmproxy import options
from eavesdropper.mitmproxy import optmanager
from eavesdropper.mitmproxy import proxy
from eavesdropper.mitmproxy.utils import debug, arg_check
...
def mitmproxy(args=None) -> typing.Optional[int]:  # pragma: no cover
    if os.name == "nt":
        ...
        return 1
    assert_utf8_env()
    from eavesdropper.mitmproxy.tools import console
    run(console.master.ConsoleMaster, cmdline.mitmproxy, args)
    return None


def mitmdump(args=None) -> typing.Optional[int]:  # pragma: no cover
    from eavesdropper.mitmproxy.tools import dump
...
def mitmweb(args=None) -> typing.Optional[int]:  # pragma: no cover
    from eavesdropper.mitmproxy.tools import web
