...
from eavesdropper.mitmproxy import command, command_lexer
from eavesdropper.mitmproxy import contentviews
...
class ConsoleAddon:
    ...
    def console_choose(
            ...
            cmd: eavesdropper.mitmproxy.types.Cmd,
            *args: eavesdropper.mitmproxy.types.CmdArgs
    ) -> None:
        """
    ...
    def console_choose_cmd(
            self,
            prompt: str,
            choicecmd: eavesdropper.mitmproxy.types.Cmd,
            subcmd: eavesdropper.mitmproxy.types.Cmd,
            *args: eavesdropper.mitmproxy.types.CmdArgs
    ) -> None:
        """
    ...
    @command.argument("part", type=eavesdropper.mitmproxy.types.Choice("console.bodyview.options"))
    ...
    @command.argument("flow_part", type=eavesdropper.mitmproxy.types.Choice("console.edit.focus.options"))
    ...
    def grideditor_load(self, path: eavesdropper.mitmproxy.types.Path) -> None:
        """
    ...
    def grideditor_load_escaped(self, path: eavesdropper.mitmproxy.types.Path) -> None:
        """
    ...
    def grideditor_save(self, path: eavesdropper.mitmproxy.types.Path) -> None:
        """
    ...
    @command.argument("mode", type=eavesdropper.mitmproxy.types.Choice("console.flowview.mode.options"))
