...
from eavesdropper.mitmproxy.tools.console import layoutwidget
from eavesdropper.mitmproxy.tools.console import flowdetailview
from eavesdropper.mitmproxy.tools.console import searchable
from eavesdropper.mitmproxy.tools.console import tabs
import eavesdropper.mitmproxy.tools.console.master  # noqa
...
class FlowDetails(tabs.Tabs):
    ...
    @property
    def flow(self) -> eavesdropper.mitmproxy.flow.Flow:
