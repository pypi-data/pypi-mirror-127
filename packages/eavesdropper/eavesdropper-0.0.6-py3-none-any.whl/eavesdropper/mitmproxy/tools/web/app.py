...
import eavesdropper.mitmproxy.tools.web.master  # noqa
...
from eavesdropper.mitmproxy import version


def flow_to_json(flow: eavesdropper.mitmproxy.flow.Flow) -> dict:
    """
