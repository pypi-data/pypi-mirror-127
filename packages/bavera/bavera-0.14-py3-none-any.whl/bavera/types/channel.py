...
from bavera.util.snowflake import to_snowflake
from bavera.util.functional import one_or_many, chunks
from bavera.types.user import User
from bavera.types.base import SlottedModel, Field, AutoDictField, snowflake, enum, text, cached_property
from bavera.types.permissions import Permissions, Permissible, PermissionValue
...
class PermissionOverwrite(ChannelSubType):
    ...
    def create_for_channel(cls, channel, entity, allow=0, deny=0):
        from bavera.types.guild import Role
...
class Channel(SlottedModel, Permissible):
    ...
    def create_invite(self, *args, **kwargs):
        ...
        from bavera.types.invite import Invite
    ...
    def connect(self, *args, **kwargs):
        ...
        """
        from bavera.voice.client import VoiceClient
