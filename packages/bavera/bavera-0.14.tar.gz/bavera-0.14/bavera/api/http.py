...
from bavera import VERSION as bavera_version
from requests import __version__ as requests_version
from bavera.util.logging import LoggingClass
from bavera.api.ratelimit import RateLimiter
...
class HTTPClient(LoggingClass):
    ...
    def __init__(self, token, after_request=None):
        ...
        self.headers = {
            'User-Agent': 'DiscordBot (https://github.com/bavera/bavera {}) Python/{} requests/{}'.format(
                bavera_version,
                py_version,
                requests_version),
        }
