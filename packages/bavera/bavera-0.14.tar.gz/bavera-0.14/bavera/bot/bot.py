...
from bavera.types.guild import GuildMember
from bavera.bot.plugin import find_loadable_plugins
from bavera.bot.command import CommandEvent, CommandLevels
from bavera.bot.storage import Storage
from bavera.util.config import Config
from bavera.util.logging import LoggingClass
from bavera.util.serializer import Serializer
...
class Bot(LoggingClass):
    ...
    def from_cli(cls, *plugins):
        ...
        """
        from bavera.cli import bavera_main
        inst = cls(bavera_main())
