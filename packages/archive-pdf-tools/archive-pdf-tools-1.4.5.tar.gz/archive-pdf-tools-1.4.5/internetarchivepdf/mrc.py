        ...
        for line in paragraph['lines']:
            ...
            if ratio < 0.3 or inv_ratio < 0.3:
                ...
                if inv_ratio > 0.2 and ratio < 0.2:
                    ...
                    print('inv_ratio_sigma', inv_ratio_sigma)

                    # Prefer ratio over inv_ratio by a bit
                    # maybe check if the sigma is really low, and then it
                    # doesn't matter if inv > normal
                    #if inv_ratio < 0.3 and inv_ratio < ratio and inv_ratio_sigma < ratio_sigma:
                    ...
                    (ratio_sigma < 0.1 and inv_ratio_sigma < 0.1)):
                        ...
                        print('NONE')
                        print('NONE ratio', ratio)
                        print('NONE inv_ratio', inv_ratio)
