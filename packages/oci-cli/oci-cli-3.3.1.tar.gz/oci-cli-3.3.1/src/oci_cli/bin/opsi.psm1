...
function GetOciSubcommands_opsi() {
    $ociSubcommands = @{
        'opsi' = 'database-insights enterprise-manager-bridges exadata-insights host-insights work-requests'
...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi database-insights list' = 'all compartment-id database-id database-type em-bridge-id exadata-insight-id fields from-json help id lifecycle-state limit page page-size sort-by sort-order status'
        'opsi database-insights list-database-configurations' = 'all cdb-name compartment-id database-id database-type defined-tag-equals defined-tag-exists em-bridge-id exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help host-name id limit page page-size sort-by sort-order'
        ...
        'opsi database-insights summarize-sql-insights' = 'analysis-time-interval cdb-name compartment-id database-id database-time-pct-greater-than database-type defined-tag-equals defined-tag-exists exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help host-name id page time-interval-end time-interval-start'
        ...
        'opsi exadata-insights list' = 'all compartment-id em-bridge-id exadata-type from-json help id lifecycle-state limit page page-size sort-by sort-order status'
        ...
        'opsi host-insights list' = 'all compartment-id em-bridge-id exadata-insight-id from-json help host-type id lifecycle-state limit page page-size platform-type sort-by sort-order status'
        'opsi host-insights list-host-configurations' = 'all compartment-id defined-tag-equals defined-tag-exists em-bridge-id exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help id limit page page-size platform-type sort-by sort-order'
        ...
        'opsi host-insights summarize-host-insight-resource-capacity-trend' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help id page platform-type resource-metric sort-by sort-order time-interval-end time-interval-start utilization-level'
        'opsi host-insights summarize-host-insight-resource-forecast-trend' = 'analysis-time-interval compartment-id confidence defined-tag-equals defined-tag-exists exadata-insight-id forecast-days forecast-model freeform-tag-equals freeform-tag-exists from-json help id page platform-type resource-metric statistic time-interval-end time-interval-start utilization-level'
        'opsi host-insights summarize-host-insight-resource-statistics' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists exadata-insight-id forecast-days freeform-tag-equals freeform-tag-exists from-json help id insight-by limit page percentile platform-type resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-usage' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help id page percentile platform-type resource-metric time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-usage-trend' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help id page platform-type resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-utilization-insight' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists exadata-insight-id forecast-days freeform-tag-equals freeform-tag-exists from-json help id page platform-type resource-metric time-interval-end time-interval-start'
