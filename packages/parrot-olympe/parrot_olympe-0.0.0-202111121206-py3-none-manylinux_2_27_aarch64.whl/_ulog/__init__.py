...
class struct___va_list(Structure):
    pass

struct___va_list._pack_ = True # source:False
struct___va_list._fields_ = [
    ('__stack', POINTER_T(None)),
    ('__gr_top', POINTER_T(None)),
    ('__vr_top', POINTER_T(None)),
    ('__gr_offs', ctypes.c_int32),
    ('__vr_offs', ctypes.c_int32),
]

va_list = struct___va_list
...
__all__ = \
    ...
    '__ulog_default_cookie', 'struct___va_list', 'struct_iovec',
