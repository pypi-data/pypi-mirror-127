...
class Power:
	...
	def get_value(self) -> List[float]:
		...
		Transfers the level data to the table selected with CORRection. *RST does not affect data lists. The numerical suffix at
		SOURce must not be used for this command. \n
