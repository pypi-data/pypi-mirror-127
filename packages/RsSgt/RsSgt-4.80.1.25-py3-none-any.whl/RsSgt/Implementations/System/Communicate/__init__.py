...
class Communicate:
	"""Communicate commands group definition. 22 total commands, 8 Sub-groups, 0 group commands"""
	...
	def pciExpress(self):
		...
		if not hasattr(self, '_pciExpress'):
			from .PciExpress import PciExpress
			self._pciExpress = PciExpress(self._core, self._cmd_group)
