...
class Awgn:
	"""Awgn commands group definition. 20 total commands, 4 Sub-groups, 5 group commands"""
	...
	def get_state(self) -> bool:
		...
		Activates or deactivates the white noise (AWGN = Averaged White Gaussian Noise) . Use the command AWGN:MODE to define the
		mode the AWGN generator is working in. \n
