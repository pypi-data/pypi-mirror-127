...
- une librairie écrite en Python permettant la communication avec l'application [i-Parapheur](https://www.libriciel.fr/iparapheur/) en version 4.2+, au travers de l'API REST ou via webservice SOAP.
