...
class AmplifyExportedBackend(
    ...
    def __init__(
        ...
        *,
        path: builtins.str,
        amplify_environment: typing.Optional[builtins.str] = None,
...
class AmplifyExportedBackendProps(aws_cdk.core.StackProps):
    def __init__(
        ...
        *,
        ...
        if amplify_environment is not None:
            self._values["amplify_environment"] = amplify_environment
    ...
    @builtins.property
    def amplify_environment(self) -> typing.Optional[builtins.str]:
