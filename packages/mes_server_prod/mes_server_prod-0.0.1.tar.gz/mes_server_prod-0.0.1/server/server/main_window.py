...
from packets.server import StatWindow
from packets.server import ConfigWindow
from packets.server import RegisterUser
from packets.server import DelUserDialog
