...
const releasesDisplayOptions_1 = require("app/views/releases/list/releasesDisplayOptions");
const releasesRequest_1 = (0, tslib_1.__importDefault)(require("app/views/releases/list/releasesRequest"));
describe('ReleasesRequest', function () {
    ...
    it('calculates correct session health data', function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let healthData;
            const wrapper = (0, enzyme_1.mountWithTheme)(<releasesRequest_1.default releases={[
                    ...
                    'e102abb2c46e7fe8686441091005c12aed90da99',
                        ...
                        project: [projectId],
                    } })} display={[releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS]} selection={selection}>
        {({ getHealthData }) => {
                    healthData = getHealthData;
                    return null;
                }}
      </releasesRequest_1.default>, routerContext);
            yield tick();
            wrapper.update();
            expect(healthData.getCrashCount('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(492);
            expect(healthData.getCrashFreeRate('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(99.76);
            expect(healthData.get24hCountByRelease('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(219826);
            expect(healthData.get24hCountByProject(projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(835965);
            expect(healthData.getTimeSeries('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toEqual([
                {
                    data: [
            ...
            expect(healthData.getAdoption('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(26.29607698886915);
            expect(healthData.getCrashCount('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(5);
            expect(healthData.getCrashFreeRate('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(99.921);
            expect(healthData.get24hCountByRelease('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(6320);
            expect(healthData.get24hCountByProject(projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(835965);
            expect(healthData.getTimeSeries('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toEqual([
                {
                    data: [
                        { name: 1615975200000, value: 0 },
                        { name: 1615978800000, value: 0 },
            ...
            expect(healthData.getAdoption('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(0.7560125124855706);
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const wrapper = (0, enzyme_1.mountWithTheme)(<releasesRequest_1.default releases={[
                    ...
                    'e102abb2c46e7fe8686441091005c12aed90da99',
                        ...
                        project: [projectId],
                    } })} display={[releasesDisplayOptions_1.ReleasesDisplayOption.USERS]} selection={selection}>
        {({ getHealthData }) => {
                    healthData = getHealthData;
                    return null;
                }}
            ...
            wrapper.update();
            expect(healthData.getCrashCount('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(492);
            expect(healthData.getCrashFreeRate('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toBe(99.908);
            expect(healthData.get24hCountByRelease('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toBe(56826);
            expect(healthData.get24hCountByProject(projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toBe(140965);
            expect(healthData.getTimeSeries('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toEqual([
                {
                    data: [
                        { name: 1615975200000, value: 0 },
                        { name: 1615978800000, value: 0 },
            ...
            expect(healthData.getAdoption('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toBe(40.31213421771362);
            expect(healthData.getCrashCount('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS)).toBe(5);
            expect(healthData.getCrashFreeRate('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toBe(99.87);
            expect(healthData.get24hCountByRelease('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toBe(850);
            expect(healthData.get24hCountByProject(projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toBe(140965);
            expect(healthData.getTimeSeries('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toEqual([
                {
                    data: [
                        { name: 1615975200000, value: 0 },
                        { name: 1615978800000, value: 0 },
            ...
            expect(healthData.getAdoption('e102abb2c46e7fe8686441091005c12aed90da99', projectId, releasesDisplayOptions_1.ReleasesDisplayOption.USERS)).toBe(0.6029865569467598);
        });
    });
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const wrapper = (0, enzyme_1.mountWithTheme)(<releasesRequest_1.default releases={[
                    ...
                    'e102abb2c46e7fe8686441091005c12aed90da99',
                        ...
                        project: [projectId],
                    } })} display={[releasesDisplayOptions_1.ReleasesDisplayOption.SESSIONS]} selection={selection} healthStatsPeriod={types_1.HealthStatsPeriodOption.AUTO}>
        {({ getHealthData }) => {
                    healthData = getHealthData;
                    return null;
                }}
...
//# sourceMappingURL=releasesRequest.spec.jsx.map