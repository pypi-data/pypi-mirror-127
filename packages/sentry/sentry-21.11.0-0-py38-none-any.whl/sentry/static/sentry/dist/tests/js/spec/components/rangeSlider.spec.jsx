...
describe('RangeSlider', function () {
    it('changes value / has right label', function () {
        const wrapper = (0, enzyme_1.mountWithTheme)(<rangeSlider_1.default name="test" value={5} min={0} max={10} onChange={() => { }}/>);
    ...
    it('can use formatLabel', function () {
        const wrapper = (0, enzyme_1.mountWithTheme)(<rangeSlider_1.default name="test" value={5} min={0} max={10} formatLabel={value => (<div className="test">{value === 7 ? 'SEVEN!' : Number(value) + 1}</div>)} onChange={() => { }}/>);
    ...
    it('calls onChange', function () {
        ...
        const wrapper = (0, enzyme_1.mountWithTheme)(<rangeSlider_1.default name="test" value={5} min={0} max={10} onChange={onChange}/>);
    ...
    it('can provide a list of allowedValues', function () {
        const onChange = jest.fn();
        const wrapper = (0, enzyme_1.mountWithTheme)(<rangeSlider_1.default name="test" value={1000} min={0} max={10} allowedValues={[0, 100, 1000, 10000, 20000]} onChange={onChange}/>);
    ...
    it('handles invalid values', function () {
        const onChange = jest.fn();
        const wrapper = (0, enzyme_1.mountWithTheme)(<rangeSlider_1.default name="test" value={1000} min={0} max={10} allowedValues={[0, 100, 1000, 10000, 20000]} // support unsorted arrays?
         onChange={onChange}/>);
