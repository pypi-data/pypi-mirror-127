...
const sourceField_1 = (0, tslib_1.__importDefault)(require("app/views/settings/components/dataScrubbing/modals/form/sourceField"));
const utils_1 = require("app/views/settings/components/dataScrubbing/utils");
function renderComponent(_a) {
    var { value = '$string', onChange = jest.fn() } = _a, props = (0, tslib_1.__rest)(_a, ["value", "onChange"]);
    return (0, enzyme_1.mountWithTheme)(<sourceField_1.default isRegExMatchesSelected={false} suggestions={utils_1.valueSuggestions} onChange={onChange} value={value} {...props}/>);
}
describe('Source', () => {
    it('default render', () => {
