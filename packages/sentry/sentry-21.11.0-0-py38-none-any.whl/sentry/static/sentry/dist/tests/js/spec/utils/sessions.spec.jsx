...
describe('utils/sessions', () => {
    ...
    describe('getCountAtIndex', () => {
        const groups = [sessionsApiResponse.groups[1], sessionsApiResponse.groups[2]];
        it('returns sessions count', () => {
            expect((0, sessions_1.getCountAtIndex)(groups, types_1.SessionField.SESSIONS, 1)).toBe(35);
        });
        it('returns users count', () => {
            expect((0, sessions_1.getCountAtIndex)(groups, types_1.SessionField.USERS, 1)).toBe(16);
        });
    });
    ...
    describe('getSessionsInterval', () => {
        describe('with high fidelity', () => {
            it('>= 60 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '60d' }, { highFidelity: true })).toBe('1d');
            });
            it('>= 30 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '30d' }, { highFidelity: true })).toBe('4h');
            });
            it('14 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '14d' }, { highFidelity: true })).toBe('1h');
            });
            it('>= 6 hours', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '6h' }, { highFidelity: true })).toBe('1h');
            });
            ...
            it('less or equal to 10 minutes', () => {
                expect((0, sessions_1.getSessionsInterval)({ start: '2021-10-08T12:00:00Z', end: '2021-10-08T12:05:00.000Z' }, { highFidelity: true })).toBe('10s');
            });
        ...
        describe('with low fidelity', () => {
            it('>= 60 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '60d' })).toBe('1d');
                expect((0, sessions_1.getSessionsInterval)({ start: '2021-07-19T15:14:23Z', end: '2021-10-19T15:14:23Z' }, { highFidelity: true })).toBe('1d');
            });
            it('>= 30 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '30d' })).toBe('4h');
            });
            it('14 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '14d' })).toBe('1h');
            });
            it('>= 6 hours', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '6h' })).toBe('1h');
            });
            it('between 6 hours and 30 minutes', () => {
