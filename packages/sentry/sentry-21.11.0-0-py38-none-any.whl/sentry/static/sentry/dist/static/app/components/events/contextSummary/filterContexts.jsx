...
function filterContexts(event, context) {
    ...
    if (context.keys.includes('device')) {
        const { model, arch } = ((_a = event.contexts) === null || _a === void 0 ? void 0 : _a.device) || {};
        const { name: os } = ((_b = event.contexts) === null || _b === void 0 ? void 0 : _b.os) || ((_c = event.contexts) === null || _c === void 0 ? void 0 : _c.client_os) || {};
