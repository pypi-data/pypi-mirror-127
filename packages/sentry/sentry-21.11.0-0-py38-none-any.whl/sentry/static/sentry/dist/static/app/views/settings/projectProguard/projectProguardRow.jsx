...
const ProjectProguardRow = ({ mapping, onDelete, downloadUrl, downloadRole }) => {
    ...
    return (<react_1.Fragment>
      <NameColumn>
        <Name>{debugId || uuid || `(${(0, locale_1.t)('empty')})`}</Name>
        <TimeWrapper>
      ...
      <ActionsColumn>
        <buttonBar_1.default gap={0.5}>
          <role_1.default role={downloadRole}>
            {({ hasRole }) => (<tooltip_1.default title={(0, locale_1.t)('You do not have permission to download mappings.')} disabled={hasRole}>
                <button_1.default size="small" icon={<icons_1.IconDownload size="sm"/>} disabled={!hasRole} href={downloadUrl} title={hasRole ? (0, locale_1.t)('Download Mapping') : undefined}/>
              </tooltip_1.default>)}
          </role_1.default>

          <access_1.default access={['project:releases']}>
            {({ hasAccess }) => (<tooltip_1.default disabled={hasAccess} title={(0, locale_1.t)('You do not have permission to delete mappings.')}>
                <confirm_1.default message={(0, locale_1.t)('Are you sure you want to remove this mapping?')} onConfirm={handleDeleteClick} disabled={!hasAccess}>
                  <button_1.default size="small" icon={<icons_1.IconDelete size="sm"/>} title={hasAccess ? (0, locale_1.t)('Remove Mapping') : undefined} label={(0, locale_1.t)('Remove Mapping')} disabled={!hasAccess}/>
                </confirm_1.default>
              </tooltip_1.default>)}
          </access_1.default>
        </buttonBar_1.default>
