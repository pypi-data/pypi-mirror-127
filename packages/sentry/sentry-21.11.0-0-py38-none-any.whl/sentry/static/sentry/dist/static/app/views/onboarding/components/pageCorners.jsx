...
const PageCorners = ({ animateVariant }) => (<Container>
...
const TopLeft = (0, styled_1.default)(framer_motion_1.motion.svg) `
  position: absolute;
  top: 0;
  left: 0;
`;
...
const TopRight = (0, styled_1.default)(framer_motion_1.motion.svg) `
  position: absolute;
  top: 0;
  right: 0;
`;
...
const BottomLeft = (0, styled_1.default)(framer_motion_1.motion.svg) `
  position: absolute;
  bottom: 0;
  left: 0;
`;
...
const BottomRight = (0, styled_1.default)(framer_motion_1.motion.svg) `
  position: absolute;
  bottom: 0;
  right: 0;
`;
