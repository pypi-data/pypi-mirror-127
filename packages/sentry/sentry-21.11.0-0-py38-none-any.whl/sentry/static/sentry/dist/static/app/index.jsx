...
function app() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const initalizeMainImport = Promise.resolve().then(() => __importStar(require('app/bootstrap/initializeMain')));
        const bootstrapImport = Promise.resolve().then(() => __importStar(require('app/bootstrap')));
        const { bootstrap } = yield bootstrapImport;
        const config = yield bootstrap();
        const { initializeMain } = yield initalizeMainImport;
