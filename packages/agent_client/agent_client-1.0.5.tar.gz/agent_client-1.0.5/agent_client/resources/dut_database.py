...
class DutDatabase(SqlConnection):
    ...
    def add_slot(self, slot_index, agent, config_name=""):
        self.insert_to_table(self.slot_table, name="slot_{}".format(slot_index),
                             slot=slot_index, config_name=config_name, agent=agent)
