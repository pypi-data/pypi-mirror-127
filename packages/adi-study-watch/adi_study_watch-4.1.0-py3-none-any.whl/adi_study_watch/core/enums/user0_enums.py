...
class User0Event(Enum):
    ...
    WATCH_OFF_CRADLE_BLE_DISCONNECT_NW_TERMINATED = [0x6]
    RTC_TIMER_INTERRUPT = [0x7]
    BLE_ADV_TIMEOUT = [0x8]
    USB_DISCONNECT_UNEXPECTED = [0x9]
    BATTERY_FULL = [0xA]
    FINISH_LOG_TRANSFER = [0xB]
    WATCH_OFF_CRADLE_BLE_CONNECTION = [0xC]
