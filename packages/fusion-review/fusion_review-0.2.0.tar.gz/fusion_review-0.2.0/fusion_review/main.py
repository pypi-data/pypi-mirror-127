...
from intensities import IntensitySuperStructure, IntensityDatabase
from figpan import IntensityTraceFigurePanel
from utilog import UserInputHandler
...
def handle_input_codes(panel_num, trace_panel, input_handler):
    ...
    elif user_input_code == 2 or user_input_code == 3:
        # fusion! or undo-fusion
        panel_num -= 1
        trace_panel.curridx = input_handler.start_trace - 1
