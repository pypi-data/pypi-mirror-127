...
class MediaPlayer(QWidget):
    ...
    def __init__(self, icon_path=None, *args, **kwargs):
        ...
        self.setWindowIcon(QIcon(icon_path if icon_path else SET_APP_ICON_PATH if SET_APP_ICON_PATH else None))
        self.duration = 0
...
class DialogWait(QSplashScreen):
    def __init__(
            ...
            font=("Arial Black", 21, QFont.Bold),
    ...
    def show_message(
            self, message=f'{SET_APP_NAME_TITLE}Running\nPlease Wait ...', color=Qt.white, alignment=Qt.AlignCenter
    ):
        self.show()
        self.clearMessage()
...
class SetQTableWidget(QTableWidget):
    ...
    def table_widget_update(self, column_labels, data=None):
        self.clear()
