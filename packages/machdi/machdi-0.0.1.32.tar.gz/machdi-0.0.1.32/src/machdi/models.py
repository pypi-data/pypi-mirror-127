...
class LinearRegressor(_LinearModels,_Optimization):
    ...
    def __init__(self, penalty='L2' ,alpha=0, bias_included=False,train_type=None,lr=.001,n_reports=0,maxIter=100, converLim=.001,n_converLim=1,plotting = False):
        super().__init__(penalty=penalty, alpha=alpha, include_bias=bias_included,train_type=train_type,lr=lr,n_reports=n_reports,maxIter=maxIter,converLim=converLim,n_converLim=n_converLim,plotting=plotting)
        self.activ = 'linear'
