...
class RemoteJob(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"encoded_args",b"encoded_args",u"hostname",b"hostname",u"namespace",b"namespace",u"qualified_symbol",b"qualified_symbol",u"task_id",b"task_id"]) -> None: ...
