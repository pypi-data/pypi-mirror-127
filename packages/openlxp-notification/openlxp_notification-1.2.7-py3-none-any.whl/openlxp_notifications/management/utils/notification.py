...
def send_notifications(email, sender, email_configuration):
    ...
    zipfile.ZipFile('media/Zipped_file.zip', mode='w').write(ATTACHMENT)
    ...
    att = MIMEApplication(open('media/Zipped_file.zip', 'rb').read())
    # os.remove('media/Zipped_file.zip')

    # Add a header to tell the email client to treat this part as an
    # attachment, and to give the attachment a name.
    att.add_header('Content-Disposition', 'attachment',
                   filename="OpenLXP notifications" + ".zip")
