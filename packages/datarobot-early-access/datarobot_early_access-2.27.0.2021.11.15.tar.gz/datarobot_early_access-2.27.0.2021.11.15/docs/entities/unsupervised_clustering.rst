...
Use the following methods to alter cluster names:
  - ``update_multiple_names`` - changes multiple cluster names using mapping
  - ``update_name`` - changes one cluster name
