...
from typing import IO, List, Union, Generator, cast
...
class TarReader(tarfile.TarFile, ArchiveReaderInterface):
    ...
    def opener(cls, path: Union[str, "PathLike[str]"]) -> "TarReader":
        ...
        return cast("TarReader", cls.open(path, format=tarfile.PAX_FORMAT))
