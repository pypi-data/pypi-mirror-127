...
This module extends the instance with a dictionary under `instance.properties["alira.modules.s3"]` containing the following attributes (if `module_id` is specified, the dictionary key will be its value):
