...
-   `sender`: The email address of the sender of the notification.
...
-   `image`: The instance's property referencing the image URL that will be included in the notification. If this attribute is not specified, the message will not include an image. This value of this attribute should point to a publicly accessible URL of an image.
