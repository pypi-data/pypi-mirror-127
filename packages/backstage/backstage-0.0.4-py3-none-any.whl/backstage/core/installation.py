...
from backstage.core.constant import BACKSTAGE_DATA_PATH, BACKSTAGE_HOOKING_DIR
...
def _makedirs():
    paths = (BACKSTAGE_DATA_PATH, BACKSTAGE_HOOKING_DIR)
    for path in paths:
...
def _init_config_files():
    ...
    Jason("init.json", default=default,
          location=BACKSTAGE_HOOKING_DIR)
    # build.json
