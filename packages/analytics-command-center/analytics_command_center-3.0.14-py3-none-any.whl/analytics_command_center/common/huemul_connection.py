import requests
from analytics_command_center.common.huemul_param import HuemulParam 
from analytics_command_center.common.huemul_common import huemulCommon
from analytics_command_center.common.huemul_http_info import HuemulHttpInfo
...
class HuemulConnection:
    ...
    def authRequest(self, route, data, orgId):
        ...
        try:
            # create object
            uriFinal = huemulCommon.getServiceUrl() + route
    ...
    def postRequest(self, route, data, queryParams = []):
        ...
        try:
            # create object
            uriFinal = huemulCommon.getServiceUrl() + route + routeParams
    ...
    def getHeader(self, headerParams):
        dataToReturn = {
            ...
            "huemul-client-app" : "SERVER",
            "huemul-client-info" : "",
            "authorization": "Bearer " + huemulCommon.getTokenId(),
    ...
    def _getResponse(self, response):
        ...
        try:
            ...
            huemulResponse.errors.append(HuemulResponseError(errorId = "1", errorTxt = str(e)))
