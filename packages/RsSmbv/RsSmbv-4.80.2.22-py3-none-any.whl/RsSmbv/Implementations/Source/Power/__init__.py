...
class Power:
	...
	def get_lbehaviour(self) -> enums.PowLevBehaviour:
		...
		Selects the level behavior at the RF output over time. \n
			:return: behaviour: AUTO| UNINterrupted| MONotone| CVSWr| USER| CPHase UNINterrupted|MONotone Do not use the uninterrupted level settings and strictly monotone modes in combination with the high-quality optimization mode (see BB:IMPairment:OPTimization:MODE) . CWSWr Constant VSWR
		"""
	...
	def set_lbehaviour(self, behaviour: enums.PowLevBehaviour) -> None:
		...
		Selects the level behavior at the RF output over time. \n
			:param behaviour: AUTO| UNINterrupted| MONotone| CVSWr| USER| CPHase UNINterrupted|MONotone Do not use the uninterrupted level settings and strictly monotone modes in combination with the high-quality optimization mode (see BB:IMPairment:OPTimization:MODE) . CWSWr Constant VSWR
		"""
