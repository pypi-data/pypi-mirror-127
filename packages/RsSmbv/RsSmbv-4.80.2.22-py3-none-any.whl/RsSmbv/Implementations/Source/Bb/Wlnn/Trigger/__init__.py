...
class Trigger:
	...
	def get_sl_unit(self) -> enums.UnitSlB:
		...
		Defines the unit for the entry of the length of the signal sequence (BB:WLNN:TRIGger:SLENgth) to be output in the single
		trigger mode (BB:SEQuence is set to SINGle) . \n
