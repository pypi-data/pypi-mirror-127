...
class Analysis:
	...
	def get_ua_factor(self) -> enums.AvionicDmeUsedFact:
		...
		Sets which internal adjustment factor is used. \n
			:return: used_factor: INTernal| PSENsor INTernal The mathematically calculated value of the time, when the pulse reaches its 50% level. Query the internal adjustment factor with DME:ANALysis:IAFactor PSENsor The adjustment factor measured during a normalization setup. Query the power sensor adjustment factor with DME:ANALysis:PSAFactor
		"""
	...
	def set_ua_factor(self, used_factor: enums.AvionicDmeUsedFact) -> None:
		...
		Sets which internal adjustment factor is used. \n
			:param used_factor: INTernal| PSENsor INTernal The mathematically calculated value of the time, when the pulse reaches its 50% level. Query the internal adjustment factor with DME:ANALysis:IAFactor PSENsor The adjustment factor measured during a normalization setup. Query the power sensor adjustment factor with DME:ANALysis:PSAFactor
		"""
