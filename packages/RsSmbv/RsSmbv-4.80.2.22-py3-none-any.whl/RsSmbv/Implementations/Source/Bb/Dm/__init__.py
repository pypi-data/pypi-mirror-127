...
class Dm:
	"""Dm commands group definition. 100 total commands, 19 Sub-groups, 6 group commands"""
	...
	def get_format_py(self) -> enums.BbDmModType:
		...
		Sets the modulation type. When a standard is selected (BB:DM:STANdard) , the modulation type is set to the default value. \n
