...
class Power:
	...
	def set(self, power: float, mobileStation=repcap.MobileStation.Default, channel=repcap.Channel.Default) -> None:
		...
		the channel for Misuse Output Power Control. With the command BB:C2K:POWer:ADJust, the power of all the activated
		channels is adapted so that the total power corresponds to 0 dB. This does not change the power ratio among the
