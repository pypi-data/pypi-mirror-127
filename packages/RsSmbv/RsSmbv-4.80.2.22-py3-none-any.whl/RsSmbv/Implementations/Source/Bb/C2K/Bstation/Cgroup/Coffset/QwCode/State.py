...
class State:
	...
	def set(self, state: bool, baseStation=repcap.BaseStation.Default, groupNull=repcap.GroupNull.Default, offset=repcap.Offset.Default) -> None:
		...
		selected for all channels of the base station with command BB:C2K:BSTation<st>:QWSet. For the traffic channels, this
		value is specific for the selected radio configuration. It is only available for radio configuration 3 and higher. \n
