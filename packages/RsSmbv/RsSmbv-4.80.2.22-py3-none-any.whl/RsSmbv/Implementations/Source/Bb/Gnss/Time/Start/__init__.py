...
class Start:
	"""Start commands group definition. 39 total commands, 11 Sub-groups, 3 group commands"""
	...
	def get_to_week(self) -> float:
		...
		If time base is GPS or GST, sets the simulation start time within week set with the command BB:GNSS:TIME:STARt:WNUMber. \n
