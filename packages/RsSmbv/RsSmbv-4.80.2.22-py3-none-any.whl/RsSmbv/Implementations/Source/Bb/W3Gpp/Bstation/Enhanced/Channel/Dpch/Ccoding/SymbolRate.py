...
class SymbolRate:
	...
	def get(self, channelNull=repcap.ChannelNull.Default) -> enums.SymbRate:
		...
		The symbol rate depends on the selected slot format (BB:W3GPp:BSTation:ENHanced:CHANnel<ch0>:DPCH:CCODing:SFORmat) , and
		if the slot format changes, this changes automatically as well. \n
