...
class PonNack:
	...
	def set(self, pon_nack: float, mobileStation=repcap.MobileStation.Default) -> None:
		...
		relative to the CQI Power PCQI (BB:W3GPp:MSTation<st>:DPCCh:HS:POWer) . The power PNACK/NACK used during the HARQ-ACK
		slots is calculated as: PNACK/NACK = PCQI + Poff_NACK/NACK \n
