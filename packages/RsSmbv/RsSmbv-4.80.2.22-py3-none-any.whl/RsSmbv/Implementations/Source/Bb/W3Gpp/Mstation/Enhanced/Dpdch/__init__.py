...
class Dpdch:
	...
	def get_interleaver_2(self) -> bool:
		...
		(BB:W3GPp:MSTation:ENHanced:DPDCh:TCHannel<di0>:INTerleaver) . Note: The interleaver states do not cause the symbol rate
		to change \n
	...
	def get_orate(self) -> enums.SymbRate:
		...
		command BB:W3GPp:MSTation<st>:DPDCh:ORATe. This setting also defines the number of active channels, their symbol rates
		and channelization codes. \n
