...
class Cfr:
	...
	def get_cspacing(self) -> float:
		...
		Sets the channel spacing, if BB:ARBitrary:CFR:FILTer is set to SIMPle. \n
	...
	def get_forder(self) -> int:
		...
		Sets the maximum filter order, if BB:ARBitrary:CFR:FILTer is set to ENHanced. \n
	...
	def get_pfreq(self) -> float:
		...
		Sets the passband frequency, if BB:ARBitrary:CFR:FILTer is set to ENHanced. Frequency components lower than the passband
		frequency are passed through unfiltered. \n
	...
	def get_sbandwidth(self) -> float:
		...
		Sets the signal bandwidth, if BB:ARBitrary:CFR:FILTer is set to SIMPle. The value of the signal bandwidth should not be
		higher than the channel spacing (BB:ARBitrary:CFR:CSPacing) . \n
	...
	def get_sfreq(self) -> float:
		...
		Sets the stopband frequency of the filter, if BB:ARBitrary:CFR:FILTer is set to ENHanced. Frequency components higher
		than the stopband frequency are filtered out by the lowpass filter. \n
