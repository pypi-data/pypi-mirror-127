...
class Mindex:
	...
	def set(self, mindex: float, channel=repcap.Channel.Default) -> None:
		...
		the command BB:BTOoth:SRATe:VARiation <img border='0' src='images/img388349408bdb4b210a00206a01f5817c_1_--_--_PNG96.png'
		alt='' title=''>= 'frequency deviation', set with the command BB:BTOoth:MSETtings:FDEViation According to the Bluetooth
		standard, the modulation index is allowed to vary between 0.28 and 0.35. \n
