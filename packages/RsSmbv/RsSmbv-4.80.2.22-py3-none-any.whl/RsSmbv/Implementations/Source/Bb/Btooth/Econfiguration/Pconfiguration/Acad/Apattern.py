...
class Apattern:
	"""Apattern commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""
	...
	def set(self, dpattern: List[str], bitcount: int) -> None:
		...
		Specifies user-defined pattern. The settings is relevant for BB:BTOoth:ECONfiguration:PCONfiguration:ACADPATTern \n
