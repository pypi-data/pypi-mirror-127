...
class Hold:
	...
	def get_state(self) -> bool:
		...
		Snippet: value: bool = driver.source.correction.fresponse.rf.optimization.hold.get_state() \n
			INTRO_CMD_HELP: For CORRection:FRESponse:RF:OPTimization:MODEQHIG|QHT, retains the last calculated correction values as long as one of the following is performed: \n
			- SOURce1:CORRection:FRESponse:RF:OPTimization:HOLD:STATe 0
			- CORRection:FRESponse:RF:OPTimization:LOCal \n
