...
class Analog:
	...
	def get_mode(self) -> enums.IqOutMode:
		...
		Determines the mode for setting the output parameters. \n
			:return: mode: FIXed| VARiable | VATTenuated FIXed Locks the I/Q output settings VARiable Unlocks the settings VATTenuated Attenuates the signal with the value set with the command IQ:OUTPut:POWer:ATTDigital.
		"""
	...
	def set_mode(self, mode: enums.IqOutMode) -> None:
		...
		Determines the mode for setting the output parameters. \n
			:param mode: FIXed| VARiable | VATTenuated FIXed Locks the I/Q output settings VARiable Unlocks the settings VATTenuated Attenuates the signal with the value set with the command IQ:OUTPut:POWer:ATTDigital.
		"""
	...
	def preset(self) -> None:
		...
		Sets the default settings (*RST values specified for the commands) .
			...
			- The state set with the command IQ:OUTPut:ANALog:STATe.
