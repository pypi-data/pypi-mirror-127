...
class Findex:
	...
	def set(self, findex: int, output=repcap.Output.Default) -> None:
		...
		Sets the frame index, that is, the frame to be marked in the frame block marked with BB:WLNN:TRIGger:OUTPut<ch>:FBINdex.
		The maximum value depends on the number of frames set with command BB:WLNN:FBLock<ch>:FCOunt . The maximum value is 1024. \n
