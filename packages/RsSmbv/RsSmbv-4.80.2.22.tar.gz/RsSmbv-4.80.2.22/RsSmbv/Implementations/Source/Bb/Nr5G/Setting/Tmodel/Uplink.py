...
class Uplink:
	...
	def set_value(self, tmod_up: str) -> None:
		...
		Loads a test model file with predefined settings. \n
			:param tmod_up: 'filename' Filename as queried with one of the following commands: BB:NR5G:SETTing:TMODel:UL:CATalog BB:NR5G:SETTing:TMODel:DL:CATalog BB:NR5G:SETTing:TMODel:FILTer:CATalog
		"""
