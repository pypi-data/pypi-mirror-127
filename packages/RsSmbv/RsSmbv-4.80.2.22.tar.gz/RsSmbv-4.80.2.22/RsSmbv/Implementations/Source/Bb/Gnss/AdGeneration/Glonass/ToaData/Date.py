...
class Date:
	...
	def set(self, year: int, month: int, day: int) -> None:
		...
		Enabled for UTC or GLONASS timebase (BB:GNSS:ADGeneration:GPS:TOAData:TBASis) . Enters the date for the assistance data
		in DMS format of the Gregorian calendar. \n
