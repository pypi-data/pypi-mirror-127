...
class Output:
	...
	def get_cmode(self) -> enums.Dimensions:
		"""SCPI: [SOURce<HW>]:BB:NR5G:OUTPut:CMODe \n
		Snippet: value: enums.Dimensions = driver.source.bb.nr5G.output.get_cmode() \n
	...
	def set_cmode(self, clipping_mode: enums.Dimensions) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:OUTPut:CMODe \n
		Snippet: driver.source.bb.nr5G.output.set_cmode(clipping_mode = enums.Dimensions.SCALar) \n
		Sets the method for level clipping. \n
			:param clipping_mode: VECTor| SCALar
		"""
		param = Conversions.enum_scalar_to_str(clipping_mode, enums.Dimensions)
