...
class Data:
	...
	def set(self, data: enums.DataSourceA, mobileStation=repcap.MobileStation.Default, channel=repcap.Channel.Default) -> None:
		...
		the command BB:C2K:MSTation<st>:TPC:DATA. For the traffic channels, this value is specific for the selected radio
		configuration. \n
			:param data: ZERO| ONE| PATTern| PN9| PN11| PN15| PN16| PN20| PN21| PN23| DLISt PNxx The pseudo-random sequence generator is used as the data source. Different random sequence lengths can be selected. DLISt A data list is used. The data list is selected with the command BB:C2K:MSTationst:CHANnelch:DATA:DSELect. ZERO | ONE Internal 0 and 1 data is used. PATTern Internal data is used. The bit pattern for the data is defined by the command BB:C2K:MSTationst:CHANnelch:DATA:PATTern.
