...
class PoaNack:
	...
	def set(self, poa_nack: float, mobileStation=repcap.MobileStation.Default) -> None:
		...
		to the CQI Power PCQI (BB:W3GPp:MSTation<st>:DPCCh:HS:POWer) . The power PACK/NACK used during the HARQ-ACK slots is
		calculated as: PACK/NACK = PCQI + Poff_ACK/NACK \n
