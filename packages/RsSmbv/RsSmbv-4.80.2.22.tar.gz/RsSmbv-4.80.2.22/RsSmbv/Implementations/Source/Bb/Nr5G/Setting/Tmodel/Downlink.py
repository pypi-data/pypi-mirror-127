...
class Downlink:
	...
	def get_value(self) -> str:
		...
		Loads a test model file with predefined settings. \n
			:return: tmod_down: 'filename' Filename as queried with one of the following commands: BB:NR5G:SETTing:TMODel:UL:CATalog BB:NR5G:SETTing:TMODel:DL:CATalog BB:NR5G:SETTing:TMODel:FILTer:CATalog
		"""
	...
	def set_value(self, tmod_down: str) -> None:
		...
		Loads a test model file with predefined settings. \n
			:param tmod_down: 'filename' Filename as queried with one of the following commands: BB:NR5G:SETTing:TMODel:UL:CATalog BB:NR5G:SETTing:TMODel:DL:CATalog BB:NR5G:SETTing:TMODel:FILTer:CATalog
		"""
