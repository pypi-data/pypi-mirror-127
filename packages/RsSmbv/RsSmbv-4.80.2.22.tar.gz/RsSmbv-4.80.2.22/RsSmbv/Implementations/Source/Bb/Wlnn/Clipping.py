...
class Clipping:
	...
	def get_level(self) -> int:
		...
		if BB:WLNN:CLIPping:STATe is set to ON. \n
	...
	def get_mode(self) -> enums.Dimensions:
		...
		Snippet: value: enums.Dimensions = driver.source.bb.wlnn.clipping.get_mode() \n
	...
	def set_mode(self, mode: enums.Dimensions) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:CLIPping:MODE \n
		Snippet: driver.source.bb.wlnn.clipping.set_mode(mode = enums.Dimensions.SCALar) \n
		Sets the method for level clipping. \n
	...
	def get_state(self) -> bool:
		...
		Activates level clipping (Clipping) . The value is defined with BB:WLNN:CLIPping:LEVel, the mode of calculation with
		BB:WLNN:CLIPping:MODE. \n
