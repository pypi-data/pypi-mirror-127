...
class Clipping:
	...
	def get_mode(self) -> enums.Dimensions:
		...
		Snippet: value: enums.Dimensions = driver.source.bb.btooth.clipping.get_mode() \n
	...
	def set_mode(self, mode: enums.Dimensions) -> None:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:CLIPping:MODE \n
		Snippet: driver.source.bb.btooth.clipping.set_mode(mode = enums.Dimensions.SCALar) \n
		The command sets the method for level clipping (Clipping) . \n
	...
	def get_state(self) -> bool:
		...
		The command activates level clipping (Clipping) . The value is defined with the command BB:BTO:CLIPping:LEVel, the mode
		of calculation with the command BB:BTO:CLIPping:MODE. \n
