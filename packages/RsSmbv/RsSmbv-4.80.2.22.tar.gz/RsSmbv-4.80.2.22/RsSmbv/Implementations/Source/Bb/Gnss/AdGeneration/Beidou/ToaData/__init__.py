...
class ToaData:
	"""ToaData commands group definition. 7 total commands, 2 Sub-groups, 5 group commands"""
	...
	def get_to_week(self) -> int:
		...
		Enabled for GPS timebase (BB:GNSS:ADGeneration:GPS:TOAData:TBASis) . Determines the Time of Week (TOW) the assistance
	...
	def get_wnumber(self) -> int:
		...
		Enabled for GPS timebase (BB:GNSS:ADGeneration:QZSS:TOAData:TBASis) . Sets the week number (WN) the assistance data is
		generated for. \n
