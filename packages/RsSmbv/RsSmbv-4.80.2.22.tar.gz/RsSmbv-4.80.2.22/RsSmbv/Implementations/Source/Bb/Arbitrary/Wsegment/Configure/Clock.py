...
class Clock:
	...
	def get_mode(self) -> enums.ArbWaveSegmClocMode:
		...
		Selects the clock rate mode for the multi segment waveform. Use the command BB:ARBitrary:WSEGment:CONFigure:CLOCk to
		define the clock in clock mode user. \n
