...
class Mcch:
	"""Mcch commands group definition. 15 total commands, 5 Sub-groups, 10 group commands"""
	...
	def get_noffset(self) -> int:
		...
		Defines, together with the BB:EUTRa:DL:MBSFn:AI:MCCH:NRC, the radio frames in which the MCCH information change
	...
	def get_offs(self) -> int:
		...
		Indicates, together with the BB:EUTRa:DL:MBSFn:AI:MCCH:RPER, the radio frames in which MCCH is scheduled. \n
