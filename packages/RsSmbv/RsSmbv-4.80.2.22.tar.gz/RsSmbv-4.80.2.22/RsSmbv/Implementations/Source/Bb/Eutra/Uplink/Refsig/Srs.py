...
class Srs:
	...
	def get_dsfc(self) -> str:
		...
		SRS subframe configuration (BB:EUTRa:UL:REFSig:SRS:CSRS) and the dduplexing mode (BB:EUTRa:DUPLexing) . \n
	...
	def get_tsfc(self) -> str:
		...
		subframe configuration (BB:EUTRa:UL:REFSig:SRS:CSRS) and the duplexing mode (BB:EUTRa:DUPLexing) . \n
			:return: tsfc: string
		"""
