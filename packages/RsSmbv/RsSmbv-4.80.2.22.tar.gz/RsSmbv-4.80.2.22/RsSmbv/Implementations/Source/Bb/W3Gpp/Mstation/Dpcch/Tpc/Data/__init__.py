...
class Data:
	...
	def set(self, data: enums.TpcDataSour, mobileStation=repcap.MobileStation.Default) -> None:
		...
		The command determines the data source for the TPC field of the DPCCH. \n
			:param data: DLISt| ZERO | ONE| PATTern| DLISt A data list is used. The data list is selected with the command BB:W3GPp:MSTationst:DPCCh:TPC:DATA:DSELect. ZERO | ONE Internal 0 and 1 data is used. PATTern Internal data is used. The bit pattern for the data is defined by the command BB:W3GPp:MSTationst:DPCCh:TPC:DATA:PATTern. The maximum length is 64 bits.
