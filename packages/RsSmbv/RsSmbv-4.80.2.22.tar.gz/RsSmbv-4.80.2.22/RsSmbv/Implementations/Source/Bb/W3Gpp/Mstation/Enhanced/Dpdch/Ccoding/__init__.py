...
class Ccoding:
	...
	def get_state(self) -> bool:
		...
		overall symbol rate (BB:W3GPp:MSTation:ENHanced:DPDCh:ORATe) is set to the value predetermined by the selected channel
		coding type (BB:W3GPp:MSTation:ENHanced:DPDCh:CCODing:TYPE) . \n
