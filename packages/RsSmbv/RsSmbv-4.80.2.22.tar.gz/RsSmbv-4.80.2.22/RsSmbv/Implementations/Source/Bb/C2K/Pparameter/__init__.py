...
class Pparameter:
	...
	def get_crest(self) -> enums.CresFactMode:
		...
		after execution of command BB:C2K:PPARameter:EXECute.
		The setting of command BB:C2K:BSTation<st>:CGRoup<di0>:COFFset<ch>:WCODe is adjusted according to the selection. \n
