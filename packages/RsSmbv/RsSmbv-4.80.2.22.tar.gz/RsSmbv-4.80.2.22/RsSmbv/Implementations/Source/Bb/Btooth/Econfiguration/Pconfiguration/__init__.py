...
class Pconfiguration:
	"""Pconfiguration commands group definition. 121 total commands, 45 Sub-groups, 52 group commands"""
	...
	def get_aoffset(self) -> float:
		...
		see BB:BTOoth:ECONfiguration:PCONfiguration:AOUNits \n
	...
	def get_ao_units(self) -> enums.BtoOffsUnit:
		...
		Indicates the units used by the 'Aux Offset' parameter, see BB:BTOoth:ECONfiguration:PCONfiguration:AOFFset \n
	...
	def get_mu_channels(self) -> int:
		...
		see BB:BTOoth:ECONfiguration:PCONfiguration:PHYS:L1M:STATe etc. \n
	...
	def get_sounits(self) -> enums.BtoOffsUnit:
		...
		Indicates the units used by the 'Sync Packet Offset' parameter, see BB:BTOoth:ECONfiguration:PCONfiguration:SPOFfset \n
			:return: unit: U30| U300 U30 30 µs U300 300 µs
		"""
	...
	def get_sp_offset(self) -> float:
		...
		see BB:BTOoth:ECONfiguration:PCONfiguration:SOUNits \n
