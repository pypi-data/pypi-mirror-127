...
class Data:
	"""Data commands group definition. 3 total commands, 1 Sub-groups, 2 group commands"""
	...
	def get_dselection(self) -> str:
		...
		Specifies data list file. The setting is relevant for BB:BTOoth:ECONfiguration:PCONfiguration:DATADLISt \n
	...
	def get_value(self) -> enums.BtoDataSourc:
		...
		Selects the pattern source used for the payload. \n
			:return: data: ALL0| ALL1| PATTern| PN09| PN11| PN15| PN16| PN20| PN21| PN23| DLISt ALL0 / ALL1 All 0 or all 1 pattern PATTern User-defined pattern. The pattern can be specified via: BB:BTOoth:ECONfiguration:PCONfiguration:DATA:DPATtern PNxx Pseudo-random bit sequences (PRBS) of a length of xx bits. The length in bit can be 9, 11, 15, 16, 20, 21, or 23. DLISt Internal data list is used. The data list can be specified via: BB:BTOoth:ECONfiguration:PCONfiguration:DATA:DSELection
		"""
