...
class Step:
	...
	def get_mode(self) -> enums.FreqStepMode:
		...
		Defines the type of step width to vary the RF output power step-by-step with the commands POW UP or POW DOWN. \n
			:return: mode: DECimal| USER DECimal Increases or decreases the level in steps of ten. USER Increases or decreases the level in increments, determined with the command POWer.
		"""
	...
	def set_mode(self, mode: enums.FreqStepMode) -> None:
		...
		Defines the type of step width to vary the RF output power step-by-step with the commands POW UP or POW DOWN. \n
			:param mode: DECimal| USER DECimal Increases or decreases the level in steps of ten. USER Increases or decreases the level in increments, determined with the command POWer.
		"""
