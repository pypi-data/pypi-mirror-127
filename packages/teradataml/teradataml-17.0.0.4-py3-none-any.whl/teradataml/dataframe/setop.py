...
def __process_setop_operation(df_list, allow_duplicates, setop_type, operation):
    """
    DESCRIPTION:
        Internal function to process set opertaion and return the result DataFrame.
    ...
    try:
        ...
        return __process_operation(first_df_metaexpr, is_lazy, setop_type, nodeid, index_label, index_to_use)
