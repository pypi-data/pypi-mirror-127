...
from teradataml.common.constants import TeradataConstants, SQLFunctionConstants, TDMLFrameworkKeywords
...
from teradatasqlalchemy import XML
import decimal
...
class _SQLTableExpression(_PandasTableExpression):
    ...
    def __repr__(self):
        ...
        for c in self.c:
            ...
            if isinstance(c.type, (CHAR, VARCHAR, CLOB, FLOAT, INTEGER, SMALLINT, BIGINT, BYTEINT, XML)):
