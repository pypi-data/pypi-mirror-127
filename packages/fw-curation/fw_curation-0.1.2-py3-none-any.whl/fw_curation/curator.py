...
from .reporters import AggregatedReporter, BaseLogRecord, LogRecord
...
class Curator(abc.ABC):
    ...
    def curate_container(
        self, container: Union[Any, Dict[str, Any]]
    ):  # pragma: no cover
...
class HierarchyCurator(Curator):
    ...
    def validate_container(self, container: Any) -> bool:
    ...
    def curate_container(self, container: Any):
        """Curates a generic container.
    ...
    def curate_project(self, project: Any):  # pragma: no cover
        """Curates a project.
    ...
    def curate_subject(self, subject: Any):  # pragma: no cover
        """Curates a subject.
    ...
    def curate_session(self, session: Any):  # pragma: no cover
        """Curates a session.
    ...
    def curate_acquisition(self, acquisition: Any):  # pragma: no cover
    ...
    def curate_analysis(self, analysis: Any):  # pragma: no cover
        """Curates an analysis.
    ...
    def curate_file(self, file_: Any):  # pragma: no cover
        """Curates a file.
    ...
    def validate_project(self, project: Any):  # pragma: no cover
    ...
    def validate_subject(self, subject: Any):  # pragma: no cover
    ...
    def validate_session(self, session: Any):  # pragma: no cover
    ...
    def validate_acquisition(self, acquisition: Any):  # pragma: no cover
    ...
    def validate_analysis(self, analysis: Any):  # pragma: no cover
    ...
    def validate_file(self, file_: Any):  # pragma: no cover
...
class FileCurator(Curator):
    def curate_container(self, container: Union[Any, Dict[str, Any]]) -> None:
        """Curates a generic container.
        Args:
    ...
    def curate_file(self, file_: Any) -> None:  # pragma: no cover
        """Curates a file.
    ...
    def validate_file(self, file_: Any) -> bool:  # pragma: no cover
        """Returns True if a file_ needs curation, False otherwise.
