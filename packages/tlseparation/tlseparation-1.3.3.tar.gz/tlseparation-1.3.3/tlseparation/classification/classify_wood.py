...
import numpy as np
from tlseparation.classification import classes_reference
from tlseparation.classification import wlseparation
from tlseparation.utility.filtering import class_filter
...
def reference_classification(point_cloud, knn_list, n_classes=4,
    ...
    class_file = classes_reference.DefaultClass().ref_table
    ...
    ids, count, prob = wlseparation.wlseparate_ref_voting(point_cloud, knn_list, class_file,
                                                          n_classes=n_classes)
...
def threshold_classification(point_cloud, knn, n_classes=3,
    ...
    # leaf classes.
    ids, prob = wlseparation.wlseparate_abs(point_cloud, knn, n_classes)
