...
class Logger:
    ...
    def print(self, *str_new, level=INFO, channel=DEFAULT_CHANNEL, use_style=True):
        ...
        # After applying style, add line separator (to not apply line prefix to next line)
        str_new += '\n'
    ...
    def _apply_params(self, str_new, level, channel):
        ...
        # print(appendix_line+'\n'+prefix_line, lines)
        str_new = \
            channel.color_font + channel.color_bg + \
            prefix_line + \
            str(appendix_line+'\n'+prefix_line).join(lines) + \
            appendix_line + \
            RESET
    ...
    def _on_print(self):
        ...
        while self.event_print_requested.is_set():
            ...
            with self.lock_output:
                ...
                str_out = '\r' + leading_line_done + ''.join(self.outputs) + leading_line_active
...
class LeadingLineOneliner:
    ...
    def _get_leading_line(self):
        ...
        # Add new line to string of all deactivated progbars
    ...
    def _parse_leading_line_done(self, indices_progbar):
        ...
        for index_progbar in indices_progbar:
            ...
            str_leading_line = (
                ...
                # ' |\u02E1\u1d52\u1d4d\u1d47\u1d52\u02e3' +
                appendix.format(str_time_elapsed))
            leading_line.append(str_leading_line)
...
def _on_exit():
    ...
    Note:
        ...
        Thus we need to use globals anyways.
    """
    # if exception is None:
    t_elapsed = time.time() - t_start
    str_timer_info = str('\n\nTotal runtime: {} ' + LIGHT_GRAY + '(since logger start)\n').format(format_time(t_elapsed))
