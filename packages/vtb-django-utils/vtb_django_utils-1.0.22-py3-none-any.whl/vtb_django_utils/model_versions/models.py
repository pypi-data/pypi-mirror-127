...
class ModelWithVersionedRelations(ModelVersionedRelFieldsInfoMixin, models.Model):
...
class VersionedModelMixin(ModelVersionedRelFieldsInfoMixin):
    ...
    def get_json_by_version(self, version_or_pattern: Optional[str] = None, compare_with_version: str = None) -> dict:
        ...
        if version_instance:
            model_version_json = copy(version_instance.json or {})
            ...
            if compare_with_version:
                ...
                try:
                    ...
                    json_diff['diff'] = get_objs_diff(compare_version_instance.json or {}, model_version_json)
