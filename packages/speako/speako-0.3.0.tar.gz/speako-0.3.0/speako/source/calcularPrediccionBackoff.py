if __name__ == "__main__":
	...
	from speako.source.viterbiNbestBackoff import viterbiNbest
	from speako.source.viterbiNbestBackoff import conjugateSentence
	from speako.source.viterbiNbestBackoff import convertToJSON
