if __name__ == "__main__":
	...
	from speako.source.viterbiNbestMultPal import viterbiNbest
	from speako.source.viterbiNbestMultPal import conjugateSentence
	from speako.source.viterbiNbestMultPal import convertToJSON
