...
class Dtone:
	"""Dtone commands group definition. 2 total commands, 1 Sub-groups, 1 group commands"""
	...
	def ofrequency(self):
		...
		if not hasattr(self, '_ofrequency'):
			from .Ofrequency import Ofrequency
			self._ofrequency = Ofrequency(self._core, self._cmd_group)
