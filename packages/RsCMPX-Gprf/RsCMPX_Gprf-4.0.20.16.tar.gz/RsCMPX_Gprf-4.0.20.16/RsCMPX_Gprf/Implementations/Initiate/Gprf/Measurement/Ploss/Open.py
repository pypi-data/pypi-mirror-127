...
class Open:
	...
	def set(self, connector: enums.CmwsConnector, path_index: enums.PathIndex = None) -> None:
		...
		Snippet: driver.initiate.gprf.measurement.ploss.open.set(connector = enums.CmwsConnector.R11, path_index = enums.PathIndex.P1) \n
	...
	def get(self) -> OpenStruct:
		"""SCPI: INITiate:GPRF:MEASurement<Instance>:PLOSs:OPEN \n
		Snippet: value: OpenStruct = driver.initiate.gprf.measurement.ploss.open.get() \n
		No command help available \n
