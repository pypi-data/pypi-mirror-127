...
class ListPy:
	...
	def esingle(self):
		...
		if not hasattr(self, '_esingle'):
			from .Esingle import Esingle
			self._esingle = Esingle(self._core, self._cmd_group)
	...
	def rlist(self):
		...
		if not hasattr(self, '_rlist'):
			...
			self._rlist = Rlist(self._core, self._cmd_group)
		return self._rlist
	...
	def fill(self):
		...
		if not hasattr(self, '_fill'):
			...
			self._fill = Fill(self._core, self._cmd_group)
		return self._fill
	...
	def dgain(self):
		...
		if not hasattr(self, '_dgain'):
			from .Dgain import Dgain
			self._dgain = Dgain(self._core, self._cmd_group)
		return self._dgain
	...
	def reenabling(self):
		...
		if not hasattr(self, '_reenabling'):
			from .Reenabling import Reenabling
			self._reenabling = Reenabling(self._core, self._cmd_group)
