...
class EnvelopePower:
	...
	def set(self, index: int, exp_nom_power: float) -> None:
		...
		Snippet: driver.configure.gprf.measurement.iqRecorder.listPy.envelopePower.set(index = 1, exp_nom_power = 1.0) \n
	...
	def get(self, index: int) -> float:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:IQRecorder:LIST:ENPower \n
		Snippet: value: float = driver.configure.gprf.measurement.iqRecorder.listPy.envelopePower.get(index = 1) \n
		No command help available \n
			:param index: No help available
	...
	def get_all(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.configure.gprf.measurement.iqRecorder.listPy.envelopePower.get_all() \n
		No command help available \n
			:return: exp_nom_power: No help available
		"""
	...
	def set_all(self, exp_nom_power: List[float]) -> None:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:IQRecorder:LIST:ENPower:ALL \n
		Snippet: driver.configure.gprf.measurement.iqRecorder.listPy.envelopePower.set_all(exp_nom_power = [1.1, 2.2, 3.3]) \n
		No command help available \n
			:param exp_nom_power: No help available
		"""
