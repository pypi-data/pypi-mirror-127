...
class Ambient:
	"""Ambient commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""
	...
	def get(self, all: enums.Scope = None) -> GetStruct:
		"""SCPI: SENSe:BASE:TEMPerature:OPERating:AMBient \n
		Snippet: value: GetStruct = driver.sense.base.temperature.operating.ambient.get(all = enums.Scope.ALL) \n
		No command help available \n
			:param all: No help available
			:return: structure: for return value, see the help for GetStruct structure arguments."""
		param = ArgSingleList().compose_cmd_string(ArgSingle('all', all, DataType.Enum, enums.Scope, is_optional=True))
