...
class Avto(models.Model):
    ...
    odometer = models.FloatField(blank=True, verbose_name='Odometer', default='')
    odometer_desc = models.CharField(max_length=255, blank=True, verbose_name='Odometer_desc', default='')
    ...
    class Meta:
        verbose_name = "CARS (Site iaai.com)"
        ordering = ['id']
        app_label = 'avto'
