/*! For license information please see 1280cce4.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[61918],{39841:(e,t,i)=>{i(65233),i(65660);var r=i(9672),o=i(87156),n=i(50856),a=i(44181);(0,r.k)({_template:n.d`
    <style>
      :host {
        display: block;
        /**
...
`,is:"app-header-layout",behaviors:[a.Y],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return(0,o.vz)(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var e=this.header;if(this.isAttached&&e){this.$.wrapper.classList.remove("initializing"),e.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var t=e.offsetHeight;this.hasScrollingRegion?(e.style.left="",e.style.right=""):requestAnimationFrame(function(){var t=this.getBoundingClientRect(),i=document.documentElement.clientWidth-t.right;e.style.left=t.left+"px",e.style.right=i+"px"}.bind(this));var i=this.$.contentContainer.style;e.fixed&&!e.condenses&&this.hasScrollingRegion?(i.marginTop=t+"px",i.paddingTop=""):(i.paddingTop=t+"px",i.marginTop="")}}})},25782:(e,t,i)=>{i(65233),i(65660),i(70019),i(97968);var r=i(9672),o=i(50856),n=i(33760);(0,r.k)({_template:o.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[n.U]})},27849:(e,t,i)=>{i(39841);var r=i(50856);i(28426);class o extends(customElements.get("app-header-layout")){static get template(){return r.d`
      <style>
        :host {
          display: block;
          /**
    ...
    >
      ...
      ${Object.values(l.aisConfigSections).map((e=>r.dy`
          <ha-card>
        ...
        `))}
      ${this.cloudStatus&&(0,a.p)(this.hass,"cloud")?r.dy`
            <ha-card>
              <ha-config-navigation
                .hass=${this.hass}
                .showAdvanced=${this.showAdvanced}
          ...
          `:""}
      ${Object.values(l.configSections).map((e=>r.dy`
          <ha-card>
            <ha-config-navigation
              .hass=${this.hass}
              .showAdvanced=${this.showAdvanced}
    ...
    `:e}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,r.iv`
        app-header {
      ...
      `]}}]}}),r.oi)}}]);
//# sourceMappingURL=1280cce4.js.map