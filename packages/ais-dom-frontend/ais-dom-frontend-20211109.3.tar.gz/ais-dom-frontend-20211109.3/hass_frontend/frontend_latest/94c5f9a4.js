      ...
      <hass-subpage header="Konfiguracja bramki AIS dom">
        <ha-config-section .is-wide=${this.isWide}>
          ...
          <ha-card header="Baza danych do zapisu zdarzeń">
            ...
            ${this.dbConnectionValidating?o.dy`<div style="width: 100%; text-align: center;">
                  ...
                  <!-- MEMORY -->
                  ${"SQLite (memory)"===this.dbEngine?o.dy`
                        <div class="card-content">
                  ...
                  <!-- PostgreSQL (local) -->
                  ${"PostgreSQL (local)"===this.dbEngine?o.dy`
                        <div class="card-content">
                          Żeby utrzymać system w dobrej kondycji, codziennie
                  ...
                  <!-- FILE -->
                  ${"SQLite (file)"===this.dbEngine?o.dy`
                        <div class="card-content">
                          ...
                          >
                            ...
                            >
                              ${this.hass.states["input_select.ais_usb_flash_drives"].attributes.options.map((e=>o.dy`
                                    <paper-item
                                      .itemName=${e}
                                      .itemValue=${e}
                                    >
                      ...
                      `:o.dy``}
                  <!-- DB -->
                  ${"MariaDB"===this.dbEngine||"MySQL"===this.dbEngine||"PostgreSQL"===this.dbEngine?o.dy`
                        <div class="card-content">
                  ...
                  <div class="card-content">
                    ...
                    <ha-expansion-panel
                      .header=${o.dy`<ha-icon icon="mdi:filter-plus"></ha-icon>
                  ...
                  <!-- KEEP DAYS -->
                  ${"SQLite (file)"===this.dbEngine||"MariaDB"===this.dbEngine||"MySQL"===this.dbEngine||"PostgreSQL"===this.dbEngine?o.dy`
                  <div class="card-content">
        ...
        <ha-config-section .is-wide=${this.isWide}>
          ...
          <ha-card header=" Wybór parametrów logowania">
            ...
            <div class="card-content">
              ...
              <br /><br />
              ${this.isNotSeleced(this.logDrive)?o.dy``:o.dy`
