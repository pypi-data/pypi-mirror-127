...
def debug(ctx, gateway, interpreter, verbose, tty, quiet, args, ignore_missing, elf_file):
    """
    ...
    while True:
        ...
        try:
            ...
            if exc.args and 'subpath' in exc.args[0]:
                root = root.parent
            else:
                raise
    ...
    cwd_parts = pathlib.Path.cwd().relative_to(root).parts
    args = {
        'elf_file': elf_file,
