...
class FitFillStub(object):
    ...
    def __init__(self, channel):
        ...
        self.import_mesh = channel.unary_unary(
                '/fit_fill.FitFill/import_mesh',
...
class FitFillServicer(object):
    ...
    def import_mesh(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_FitFillServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'import_mesh': grpc.unary_unary_rpc_method_handler(
                    servicer.import_mesh,
...
class FitFill(object):
    ...
    def import_mesh(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fit_fill.FitFill/import_mesh',
