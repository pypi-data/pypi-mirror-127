...
_ENGINEDESC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='runtime_thread_num', full_name='baidu.paddle_serving.configure.EngineDesc.runtime_thread_num', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_infer_size', full_name='baidu.paddle_serving.configure.EngineDesc.batch_infer_size', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='enable_overrun', full_name='baidu.paddle_serving.configure.EngineDesc.enable_overrun', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='allow_split_request', full_name='baidu.paddle_serving.configure.EngineDesc.allow_split_request', index=22,
