...
def test_RestrictingNodeTransformer__test_ternary_if(mocker):
    ...
    _getattr_.assert_has_calls([mocker.call(glb["y"], "z"), mocker.call(glb["y"], "a")])
    ...
    assert glb["x"].y == "b"
    _write_.assert_called_once_with(glb["x"])
    _getattr_.assert_has_calls([mocker.call(glb["y"], "z"), mocker.call(glb["y"], "b")])
