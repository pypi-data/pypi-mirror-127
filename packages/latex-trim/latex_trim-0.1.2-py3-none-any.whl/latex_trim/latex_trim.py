...
def run():
    ...
    def toggle_selector(event):
        ...
        if event.key == 'enter':
            ...
            right = x1/200
            left = (x - x2)/200
            print(f"\\includegraphics[page={args.page + 1}, clip, trim={right}in {bottom}in {left}in {top}in]{{path/to/{args.file}}}")

    # drawtype is 'box' or 'line' or 'none'
    toggle_selector.RS = RectangleSelector(ax.axes, line_select_callback,
