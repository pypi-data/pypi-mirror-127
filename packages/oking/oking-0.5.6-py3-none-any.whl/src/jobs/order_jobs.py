    ...
    try:
        ...
        if db_config.sql is None:
            ...
            for invoice in invoices:
                invoice_sent = api_okvendas.post_invoices(src.client_data.get('url_api') + '/pedido/faturar', invoice, job_config.get('token_api'))
...
def query_invoices(db_config: DatabaseConfig) -> list[Invoice]:
    """
    Consulta as notas fiscais a serem enviadas na api do kanais
    Args:
