...
def _generate(candidates, rng, t, prob):
    return rng.choice(candidates)(t, prob=prob)
...
class NoiseGenerator(object):
    ...
    def generate(self, text, methods='disattach-letters', prob=1., delimeter='newline', verbose=1) -> str:
        ...
        text = self.run_multiprocessing(partial(_generate, candidates=candidates, rng=self.rng, prob=prob), text, verbose=verbose)
