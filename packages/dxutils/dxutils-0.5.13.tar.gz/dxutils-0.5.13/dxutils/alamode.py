...
from fastcore.script import Param, call_parse, bool_arg, store_true, store_false, str_enum
...
# Cell
@call_parse
def gen_alamode(name:Param('Supercell POSCAR file', str),
                ...
                action:Param('Type of the file to generate',
                             str_enum('_actions', 'gen', 'opt','phon','dos'))='opt',
                evec:Param('Output eigenvectors', store_false)=True,
                msd:Param('Output mean squere displacement', store_false)=True,
                ...
                printout:Param('Print out the file contents.', store_false)=True,
