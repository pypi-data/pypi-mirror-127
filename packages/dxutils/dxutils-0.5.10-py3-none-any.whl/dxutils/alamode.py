...
# Cell
@call_parse
def gen_alamode(name:Param('Supercell POSCAR file (SPOSCAR)', str)='SPOSCAR',
                order:Param('Approximation order (1)', int)=1,
                prefix:Param('Prefix used in calculations (CRYST)', str)='CRYST',
                scale:Param('Scale of the unit cell (1.0)', float)=1.0,
                action:Param('Type of the file to generate (opt/gen/phon/dos)', str)='opt',
                evec:Param('Output eigenvectors (true)', bool_arg)=True,
                msd:Param('Output mean squere displacement (1)', bool_arg)=True,
                tmax:Param('Max temperature (1000)K', float)=1000,
                ...
                grid:Param('k-grid for dos calculation (10x10x10)', str)='10x10x10',
                c1:Param('First order interaction cutoff (None)')='None',
                c2:Param('Second order interaction cutoff (10)', float)=10,
                c3:Param('Third order interaction cutoff (10)', float)=10,
                dfset:Param('Name of the DFSET file (DFSET)', str)='DFSET',
                printout:Param('Print out the file contents.', bool_arg, default=True)=True):
    """Generates gen/opt/phon/dos file depending on the ACTION (default: opt).
       The default values of parameters are enclosed in parethesis.
    """
