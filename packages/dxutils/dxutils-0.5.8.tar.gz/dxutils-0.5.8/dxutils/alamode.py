...
@call_parse
def gen_alamode(name=Param(default='SPOSCAR', type=str, help='Supercell POSCAR file (SPOSCAR)'),
                order=Param(default=1, type=int, help='Approximation order (1)'),
                prefix=Param(default='CRYST', type=str, help='Prefix used in calculations (CRYST)'),
                scale=Param(default=1.0, type=float, help='Scale of the unit cell (1.0)'),
                action=Param(default='opt', type=str, help='Type of the file to generate (opt/gen/phon/dos)'),
                evec=Param(default=True, type=bool_arg, help='Print eigenvectors (true)'),
                msd=Param(default=True, type=bool_arg, help='Print mean squere displacement (1)'),
                tmax=Param(default=1000, type=float, help='Max temperature (1000)K'),
                charge=Param(default=None, type=str, help='Name of the Born effective charges file (<prefix>.born)'),
                born=Param(default=0, help='If non-zero use info from <prefix>.born as Born effective charges using given approximation.'),
                ndat=Param(default=0, type=int, help='Number of data points used in fitting (0=All)'),
                kpath=Param(default=None, type=str, help='File with reciprocal space path'),
                grid=Param(default='10x10x10', type=str, help='k-grid for dos calculation (10x10x10)'),
                c1=Param(default='None', type=str, help='First order interaction cutoff (None)'),
                c2=Param(default=10, type=float, help='Second order interaction cutoff (10)'),
                c3=Param(default=10, type=float, help='Third order interaction cutoff (10)'),
                dfset=Param(default='DFSET', help='Name of the DFSET file (DFSET)'),
                printout=Param(default=True, type=bool_arg, help='Print out the file contents.')):
    """Generates gen/opt/phon/dos file depending on the ACTION (default: opt).
       The default values of parameters are enclosed in parethesis.
    """
