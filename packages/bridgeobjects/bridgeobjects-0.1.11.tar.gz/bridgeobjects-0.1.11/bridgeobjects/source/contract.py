...
from .constants import (CONTRACTS, SEATS, SUITS,
    ...
    GAME_TRICKS, CONTRACT_THRESHOLD, DOUBLED_BONUS, REDOUBLED_BONUS,
...
class Contract(object):
    ...
    def _contract_made(self, declarer_tricks: int, vulnerable: bool) -> int:
        ...
        if 0:
            print(self)
            print('g', contract_points)
            print('d', doubled_bonus)
            print('c', self._game_bonus(declarer_tricks, vulnerable, contract_points))
            print('o', self._overtrick_points(declarer_tricks, vulnerable))
            print('s', self._slam_points(declarer_tricks, vulnerable))
        return score
