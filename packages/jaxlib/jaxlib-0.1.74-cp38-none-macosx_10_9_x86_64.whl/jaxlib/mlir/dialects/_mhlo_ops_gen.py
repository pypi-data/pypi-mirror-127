...
class CustomCallOp(_ods_ir.OpView):
  ...
  def __init__(self, result, args, call_target_name, has_side_effect, backend_config, api_version, operand_layouts, result_layouts, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TransposeOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, permutation, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
