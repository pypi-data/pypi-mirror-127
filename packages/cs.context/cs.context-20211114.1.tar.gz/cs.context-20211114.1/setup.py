...
setup(
 ...
 'running the first and second steps of a single `enter_exit` generator '    
 'method.\n'    
 '\n'    
 'The `enter_exit` method is _not_ a context manager, but a short generator '    
 'method.\n'    
 ...
 'the `enter_exit` generator _may_ `yield` a true/false value to use as the '    
 'result\n'    
