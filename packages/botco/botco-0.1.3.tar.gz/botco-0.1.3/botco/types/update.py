...
class Update(TelegramObject):
    ...
    `Webhooks <https://core.telegram.org/bots/api#setwebhook>`_, since it allows you to 
    ...
    """*Optional*. The result of an `inline <https://core.telegram.org/bots/api#inline-mode>`_ 
    query that was chosen by a user and sent to their chat partner. Please see our documentation on 
    the `feedback collecting <https://core.telegram.org/bots/inline#collecting-feedback>`_ for details 
