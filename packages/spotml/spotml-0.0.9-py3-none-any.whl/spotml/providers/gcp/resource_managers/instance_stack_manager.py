...
from spotml.providers.gcp.resources.stack import Stack
from spotml.providers.gcp.helpers.ce_client import CEClient
from spotml.providers.gcp.helpers.deployment import wait_resources
from spotml.providers.gcp.helpers.dm_client import DMClient
from spotml.providers.gcp.helpers.dm_resource import DMResource
from spotml.providers.gcp.helpers.rtc_client import RtcClient
...
class InstanceStackManager(object):
    ...
    def __init__(self, machine_name: str, project_id: str, zone: str):
        ...
        self._stack_name = 'spotml-instance-' + machine_name
