...
from spotml.config.abstract_instance_config import AbstractInstanceConfig, VolumeMount
from spotml.config.abstract_instance_volume import AbstractInstanceVolume
from spotml.constants.constants import SPOT_STRATEGY_SPOT
from spotml.providers.aws.config.validation import validate_instance_parameters
from spotml.providers.aws.config.ebs_volume import EbsVolume

DEFAULT_AMI_NAME = 'SpotmlAMI'
...
class InstanceConfig(AbstractInstanceConfig):
    ...
    def is_spot_instance(self) -> bool:
        return self._params['spotStrategy'] == SPOT_STRATEGY_SPOT
