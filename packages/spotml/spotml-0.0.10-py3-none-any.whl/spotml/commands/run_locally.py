...
from spotml.deployment.utils.commands import get_script_command, get_log_command, get_tmux_session_command, get_bash_command
...
class RunLocallyCommand(AbstractConfigCommand):
    ...
    def _run(self, instance_manager: AbstractInstanceManager, args: Namespace, output: AbstractOutputWriter):
        ...
        if instance_manager.use_tmux:
            session_name = args.session_name if args.session_name else 'spotml-script-%s' % script_name
