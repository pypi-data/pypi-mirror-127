...
from spotml.configuration import get_spotml_keys_dir
from spotml.providers.instance_manager_factory import PROVIDER_AWS
...
class KeyPairManager(object):
    ...
    def __init__(self, ec2, project_name: str, region: str):
        self._ec2 = ec2
        self._key_name = 'spotml-key'
        self._key_path = os.path.join(get_spotml_keys_dir(PROVIDER_AWS), self._key_name)
