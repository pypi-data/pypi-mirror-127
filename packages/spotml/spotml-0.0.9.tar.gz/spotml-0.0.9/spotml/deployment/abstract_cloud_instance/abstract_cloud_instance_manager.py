...
class AbstractCloudInstanceManager(AbstractSshInstanceManager, ABC):
    ...
    def maybe_create_key(self):
        self.instance_deployment.maybe_create_key()
    ...
    def start(self, output: AbstractOutputWriter, dry_run=False):
        ...
        # create or get existing bucket for the project - removing this since this is now handled in run and start separately.
    ...
    def sync_to_bucket(self, output: AbstractOutputWriter, dry_run=False):
        ...
        # sync the project with the S3/GCP bucket
    ...
    def sync(self, output: AbstractOutputWriter, dry_run=False):
        self.sync_to_bucket(output, dry_run)
        self.sync_to_instance(output, dry_run)
