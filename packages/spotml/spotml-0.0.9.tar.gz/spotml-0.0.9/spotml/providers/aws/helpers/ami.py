from spotml.providers.aws.config.instance_config import DEFAULT_AMI_NAME
from spotml.providers.aws.resources.image import Image
        ...
        if not image:
            ...
            if not len(res['Images']):
                raise ValueError('AWS Deep Learning AMI not found.\n'
                                 'Use the "spotml aws create-ami" command to create an AMI with NVIDIA Docker.')
