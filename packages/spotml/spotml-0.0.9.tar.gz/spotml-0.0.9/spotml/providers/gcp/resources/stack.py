...
from spotml.providers.gcp.helpers.dm_client import DMClient
        ...
        Args:
            ...
            data (dict): Stack info. Example:
               {'fingerprint': 'vvtbwT7F953T0YC9tQ9CUg==',
                ...
                'name': 'spotml-instance-x11-test-i2',
                'operation': {'endTime': '2019-04-20T16:27:23.141-07:00',
                              'error': {'errors': [{'code': 'RESOURCE_ERROR',
                                                    'location': '/deployments/spotml-instance-x11-test-i2/resources/spotml-instance-x11-test-i2-disk-1',
                                                    'message': '{"ResourceType":"compute.v1.disk","ResourceErrorCode":"400","ResourceErrorMessage":{"code":400,"errors":[{"domain":"global","location":"zone","locationType":"parameter","message":"Invalid '
                                                               ...
                                                               'Request","requestPath":"https://www.googleapis.com/compute/v1/projects/spotml-221422/zones/zones%2Fus-east1-b/disks","httpMethod":"POST"}}'}]},
                              ...
                              'progress': 100,
                              'selfLink': 'https://www.googleapis.com/deploymentmanager/v2/projects/spotml-221422/global/operations/operation-1555802826515-586fe92d0a605-6166491c-7051043e',
                              'startTime': '2019-04-20T16:27:06.908-07:00',
                              'status': 'DONE',
                              'targetId': '3128259442476717093',
                              'targetLink': 'https://www.googleapis.com/deploymentmanager/v2/projects/spotml-221422/global/deployments/spotml-instance-x11-test-i2',
                              'user': 'spotml@spotml-221422.iam.gserviceaccount.com'},
                'selfLink': 'https://www.googleapis.com/deploymentmanager/v2/projects/spotml-221422/global/deployments/spotml-instance-x11-test-i2',
                'update': {'manifest': 'https://www.googleapis.com/deploymentmanager/v2/projects/spotml-221422/global/deployments/spotml-instance-x11-test-i2/manifests/manifest-1555802826772'},
