            ...
            data (dict): Stack info.
                ...
                {'id': '1760655646875625396',
                 ...
                 'update': {'finalProperties': 'failure:\n'
                                               ...
                                               '    path: /failure\n'
                                               'parent: '
                                               'projects/spotml-221422/configs/x11-test-i2-docker-status\n'
                                               'success:\n'
                                               '  cardinality:\n'
                                               '    number: 1\n'
                                               '    path: /success\n'
                            ...
                            'manifest': 'https://www.googleapis.com/deploymentmanager/v2/projects/spotml-221422/global/deployments/spotml-instance-x11-test-i2/manifests/manifest-1566775635906',
                            'properties': 'failure:\n'
                                          '  cardinality:\n'
                                          '    number: 1\n'
                                          '    path: /failure\n'
                ...
                {'finalProperties': 'config: x11-test-i2-docker-status\n'
                 ...
                 'manifest': 'https://www.googleapis.com/deploymentmanager/v2/projects/spotml-221422/global/deployments/spotml-instance-x11-test-i2/manifests/manifest-1566778333272',
                 'name': 'x11-test-i2-docker-status',
                 'properties': 'config: x11-test-i2-docker-status\n'
                               'description: Docker status\n',
                 'type': 'runtimeconfig.v1beta1.config',
                 'updateTime': '2019-08-25T17:12:30.254-07:00',
                 'url': 'https://runtimeconfig.googleapis.com/v1beta1/projects/spotml-221422/configs/x11-test-i2-docker-status'}
        """
        self._dm = dm
        self._data = data
