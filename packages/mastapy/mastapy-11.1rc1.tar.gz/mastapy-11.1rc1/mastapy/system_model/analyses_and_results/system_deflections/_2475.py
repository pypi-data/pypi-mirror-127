...
from mastapy.system_model.analyses_and_results.system_deflections import _2476, _2474, _2480
...
class FaceGearSetSystemDeflection(_2480.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3806.FaceGearSetPowerFlow':
        ...
        return constructor.new(_3806.FaceGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2476.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2476.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2474.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2474.FaceGearMeshSystemDeflection))
        return value
