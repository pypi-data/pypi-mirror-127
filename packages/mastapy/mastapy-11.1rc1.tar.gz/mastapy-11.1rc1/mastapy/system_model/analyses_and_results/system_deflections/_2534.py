...
from mastapy.system_model.analyses_and_results.system_deflections import _2535, _2533, _2427
...
class StraightBevelDiffGearSetSystemDeflection(_2427.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3860.StraightBevelDiffGearSetPowerFlow':
        ...
        return constructor.new(_3860.StraightBevelDiffGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2535.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2535.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2533.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2533.StraightBevelDiffGearMeshSystemDeflection))
        return value
