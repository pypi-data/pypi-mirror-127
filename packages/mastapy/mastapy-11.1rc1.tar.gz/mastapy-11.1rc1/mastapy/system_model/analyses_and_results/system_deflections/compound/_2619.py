...
class CylindricalGearMeshCompoundSystemDeflection(_2631.GearMeshCompoundSystemDeflection):
    '''CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def component_design(self) -> '_2036.CylindricalGearMesh':
        ...
        return constructor.new(_2036.CylindricalGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2461.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2461.CylindricalGearMeshSystemDeflectionWithLTCAResults))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2461.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2461.CylindricalGearMeshSystemDeflectionWithLTCAResults))
        return value
