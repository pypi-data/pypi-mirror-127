...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2696, _2697, _2632
...
class WormGearSetCompoundSystemDeflection(_2632.GearSetCompoundSystemDeflection):
    '''WormGearSetCompoundSystemDeflection
    ...
    @property
    def worm_gears_compound_system_deflection(self) -> 'List[_2696.WormGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundSystemDeflection, constructor.new(_2696.WormGearCompoundSystemDeflection))
        return value

    @property
    def worm_meshes_compound_system_deflection(self) -> 'List[_2697.WormGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundSystemDeflection, constructor.new(_2697.WormGearMeshCompoundSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2557.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2557.WormGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2557.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2557.WormGearSetSystemDeflection))
        return value
