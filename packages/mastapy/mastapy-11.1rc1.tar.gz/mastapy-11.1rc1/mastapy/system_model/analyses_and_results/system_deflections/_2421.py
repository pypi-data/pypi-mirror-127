...
class BevelDifferentialGearMeshSystemDeflection(_2426.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3761.BevelDifferentialGearMeshPowerFlow':
        ...
        return constructor.new(_3761.BevelDifferentialGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
