...
class StraightBevelGearMeshSystemDeflection(_2426.BevelGearMeshSystemDeflection):
    '''StraightBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3861.StraightBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3861.StraightBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
