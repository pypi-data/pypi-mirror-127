...
class SpiralBevelGearSystemDeflection(_2428.BevelGearSystemDeflection):
    '''SpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3853.SpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3853.SpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
