...
from mastapy.system_model_gui import _1606
...
from mastapy.system_model.part_model.configurations import _2339, _2337, _2340
from mastapy.system_model.analyses_and_results.load_case_groups import _5373, _5381, _5374
...
from mastapy.system_model.database_access import _1991
...
from mastapy import _7260, _0
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2702
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1606.MASTAGUI':
        ...
        return constructor.new(_1606.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI is not None else None
    ...
    @property
    def unbalanced_mass_inclusion(self) -> '_2204.UnbalancedMassInclusionOption':
        ...
        return constructor.new(_2204.UnbalancedMassInclusionOption)(value) if value is not None else None

    @unbalanced_mass_inclusion.setter
    def unbalanced_mass_inclusion(self, value: '_2204.UnbalancedMassInclusionOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_1953.ThermalExpansionOptionForGroundedNodes':
        ...
        return constructor.new(_1953.ThermalExpansionOptionForGroundedNodes)(value) if value is not None else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_1953.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def default_system_temperatures(self) -> '_1954.TransmissionTemperatureSet':
        ...
        return constructor.new(_1954.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures is not None else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2237.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2237.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup is not None else None

    @property
    def system(self) -> '_1952.SystemReporting':
        ...
        return constructor.new(_1952.SystemReporting)(self.wrapped.System) if self.wrapped.System is not None else None

    @property
    def fe_batch_operations(self) -> '_2088.BatchOperations':
        ...
        return constructor.new(_2088.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations is not None else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1714.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1714.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2237.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2237.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2339.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2339.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def fe_substructure_configurations(self) -> 'List[_2337.ActiveFESubstructureSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESubstructureConfigurations, constructor.new(_2337.ActiveFESubstructureSelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2340.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2340.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5373.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5373.DesignState))
        return value

    @property
    def time_series_load_case_groups(self) -> 'List[_5381.TimeSeriesLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TimeSeriesLoadCaseGroups, constructor.new(_5381.TimeSeriesLoadCaseGroup))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5374.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5374.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2200.RootAssembly':
        ...
        return constructor.new(_2200.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly is not None else None

    @property
    def gear_set_config(self) -> '_2258.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2258.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig is not None else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2258.GearSetConfiguration'):
        value = value.wrapped if value else None
        self.wrapped.GearSetConfig = value

    @property
    def status(self) -> '_1557.Status':
        ...
        return constructor.new(_1557.Status)(self.wrapped.Status) if self.wrapped.Status is not None else None

    @property
    def databases(self) -> '_1991.Databases':
        ...
        return constructor.new(_1991.Databases)(self.wrapped.Databases) if self.wrapped.Databases is not None else None

    @property
    def masta_settings(self) -> '_1933.MastaSettings':
        ...
        return constructor.new(_1933.MastaSettings)(self.wrapped.MastaSettings) if self.wrapped.MastaSettings is not None else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1897.RollingBearing'):
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2296.BeltCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2299.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2300.ShaftCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2298.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2297.CycloidalAssemblyCreationOptions':
    ...
    def design_state_load_case_group_named(self, name: 'str') -> '_5373.DesignState':
    ...
    def time_series_load_case_group_named(self, name: 'str') -> '_5381.TimeSeriesLoadCaseGroup':
    ...
    def design_state_named(self, name: 'str') -> '_5373.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5374.DutyCycle':
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1557.Status':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_7260.TaskProgress') -> '_1557.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2702.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2702.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2702.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5373.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5374.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2161.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2161.Assembly.TYPE](), constructor.new(_2161.Assembly))
