...
from mastapy.system_model.fe import (
    _2089, _2114, _2137, _2083,
    _2085, _2110, _2135, _2111,
    _2107, _2121, _2122, _2120,
    _2117, _2118, _2119
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2175, _2171, _2179
...
from mastapy.system_model.fe.links import _2144
...
class FESubstructure(_62.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2089.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2089.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2089.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2083.AlignmentMethod':
        ...
        return constructor.new(_2083.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2083.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_to_component(self) -> '_1950.RelativeComponentAlignment[_2171.Component]':
        ...
        return constructor.new(_1950.RelativeComponentAlignment)[_2171.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent is not None else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2085.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2085.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions is not None else None
    ...
    @property
    def export(self) -> '_2110.FESubstructureExportOptions':
        ...
        return constructor.new(_2110.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2135.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2135.ReplacedShaftSelectionHelper))
        return value

    @property
    def nodes(self) -> 'List[_2111.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2111.FESubstructureNode))
        return value

    @property
    def replaced_shafts(self) -> 'List[_2208.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2208.Shaft))
        return value

    @property
    def links(self) -> 'List[_2144.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2144.FELink))
        return value
    ...
    @property
    def geometries(self) -> 'List[_2107.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2107.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2121.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2121.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2122.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2122.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2179.FEPart':
        ...
        return constructor.new(_2179.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart is not None else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7260.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2120.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2117.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2118.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2119.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_152.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7260.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2111.FESubstructureNode') -> 'List[_2144.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2144.FELink))
