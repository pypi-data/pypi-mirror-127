...
from mastapy.system_model.drawing import _1982, _1978
...
class ContourDrawStyle(_275.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1583.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1583.ThreeDViewContourOption)(value) if value is not None else None

    @contour.setter
    def contour(self, value: '_1583.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1982.ScalingDrawStyle':
        ...
        return constructor.new(_1982.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling is not None else None

    @property
    def model_view_options(self) -> '_1978.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1978.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions is not None else None
