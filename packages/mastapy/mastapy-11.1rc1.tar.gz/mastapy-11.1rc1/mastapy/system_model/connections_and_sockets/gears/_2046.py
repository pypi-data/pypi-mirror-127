...
class KlingelnbergCycloPalloidHypoidGearMesh(_2045.KlingelnbergCycloPalloidConicalGearMesh):
    '''KlingelnbergCycloPalloidHypoidGearMesh
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_mesh_design(self) -> '_929.KlingelnbergCycloPalloidHypoidGearMeshDesign':
        ...
        return constructor.new(_929.KlingelnbergCycloPalloidHypoidGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearMeshDesign) if self.wrapped.KlingelnbergCycloPalloidHypoidGearMeshDesign is not None else None
