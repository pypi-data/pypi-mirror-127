...
from mastapy.system_model.part_model.projections import _2211
from mastapy.system_model.part_model.part_groups import _2216
...
class RootAssembly(_2161.Assembly):
    '''RootAssembly
    ...
    def model(self) -> '_1932.Design':
        ...
        return constructor.new(_1932.Design)(self.wrapped.Model) if self.wrapped.Model is not None else None
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2211.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2211.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2216.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2216.ParallelPartGroup))
        return value
