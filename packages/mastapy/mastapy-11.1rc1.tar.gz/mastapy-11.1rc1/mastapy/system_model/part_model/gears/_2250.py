...
class CylindricalGear(_2255.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_963.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_963.CylindricalGearDesign':
        ...
        if _963.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
