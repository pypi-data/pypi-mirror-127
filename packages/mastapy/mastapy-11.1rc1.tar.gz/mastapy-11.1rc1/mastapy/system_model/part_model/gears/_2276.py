...
from mastapy.gears.gear_designs.worm import _908, _907, _911
...
class WormGear(_2255.Gear):
    ...
    @property
    def active_gear_design(self) -> '_908.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_908.WormGearDesign':
        ...
        if _908.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
