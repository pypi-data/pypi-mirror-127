...
class KlingelnbergCycloPalloidSpiralBevelGearRating(_377.KlingelnbergCycloPalloidConicalGearRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_924.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_924.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear is not None else None
