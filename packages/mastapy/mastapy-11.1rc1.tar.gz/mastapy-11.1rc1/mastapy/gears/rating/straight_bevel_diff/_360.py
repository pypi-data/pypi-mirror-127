...
class StraightBevelDiffGearMeshRating(_493.ConicalGearMeshRating):
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_913.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_913.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh is not None else None
