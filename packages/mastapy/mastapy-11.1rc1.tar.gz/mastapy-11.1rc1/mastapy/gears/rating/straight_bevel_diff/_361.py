...
class StraightBevelDiffGearRating(_494.ConicalGearRating):
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_912.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_912.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear is not None else None
