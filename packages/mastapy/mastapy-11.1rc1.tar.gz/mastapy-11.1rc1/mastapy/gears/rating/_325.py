...
from mastapy.gears.load_case.worm import _832
from mastapy._internal.cast_exception import CastException
from mastapy.gears.load_case.face import _835
from mastapy.gears.load_case.cylindrical import _838
from mastapy.gears.load_case.conical import _841
from mastapy.gears.load_case.concept import _844
...
class GearMeshRating(_318.AbstractGearMeshRating):
    ...
    @property
    def mesh_load_case(self) -> '_829.MeshLoadCase':
        ...
        if _829.MeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_worm_mesh_load_case(self) -> '_832.WormMeshLoadCase':
        ...
        if _832.WormMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_face_mesh_load_case(self) -> '_835.FaceMeshLoadCase':
        ...
        if _835.FaceMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_cylindrical_mesh_load_case(self) -> '_838.CylindricalMeshLoadCase':
        ...
        if _838.CylindricalMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_conical_mesh_load_case(self) -> '_841.ConicalMeshLoadCase':
        ...
        if _841.ConicalMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_concept_mesh_load_case(self) -> '_844.ConceptMeshLoadCase':
        ...
        if _844.ConceptMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_bevel_mesh_load_case(self) -> '_846.BevelMeshLoadCase':
        ...
        if _846.BevelMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
