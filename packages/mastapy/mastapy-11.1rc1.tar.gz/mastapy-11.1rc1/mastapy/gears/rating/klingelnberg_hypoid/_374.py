...
class KlingelnbergCycloPalloidHypoidGearRating(_377.KlingelnbergCycloPalloidConicalGearRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_928.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_928.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear is not None else None
