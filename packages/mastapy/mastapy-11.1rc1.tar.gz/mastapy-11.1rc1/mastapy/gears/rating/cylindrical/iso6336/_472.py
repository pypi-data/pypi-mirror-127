...
class ISO63362006GearSingleFlankRating(_478.ISO6336AbstractMetalGearSingleFlankRating):
    ...
    def tooth_fatigue_fracture_results(self) -> '_468.CylindricalGearToothFatigueFractureResults':
        ...
        return constructor.new(_468.CylindricalGearToothFatigueFractureResults)(self.wrapped.ToothFatigueFractureResults) if self.wrapped.ToothFatigueFractureResults is not None else None
