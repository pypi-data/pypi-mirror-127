...
from mastapy.gears.rating.cylindrical import _444
...
class CylindricalGearScuffingResults(_0.APIBase):
    ...
    @property
    def scuffing_results_row(self) -> 'List[_444.ScuffingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ScuffingResultsRow, constructor.new(_444.ScuffingResultsRow))
        return value
