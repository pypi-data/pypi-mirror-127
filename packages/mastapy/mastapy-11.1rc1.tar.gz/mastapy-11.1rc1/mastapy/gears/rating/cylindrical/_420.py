...
class CylindricalGearMeshRating(_325.GearMeshRating):
    ...
    @property
    def mesh_load_case(self) -> '_838.CylindricalMeshLoadCase':
        ...
        return constructor.new(_838.CylindricalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase is not None else None
    ...
    @property
    def cylindrical_gear_mesh(self) -> '_970.CylindricalGearMeshDesign':
        ...
        return constructor.new(_970.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMesh) if self.wrapped.CylindricalGearMesh is not None else None
