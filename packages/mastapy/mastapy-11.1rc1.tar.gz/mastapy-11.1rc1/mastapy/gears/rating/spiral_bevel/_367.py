...
class SpiralBevelGearMeshRating(_508.BevelGearMeshRating):
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_921.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_921.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh is not None else None
