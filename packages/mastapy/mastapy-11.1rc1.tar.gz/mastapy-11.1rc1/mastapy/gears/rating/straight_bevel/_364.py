...
class StraightBevelGearMeshRating(_508.BevelGearMeshRating):
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_917.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_917.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh is not None else None
