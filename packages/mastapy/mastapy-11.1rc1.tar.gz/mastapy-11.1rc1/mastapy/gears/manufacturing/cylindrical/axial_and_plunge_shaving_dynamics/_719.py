...
class ShavingDynamics(_0.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_956.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_956.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails is not None else None
