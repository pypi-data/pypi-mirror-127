...
class WormGrindingProcessPitchCalculation(_648.WormGrindingProcessCalculation):
    ...
    def right_flank(self) -> '_615.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_615.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
    ...
    def left_flank(self) -> '_615.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_615.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None
