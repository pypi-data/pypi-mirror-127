...
class ShavingDynamicsCalculationForDesignedGears(_720.ShavingDynamicsCalculation['T'], Generic[T]):
    ...
    @property
    def start_of_shaving_profile(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value is not None else None

    @property
    def end_of_shaving_profile(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value is not None else None
