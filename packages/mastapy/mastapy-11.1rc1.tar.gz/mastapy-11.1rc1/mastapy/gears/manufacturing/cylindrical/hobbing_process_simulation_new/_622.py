...
class HobbingProcessLeadCalculation(_620.HobbingProcessCalculation):
    ...
    def right_flank(self) -> '_614.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
    ...
    def left_flank(self) -> '_614.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None
