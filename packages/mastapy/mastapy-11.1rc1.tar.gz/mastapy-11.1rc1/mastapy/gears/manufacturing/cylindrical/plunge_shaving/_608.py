...
class RealPlungeShaverOutputs(_605.PlungeShaverOutputs):
    ...
    def left_flank_micro_geometry(self) -> '_567.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_567.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry is not None else None
    ...
    def right_flank_micro_geometry(self) -> '_567.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_567.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry is not None else None
    ...
    def shaver(self) -> '_682.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_682.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver is not None else None
