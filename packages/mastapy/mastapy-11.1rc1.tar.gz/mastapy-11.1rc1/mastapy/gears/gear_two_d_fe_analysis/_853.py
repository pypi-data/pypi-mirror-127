...
class CylindricalGearTIFFAnalysisDutyCycle(_1157.GearDesignAnalysis):
    ...
    @property
    def analysis(self) -> '_854.CylindricalGearTwoDimensionalFEAnalysis':
        ...
        return constructor.new(_854.CylindricalGearTwoDimensionalFEAnalysis)(self.wrapped.Analysis) if self.wrapped.Analysis is not None else None
