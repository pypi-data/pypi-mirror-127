...
class CylindricalGearSetTIFFAnalysis(_1165.GearSetDesignAnalysis):
    ...
    @property
    def gears(self) -> 'List[_852.CylindricalGearTIFFAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_852.CylindricalGearTIFFAnalysis))
        return value
