...
from mastapy.gears.materials import _549, _555
...
class KlingelnbergConicalGearMaterialDatabase(_549.GearMaterialDatabase['_555.KlingelnbergCycloPalloidConicalGearMaterial']):
    '''KlingelnbergConicalGearMaterialDatabase
