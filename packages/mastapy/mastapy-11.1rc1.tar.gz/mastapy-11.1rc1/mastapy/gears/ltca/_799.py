...
from mastapy.gears.ltca import _793, _792
...
class GearRootFilletStressResults(_0.APIBase):
    ...
    @property
    def rows(self) -> 'List[_793.GearFilletNodeStressResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_793.GearFilletNodeStressResultsRow))
        return value

    @property
    def columns(self) -> 'List[_792.GearFilletNodeStressResultsColumn]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_792.GearFilletNodeStressResultsColumn))
        return value
