...
from mastapy.gears.ltca.conical import _823
...
class ConicalMeshLoadDistributionAnalysis(_795.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_841.ConicalMeshLoadCase':
        ...
        if _841.ConicalMeshLoadCase.TYPE not in self.wrapped.ConicalMeshLoadCase.__class__.__mro__:
    ...
    @property
    def meshed_gears(self) -> 'List[_823.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_823.ConicalMeshedGearLoadDistributionAnalysis))
        return value
