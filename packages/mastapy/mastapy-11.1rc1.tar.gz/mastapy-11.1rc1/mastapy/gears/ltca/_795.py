...
from mastapy.gears.ltca import _796, _794
...
class GearMeshLoadDistributionAnalysis(_1162.GearMeshImplementationAnalysis):
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_796.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_796.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_794.GearLoadDistributionAnalysis', flank: '_291.GearFlanks', stress_type: '_82.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_794.GearLoadDistributionAnalysis', stress_type: '_82.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
