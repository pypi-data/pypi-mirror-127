...
from mastapy.gears.load_case.cylindrical import _838
from mastapy.gears.ltca import _786, _795
from mastapy.gears.ltca.cylindrical import _813, _815
...
class CylindricalGearMeshLoadDistributionAnalysis(_795.GearMeshLoadDistributionAnalysis):
    '''CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_838.CylindricalMeshLoadCase':
        ...
        return constructor.new(_838.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase is not None else None

    @property
    def gear_a_in_mesh(self) -> '_786.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_786.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh is not None else None

    @property
    def gear_b_in_mesh(self) -> '_786.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_786.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh is not None else None
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_815.CylindricalMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_815.CylindricalMeshLoadDistributionAtRotation))
        return value

    @property
    def meshed_gears(self) -> 'List[_786.CylindricalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_786.CylindricalMeshedGearLoadDistributionAnalysis))
        return value
