...
class PlanetaryDetail(_0.APIBase):
    ...
    @property
    def planet_delta_angles(self) -> 'List[_304.NamedPlanetAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetDeltaAngles, constructor.new(_304.NamedPlanetAngle))
        return value
