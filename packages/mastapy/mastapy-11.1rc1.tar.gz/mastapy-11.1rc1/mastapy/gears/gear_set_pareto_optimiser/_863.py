...
class GearNameMapper(_0.APIBase):
    ...
    @property
    def gear_name_pickers(self) -> 'List[_864.GearNamePicker]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearNamePickers, constructor.new(_864.GearNamePicker))
        return value
