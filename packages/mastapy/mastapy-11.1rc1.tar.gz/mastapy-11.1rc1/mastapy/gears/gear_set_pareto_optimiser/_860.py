...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_869.LargerOrSmaller':
        ...
        return constructor.new(_869.LargerOrSmaller)(value) if value is not None else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_869.LargerOrSmaller'):
    ...
    @property
    def optimisation_targets(self) -> 'List[_876.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_876.OptimisationTarget)[TAnalysis])
        return value
    ...
    @property
    def table_filters(self) -> 'List[_894.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_894.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def chart_details(self) -> 'List[_858.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_858.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_891.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_891.ReasonsForInvalidDesigns))
        return value
