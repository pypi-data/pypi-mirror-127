...
class ConicalGearFlankMicroGeometry(_524.FlankMicroGeometry):
    ...
    @property
    def gear_design_of_type_zerol_bevel_gear_design(self) -> '_903.ZerolBevelGearDesign':
        ...
        if _903.ZerolBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_912.StraightBevelDiffGearDesign':
        ...
        if _912.StraightBevelDiffGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_straight_bevel_gear_design(self) -> '_916.StraightBevelGearDesign':
        ...
        if _916.StraightBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_spiral_bevel_gear_design(self) -> '_920.SpiralBevelGearDesign':
        ...
        if _920.SpiralBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_924.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        if _924.KlingelnbergCycloPalloidSpiralBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_928.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        if _928.KlingelnbergCycloPalloidHypoidGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_klingelnberg_conical_gear_design(self) -> '_932.KlingelnbergConicalGearDesign':
        ...
        if _932.KlingelnbergConicalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_hypoid_gear_design(self) -> '_936.HypoidGearDesign':
        ...
        if _936.HypoidGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
