...
class WormGearMeshDesign(_900.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_910.WormGearSetDesign':
        ...
        return constructor.new(_910.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet is not None else None

    @property
    def worm(self) -> '_907.WormDesign':
        ...
        return constructor.new(_907.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm is not None else None

    @property
    def wheel(self) -> '_911.WormWheelDesign':
        ...
        return constructor.new(_911.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel is not None else None

    @property
    def worm_gears(self) -> 'List[_908.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_908.WormGearDesign))
        return value
