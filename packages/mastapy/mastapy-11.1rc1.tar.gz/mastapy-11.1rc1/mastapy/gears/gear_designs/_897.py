...
from mastapy.utility.property import _1597
from mastapy.gears.gear_designs import _895
...
class DesignConstraintsCollection(_1590.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1597.DeletableCollectionMember[_895.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1597.DeletableCollectionMember)[_895.DesignConstraint])
        return value
