...
class GearSetDesign(_899.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gears(self) -> 'List[_898.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_898.GearDesign))
        return value
