...
from mastapy.gears.gear_designs.straight_bevel_diff import _912, _913
...
class StraightBevelDiffGearSetDesign(_1124.BevelGearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_912.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_912.StraightBevelDiffGearDesign))
        return value
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_913.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_913.StraightBevelDiffGearMeshDesign))
        return value
