...
from mastapy.gears.gear_designs.straight_bevel_diff import _914, _912, _915
...
class StraightBevelDiffGearMeshDesign(_1123.BevelGearMeshDesign):
    ...
    @property
    def straight_bevel_diff_gear_set(self) -> '_914.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_914.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSet) if self.wrapped.StraightBevelDiffGearSet is not None else None

    @property
    def straight_bevel_diff_gears(self) -> 'List[_912.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_912.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_915.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_915.StraightBevelDiffMeshedGearDesign))
        return value
