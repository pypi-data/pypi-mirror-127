...
from mastapy.gears.gear_designs.face import _941, _940
...
class FaceGearWheelDesign(_940.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_941.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_941.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value is not None else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_941.FaceGearDiameterFaceWidthSpecificationMethod'):
