...
from mastapy.gears.gear_designs.cylindrical import _1032, _950
...
class CylindricalMeshLinearBacklashSpecification(_1032.TolerancedValueSpecification['_950.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
