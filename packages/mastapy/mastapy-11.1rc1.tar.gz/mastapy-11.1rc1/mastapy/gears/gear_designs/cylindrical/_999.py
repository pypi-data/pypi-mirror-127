...
from mastapy.gears.gear_designs.cylindrical import _953, _997
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    @property
    def create_new_suitable_cutters(self) -> '_953.CreateNewSuitableCutterOption':
        ...
        return constructor.new(_953.CreateNewSuitableCutterOption)(value) if value is not None else None

    @create_new_suitable_cutters.setter
    def create_new_suitable_cutters(self, value: '_953.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CreateNewSuitableCutters = value

    @property
    def use_as_design_mode_geometry(self) -> '_953.CreateNewSuitableCutterOption':
    ...
    def use_as_design_mode_geometry(self, value: '_953.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
