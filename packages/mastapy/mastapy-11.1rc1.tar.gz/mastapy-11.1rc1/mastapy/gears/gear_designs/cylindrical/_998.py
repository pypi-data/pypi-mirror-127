...
class GearSetFCAImportSetup(_0.APIBase):
    ...
    @property
    def meshes(self) -> 'List[_970.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_970.CylindricalGearMeshDesign))
        return value
