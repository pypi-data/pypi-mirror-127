...
class CylindricalGearDesignConstraints(_1590.NamedDatabaseItem):
    '''CylindricalGearDesignConstraints
    ...
    @property
    def design_constraints(self) -> 'List[_964.CylindricalGearDesignConstraint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_964.CylindricalGearDesignConstraint))
        return value
