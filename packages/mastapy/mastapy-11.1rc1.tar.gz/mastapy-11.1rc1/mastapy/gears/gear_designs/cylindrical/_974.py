...
from mastapy.gears.gear_designs.cylindrical import _973, _958
...
class CylindricalGearPinionTypeCutterFlank(_958.CylindricalGearAbstractRackFlank):
    '''CylindricalGearPinionTypeCutterFlank
    ...
    @property
    def cutter(self) -> '_973.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_973.CylindricalGearPinionTypeCutter)(self.wrapped.Cutter) if self.wrapped.Cutter is not None else None
