...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_957.CylindricalGearAbstractRack':
        ...
        if _957.CylindricalGearAbstractRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_959.CylindricalGearBasicRack':
        ...
        if _959.CylindricalGearBasicRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_973.CylindricalGearPinionTypeCutter':
        ...
        if _973.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_981.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_981.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection is not None else None
