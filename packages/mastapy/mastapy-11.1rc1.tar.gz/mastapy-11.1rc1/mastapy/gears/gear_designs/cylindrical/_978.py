...
from mastapy.gears.gear_designs.cylindrical import (
    _949, _996, _1019, _1013,
    _1037, _979, _1010, _963,
    _970, _980
)
...
class CylindricalGearSetDesign(_901.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_949.AddendumModificationDistributionRule':
        ...
        return constructor.new(_949.AddendumModificationDistributionRule)(value) if value is not None else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_949.AddendumModificationDistributionRule'):
    ...
    def gear_fit_system(self) -> '_996.GearFitSystems':
        ...
        return constructor.new(_996.GearFitSystems)(value) if value is not None else None
    ...
    @property
    def left_flank(self) -> '_979.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_979.CylindricalGearSetFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_979.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_979.CylindricalGearSetFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
    ...
    @property
    def gears(self) -> 'List[_963.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_963.CylindricalGearDesign))
        return value
    ...
    @property
    def flanks(self) -> 'List[_979.CylindricalGearSetFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_979.CylindricalGearSetFlankDesign))
        return value
    ...
    @property
    def both_flanks(self) -> '_979.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_979.CylindricalGearSetFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None
    ...
    def create_optimiser(self, duty_cycle: '_426.CylindricalGearSetDutyCycleRating') -> '_980.CylindricalGearSetMacroGeometryOptimiser':
