...
class CylindricalGearBasicRack(_957.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_951.BasicRackProfiles':
        ...
        return constructor.new(_951.BasicRackProfiles)(value) if value is not None else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_951.BasicRackProfiles'):
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_973.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_973.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating is not None else None
