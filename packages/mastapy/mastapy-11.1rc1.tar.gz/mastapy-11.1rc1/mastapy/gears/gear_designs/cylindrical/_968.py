...
class CylindricalGearDesignSettings(_1382.PerMachineSettings):
    ...
    @property
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self) -> '_993.DoubleAxisScaleAndRange':
        ...
        return constructor.new(_993.DoubleAxisScaleAndRange)(value) if value is not None else None

    @default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts.setter
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self, value: '_993.DoubleAxisScaleAndRange'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_profile_measurement(self) -> '_976.CylindricalGearProfileMeasurementType':
    ...
    def cylindrical_gear_profile_measurement(self, value: '_976.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
