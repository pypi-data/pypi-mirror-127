...
class CylindricalGearLeadModificationAtProfilePosition(_1043.CylindricalGearLeadModification):
    ...
    @property
    def profile_measurement(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement is not None else None
