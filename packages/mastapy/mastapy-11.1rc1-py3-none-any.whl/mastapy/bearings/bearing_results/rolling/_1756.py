...
from mastapy.bearings.bearing_results.rolling import _1755, _1744
...
class LoadedNeedleRollerBearingRow(_1744.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1755.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1755.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
