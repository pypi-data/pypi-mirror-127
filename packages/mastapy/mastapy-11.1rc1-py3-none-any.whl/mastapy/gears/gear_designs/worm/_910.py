...
from mastapy.gears.gear_designs.worm import _908, _909
...
class WormGearSetDesign(_901.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_908.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_908.WormGearDesign))
        return value
    ...
    @property
    def worm_meshes(self) -> 'List[_909.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_909.WormGearMeshDesign))
        return value
