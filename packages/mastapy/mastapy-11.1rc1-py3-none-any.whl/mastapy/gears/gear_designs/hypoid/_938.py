...
from mastapy.gears.gear_designs.hypoid import _936, _937
...
class HypoidGearSetDesign(_1137.AGMAGleasonConicalGearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_936.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_936.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_936.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_936.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_937.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_937.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_937.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_937.HypoidGearMeshDesign))
        return value
