...
class CylindricalGearTableWithMGCharts(_1547.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_982.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_982.CylindricalGearTableMGItemDetail)(value) if value is not None else None

    @item_detail.setter
    def item_detail(self, value: '_982.CylindricalGearTableMGItemDetail'):
