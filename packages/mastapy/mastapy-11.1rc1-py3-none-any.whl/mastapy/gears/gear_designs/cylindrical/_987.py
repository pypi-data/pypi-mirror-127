...
class CylindricalMeshedGearFlank(_0.APIBase):
    ...
    @property
    def start_of_active_profile(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.StartOfActiveProfile) if self.wrapped.StartOfActiveProfile is not None else None

    @property
    def end_of_active_profile(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.EndOfActiveProfile) if self.wrapped.EndOfActiveProfile is not None else None
