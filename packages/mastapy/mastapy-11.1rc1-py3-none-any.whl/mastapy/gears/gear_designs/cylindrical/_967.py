...
class CylindricalGearDesignConstraintSettings(_1382.PerMachineSettings):
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_965.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_965.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints is not None else None
