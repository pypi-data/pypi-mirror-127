...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_987.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_987.CylindricalMeshedGearFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_987.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_987.CylindricalMeshedGearFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def flanks(self) -> 'List[_987.CylindricalMeshedGearFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_987.CylindricalMeshedGearFlank))
        return value

    @property
    def both_flanks(self) -> '_987.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_987.CylindricalMeshedGearFlank)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None
