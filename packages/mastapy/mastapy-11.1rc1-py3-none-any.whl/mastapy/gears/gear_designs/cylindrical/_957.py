...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self) -> '_963.CylindricalGearDesign':
        ...
        if _963.CylindricalGearDesign.TYPE not in self.wrapped.Gear.__class__.__mro__:
    ...
    @property
    def left_flank(self) -> '_958.CylindricalGearAbstractRackFlank':
        ...
        if _958.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_960.CylindricalGearBasicRackFlank':
        ...
        if _960.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_974.CylindricalGearPinionTypeCutterFlank':
        ...
        if _974.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def right_flank(self) -> '_958.CylindricalGearAbstractRackFlank':
        ...
        if _958.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_960.CylindricalGearBasicRackFlank':
        ...
        if _960.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_974.CylindricalGearPinionTypeCutterFlank':
        ...
        if _974.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def flanks(self) -> 'List[_958.CylindricalGearAbstractRackFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_958.CylindricalGearAbstractRackFlank))
        return value

    @property
    def both_flanks(self) -> '_958.CylindricalGearAbstractRackFlank':
        ...
        if _958.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_basic_rack_flank(self) -> '_960.CylindricalGearBasicRackFlank':
        ...
        if _960.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_974.CylindricalGearPinionTypeCutterFlank':
        ...
        if _974.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
