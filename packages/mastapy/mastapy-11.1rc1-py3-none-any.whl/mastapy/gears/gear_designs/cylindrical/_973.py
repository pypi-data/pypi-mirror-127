...
from mastapy.gears.gear_designs.cylindrical import _974, _957
...
class CylindricalGearPinionTypeCutter(_957.CylindricalGearAbstractRack):
    '''CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self) -> '_974.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_974.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_974.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_974.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
