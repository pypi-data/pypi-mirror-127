...
class CylindricalGearMeshDesign(_900.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_977.CylindricalGearProfileModifications':
        ...
        return constructor.new(_977.CylindricalGearProfileModifications)(value) if value is not None else None

    @profile_modification.setter
    def profile_modification(self, value: '_977.CylindricalGearProfileModifications'):
    ...
    @property
    def left_flank(self) -> '_971.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_971.CylindricalGearMeshFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_971.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_971.CylindricalGearMeshFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def backlash_specification(self) -> '_950.BacklashSpecification':
        ...
        return constructor.new(_950.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification is not None else None
    ...
    @property
    def cylindrical_gears(self) -> 'List[_963.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_963.CylindricalGearDesign))
        return value

    @property
    def cylindrical_meshed_gear(self) -> 'List[_986.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_986.CylindricalMeshedGear))
        return value

    @property
    def flanks(self) -> 'List[_971.CylindricalGearMeshFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_971.CylindricalGearMeshFlankDesign))
        return value

    @property
    def gear_a(self) -> '_963.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_963.CylindricalGearDesign':
    ...
    @property
    def both_flanks(self) -> '_971.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_971.CylindricalGearMeshFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None
