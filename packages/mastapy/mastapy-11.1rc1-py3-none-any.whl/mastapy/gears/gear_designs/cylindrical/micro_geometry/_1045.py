...
from mastapy.gears.gear_designs.cylindrical import _976, _970
...
class CylindricalGearMeshMicroGeometry(_1164.GearMeshImplementationDetail):
    ...
    @property
    def profile_measured_as(self) -> '_976.CylindricalGearProfileMeasurementType':
    ...
    @property
    def cylindrical_mesh(self) -> '_970.CylindricalGearMeshDesign':
        ...
        return constructor.new(_970.CylindricalGearMeshDesign)(self.wrapped.CylindricalMesh) if self.wrapped.CylindricalMesh is not None else None
