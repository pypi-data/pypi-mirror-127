...
class CylindricalGearMeshMicroGeometryDutyCycle(_1161.GearMeshDesignAnalysis):
    ...
    @property
    def meshes_analysis(self) -> 'List[_811.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesAnalysis, constructor.new(_811.CylindricalGearMeshLoadDistributionAnalysis))
        return value
