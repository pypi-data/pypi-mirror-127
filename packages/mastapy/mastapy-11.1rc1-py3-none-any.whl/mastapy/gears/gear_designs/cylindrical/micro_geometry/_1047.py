...
from mastapy.gears.gear_designs.cylindrical import _963, _990, _975
...
class CylindricalGearMicroGeometry(_1160.GearImplementationDetail):
    ...
    @property
    def cylindrical_gear(self) -> '_963.CylindricalGearDesign':
        ...
        if _963.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGear.__class__.__mro__:
    ...
    @property
    def profile_control_point(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.ProfileControlPoint) if self.wrapped.ProfileControlPoint is not None else None
