...
from mastapy.gears.gear_designs.spiral_bevel import _922, _920, _923
...
class SpiralBevelGearMeshDesign(_1123.BevelGearMeshDesign):
    ...
    @property
    def spiral_bevel_gear_set(self) -> '_922.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_922.SpiralBevelGearSetDesign)(self.wrapped.SpiralBevelGearSet) if self.wrapped.SpiralBevelGearSet is not None else None

    @property
    def spiral_bevel_gears(self) -> 'List[_920.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_920.SpiralBevelGearDesign))
        return value

    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_923.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_923.SpiralBevelMeshedGearDesign))
        return value
