...
class KlingelnbergConicalGearSetDesign(_1098.ConicalGearSetDesign):
    ...
    @property
    def conical_meshes(self) -> 'List[_933.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_933.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_933.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_933.KlingelnbergConicalGearMeshDesign))
        return value
