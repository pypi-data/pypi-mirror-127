...
from mastapy.gears.gear_designs import _897
...
class SelectedDesignConstraintsCollection(_1382.PerMachineSettings):
    ...
    @property
    def design_constraints(self) -> '_897.DesignConstraintsCollection':
        ...
        return constructor.new(_897.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints is not None else None
