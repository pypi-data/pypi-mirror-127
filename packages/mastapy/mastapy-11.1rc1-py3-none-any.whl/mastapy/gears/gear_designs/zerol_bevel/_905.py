...
from mastapy.gears.gear_designs.zerol_bevel import _903, _904
...
class ZerolBevelGearSetDesign(_1124.BevelGearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_903.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_903.ZerolBevelGearDesign))
        return value
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_904.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_904.ZerolBevelGearMeshDesign))
        return value
