...
class FaceGearSetDesign(_901.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_945.FaceGearPinionDesign':
        ...
        return constructor.new(_945.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion is not None else None

    @property
    def face_gear(self) -> '_948.FaceGearWheelDesign':
        ...
        return constructor.new(_948.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear is not None else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_947.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_947.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry is not None else None

    @property
    def gears(self) -> 'List[_940.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_940.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_940.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_940.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_942.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_942.FaceGearMeshDesign))
        return value
