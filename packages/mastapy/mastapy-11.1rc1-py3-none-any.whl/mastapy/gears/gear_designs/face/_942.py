...
from mastapy.gears.gear_designs.face import _946, _940
...
class FaceGearMeshDesign(_900.GearMeshDesign):
    '''FaceGearMeshDesign
    ...
    @property
    def face_gear_set(self) -> '_946.FaceGearSetDesign':
        ...
        return constructor.new(_946.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet is not None else None
