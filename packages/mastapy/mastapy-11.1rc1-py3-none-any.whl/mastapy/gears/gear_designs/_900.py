...
from mastapy.gears.gear_designs import _898, _899
...
class GearMeshDesign(_899.GearDesignComponent):
    '''GearMeshDesign
    ...
    @property
    def gear_a(self) -> '_898.GearDesign':
        ...
        if _898.GearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_zerol_bevel_gear_design(self) -> '_903.ZerolBevelGearDesign':
        ...
        if _903.ZerolBevelGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_worm_design(self) -> '_907.WormDesign':
        ...
        if _907.WormDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to WormDesign. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_worm_gear_design(self) -> '_908.WormGearDesign':
        ...
        if _908.WormGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to WormGearDesign. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_worm_wheel_design(self) -> '_911.WormWheelDesign':
        ...
        if _911.WormWheelDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to WormWheelDesign. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_straight_bevel_diff_gear_design(self) -> '_912.StraightBevelDiffGearDesign':
        ...
        if _912.StraightBevelDiffGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_straight_bevel_gear_design(self) -> '_916.StraightBevelGearDesign':
        ...
        if _916.StraightBevelGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_spiral_bevel_gear_design(self) -> '_920.SpiralBevelGearDesign':
        ...
        if _920.SpiralBevelGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_924.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        if _924.KlingelnbergCycloPalloidSpiralBevelGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_928.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        if _928.KlingelnbergCycloPalloidHypoidGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_klingelnberg_conical_gear_design(self) -> '_932.KlingelnbergConicalGearDesign':
        ...
        if _932.KlingelnbergConicalGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_hypoid_gear_design(self) -> '_936.HypoidGearDesign':
        ...
        if _936.HypoidGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to HypoidGearDesign. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_face_gear_design(self) -> '_940.FaceGearDesign':
        ...
        if _940.FaceGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to FaceGearDesign. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_face_gear_pinion_design(self) -> '_945.FaceGearPinionDesign':
        ...
        if _945.FaceGearPinionDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_face_gear_wheel_design(self) -> '_948.FaceGearWheelDesign':
        ...
        if _948.FaceGearWheelDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_gear_design(self) -> '_963.CylindricalGearDesign':
        ...
        if _963.CylindricalGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_planet_gear_design(self) -> '_990.CylindricalPlanetGearDesign':
        ...
        if _990.CylindricalPlanetGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_b(self) -> '_898.GearDesign':
        ...
        if _898.GearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_zerol_bevel_gear_design(self) -> '_903.ZerolBevelGearDesign':
        ...
        if _903.ZerolBevelGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_worm_design(self) -> '_907.WormDesign':
        ...
        if _907.WormDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to WormDesign. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_worm_gear_design(self) -> '_908.WormGearDesign':
        ...
        if _908.WormGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to WormGearDesign. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_worm_wheel_design(self) -> '_911.WormWheelDesign':
        ...
        if _911.WormWheelDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to WormWheelDesign. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_straight_bevel_diff_gear_design(self) -> '_912.StraightBevelDiffGearDesign':
        ...
        if _912.StraightBevelDiffGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_straight_bevel_gear_design(self) -> '_916.StraightBevelGearDesign':
        ...
        if _916.StraightBevelGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_spiral_bevel_gear_design(self) -> '_920.SpiralBevelGearDesign':
        ...
        if _920.SpiralBevelGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_924.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        if _924.KlingelnbergCycloPalloidSpiralBevelGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_928.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        if _928.KlingelnbergCycloPalloidHypoidGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_klingelnberg_conical_gear_design(self) -> '_932.KlingelnbergConicalGearDesign':
        ...
        if _932.KlingelnbergConicalGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_hypoid_gear_design(self) -> '_936.HypoidGearDesign':
        ...
        if _936.HypoidGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to HypoidGearDesign. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_face_gear_design(self) -> '_940.FaceGearDesign':
        ...
        if _940.FaceGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to FaceGearDesign. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_face_gear_pinion_design(self) -> '_945.FaceGearPinionDesign':
        ...
        if _945.FaceGearPinionDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_face_gear_wheel_design(self) -> '_948.FaceGearWheelDesign':
        ...
        if _948.FaceGearWheelDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_gear_design(self) -> '_963.CylindricalGearDesign':
        ...
        if _963.CylindricalGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_planet_gear_design(self) -> '_990.CylindricalPlanetGearDesign':
        ...
        if _990.CylindricalPlanetGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
