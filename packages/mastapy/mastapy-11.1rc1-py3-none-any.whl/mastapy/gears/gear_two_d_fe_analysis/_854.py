...
class CylindricalGearTwoDimensionalFEAnalysis(_0.APIBase):
    ...
    @property
    def findley_critical_plane_analysis(self) -> '_855.FindleyCriticalPlaneAnalysis':
        ...
        return constructor.new(_855.FindleyCriticalPlaneAnalysis)(self.wrapped.FindleyCriticalPlaneAnalysis) if self.wrapped.FindleyCriticalPlaneAnalysis is not None else None
