...
class KlingelnbergConicalMeshSingleFlankRating(_331.MeshSingleFlankRating):
    ...
    def virtual_cylindrical_gear_set(self) -> '_352.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_352.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet is not None else None
