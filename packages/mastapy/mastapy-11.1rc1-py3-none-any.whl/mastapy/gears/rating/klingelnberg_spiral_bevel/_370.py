...
class KlingelnbergCycloPalloidSpiralBevelGearMeshRating(_376.KlingelnbergCycloPalloidConicalGearMeshRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_925.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign':
        ...
        return constructor.new(_925.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMesh) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMesh is not None else None
