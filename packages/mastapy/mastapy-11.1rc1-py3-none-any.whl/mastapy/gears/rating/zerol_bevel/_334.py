...
class ZerolBevelGearMeshRating(_508.BevelGearMeshRating):
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_904.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_904.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh is not None else None
