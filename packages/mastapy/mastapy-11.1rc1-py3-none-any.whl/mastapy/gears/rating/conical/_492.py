...
class ConicalGearDutyCycleRating(_323.GearDutyCycleRating):
    ...
    def gear_set_design_duty_cycle(self) -> '_495.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_495.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle is not None else None
    ...
    def conical_gear_set_design_duty_cycle(self) -> '_495.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_495.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle is not None else None
