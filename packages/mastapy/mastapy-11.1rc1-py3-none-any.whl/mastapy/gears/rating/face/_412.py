...
from mastapy.gears.gear_designs.face import _942
...
class FaceGearMeshRating(_325.GearMeshRating):
    ...
    @property
    def mesh_load_case(self) -> '_835.FaceMeshLoadCase':
        ...
        return constructor.new(_835.FaceMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase is not None else None
    ...
    @property
    def face_gear_mesh(self) -> '_942.FaceGearMeshDesign':
        ...
        return constructor.new(_942.FaceGearMeshDesign)(self.wrapped.FaceGearMesh) if self.wrapped.FaceGearMesh is not None else None
