...
class WormGearMeshRating(_325.GearMeshRating):
    ...
    @property
    def worm_gear_mesh(self) -> '_909.WormGearMeshDesign':
        ...
        return constructor.new(_909.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh is not None else None
