...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    def analysis_point_with_maximum_local_material_exposure(self) -> '_486.ToothFlankFractureAnalysisPoint':
        ...
        return constructor.new(_486.ToothFlankFractureAnalysisPoint)(self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure) if self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure is not None else None
