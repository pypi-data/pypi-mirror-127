...
class CylindricalGearDutyCycleRating(_323.GearDutyCycleRating):
    ...
    def gear_set_design_duty_cycle(self) -> '_426.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_426.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle is not None else None
    ...
    def cylindrical_gear_set_design_duty_cycle(self) -> '_426.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_426.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle is not None else None
