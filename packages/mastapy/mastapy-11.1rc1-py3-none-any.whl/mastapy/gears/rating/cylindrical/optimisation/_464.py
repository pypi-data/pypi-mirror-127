...
class SafetyFactorOptimisationStepResult(_0.APIBase):
    ...
    def safety_factors(self) -> '_333.SafetyFactorResults':
        ...
        return constructor.new(_333.SafetyFactorResults)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors is not None else None
    ...
    def normalised_safety_factors(self) -> '_333.SafetyFactorResults':
        ...
        return constructor.new(_333.SafetyFactorResults)(self.wrapped.NormalisedSafetyFactors) if self.wrapped.NormalisedSafetyFactors is not None else None
