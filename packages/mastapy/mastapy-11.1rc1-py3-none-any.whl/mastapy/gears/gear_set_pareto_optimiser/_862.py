...
class FaceGearSetParetoOptimiser(_866.GearSetParetoOptimiser):
    '''FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_946.FaceGearSetDesign':
        ...
        return constructor.new(_946.FaceGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry is not None else None

    @property
    def candidate_gear_sets(self) -> 'List[_946.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_946.FaceGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_946.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_946.FaceGearSetDesign))
        return value
