...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def gear_load_distribution_analysis(self) -> '_821.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_821.ConicalGearLoadDistributionAnalysis)(self.wrapped.GearLoadDistributionAnalysis) if self.wrapped.GearLoadDistributionAnalysis is not None else None
