...
class GearFilletNodeStressResultsRow(_0.APIBase):
    ...
    @property
    def node_results(self) -> 'List[_791.GearFilletNodeStressResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_791.GearFilletNodeStressResults))
        return value
