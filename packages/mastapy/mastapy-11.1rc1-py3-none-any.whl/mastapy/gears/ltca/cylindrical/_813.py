...
class CylindricalGearMeshLoadedContactPoint(_798.GearMeshLoadedContactPoint):
    '''CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def gear_a_profile_measurement(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.GearAProfileMeasurement) if self.wrapped.GearAProfileMeasurement is not None else None

    @property
    def gear_b_profile_measurement(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.GearBProfileMeasurement) if self.wrapped.GearBProfileMeasurement is not None else None
