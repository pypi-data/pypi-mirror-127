...
from mastapy.gears.ltca import _803, _797
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    @property
    def gear_a_in_mesh(self) -> '_803.MeshedGearLoadDistributionAnalysisAtRotation':
        ...
        return constructor.new(_803.MeshedGearLoadDistributionAnalysisAtRotation)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh is not None else None

    @property
    def gear_b_in_mesh(self) -> '_803.MeshedGearLoadDistributionAnalysisAtRotation':
        ...
        return constructor.new(_803.MeshedGearLoadDistributionAnalysisAtRotation)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh is not None else None

    @property
    def loaded_contact_lines(self) -> 'List[_797.GearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_797.GearMeshLoadedContactLine))
        return value

    @property
    def meshed_gears(self) -> 'List[_803.MeshedGearLoadDistributionAnalysisAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_803.MeshedGearLoadDistributionAnalysisAtRotation))
        return value
