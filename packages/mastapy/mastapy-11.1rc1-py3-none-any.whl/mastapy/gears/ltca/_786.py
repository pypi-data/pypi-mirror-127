...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def gear_load_distribution_analysis(self) -> '_810.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_810.CylindricalGearLoadDistributionAnalysis)(self.wrapped.GearLoadDistributionAnalysis) if self.wrapped.GearLoadDistributionAnalysis is not None else None

    @property
    def other_gear_load_distribution_analysis(self) -> '_810.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_810.CylindricalGearLoadDistributionAnalysis)(self.wrapped.OtherGearLoadDistributionAnalysis) if self.wrapped.OtherGearLoadDistributionAnalysis is not None else None
    ...
    def contact_patch_detailed(self, result_type: '_781.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1309.GriddedSurface':
    ...
    def contact_patch(self, result_type: '_781.ContactResultType', include_tip_contact: 'bool') -> '_1309.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_781.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
