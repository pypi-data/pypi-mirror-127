...
class FormWheelGrindingSimulationCalculator(_657.CutterSimulationCalc):
    ...
    def profiled_grinding_wheel(self) -> '_696.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_696.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel is not None else None
