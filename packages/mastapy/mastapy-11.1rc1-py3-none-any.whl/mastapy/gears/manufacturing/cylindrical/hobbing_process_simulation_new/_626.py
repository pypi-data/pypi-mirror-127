...
class HobbingProcessSimulationInput(_639.ProcessSimulationInput):
    ...
    def hob_manufacture_error(self) -> '_630.HobManufactureError':
        ...
        return constructor.new(_630.HobManufactureError)(self.wrapped.HobManufactureError) if self.wrapped.HobManufactureError is not None else None
    ...
    def hob_resharpening_error(self) -> '_631.HobResharpeningError':
        ...
        return constructor.new(_631.HobResharpeningError)(self.wrapped.HobResharpeningError) if self.wrapped.HobResharpeningError is not None else None
