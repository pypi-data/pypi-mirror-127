...
class WormGrindingProcessSimulationInput(_639.ProcessSimulationInput):
    ...
    def worm_grinder_manufacture_error(self) -> '_645.WormGrinderManufactureError':
        ...
        return constructor.new(_645.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError is not None else None
