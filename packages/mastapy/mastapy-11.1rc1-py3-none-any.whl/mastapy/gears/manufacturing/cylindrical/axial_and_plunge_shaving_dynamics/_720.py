...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def new_cutter_start_of_shaving(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving is not None else None

    @property
    def life_cutter_start_of_shaving(self) -> '_975.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_975.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving is not None else None
