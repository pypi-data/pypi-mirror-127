...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_955.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_955.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails is not None else None
