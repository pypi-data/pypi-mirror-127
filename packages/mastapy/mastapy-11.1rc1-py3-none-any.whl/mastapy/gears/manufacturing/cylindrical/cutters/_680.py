...
class CylindricalGearGrindingWorm(_684.CylindricalGearRackDesign):
    ...
    def nominal_worm_grinder_shape(self) -> '_700.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_700.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape is not None else None
