...
class BevelMachineSettingOptimizationResult(_0.APIBase):
    ...
    def calculated_deviations_convex(self) -> '_728.ConicalFlankDeviationsData':
        ...
        return constructor.new(_728.ConicalFlankDeviationsData)(self.wrapped.CalculatedDeviationsConvex) if self.wrapped.CalculatedDeviationsConvex is not None else None
    ...
    def imported_deviations_convex(self) -> '_728.ConicalFlankDeviationsData':
        ...
        return constructor.new(_728.ConicalFlankDeviationsData)(self.wrapped.ImportedDeviationsConvex) if self.wrapped.ImportedDeviationsConvex is not None else None
    ...
    def calculated_deviations_concave(self) -> '_728.ConicalFlankDeviationsData':
        ...
        return constructor.new(_728.ConicalFlankDeviationsData)(self.wrapped.CalculatedDeviationsConcave) if self.wrapped.CalculatedDeviationsConcave is not None else None
    ...
    def imported_deviations_concave(self) -> '_728.ConicalFlankDeviationsData':
        ...
        return constructor.new(_728.ConicalFlankDeviationsData)(self.wrapped.ImportedDeviationsConcave) if self.wrapped.ImportedDeviationsConcave is not None else None
