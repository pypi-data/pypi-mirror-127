...
class GearSet(_2202.SpecialisedAssembly):
    '''GearSet
    ...
    @property
    def active_gear_set_design(self) -> '_901.GearSetDesign':
        ...
        if _901.GearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_worm_gear_set_design(self) -> '_910.WormGearSetDesign':
        ...
        if _910.WormGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_face_gear_set_design(self) -> '_946.FaceGearSetDesign':
        ...
        if _946.FaceGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_gear_set_design(self) -> '_978.CylindricalGearSetDesign':
        ...
        if _978.CylindricalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_planetary_gear_set_design(self) -> '_989.CylindricalPlanetaryGearSetDesign':
        ...
        if _989.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_designs(self) -> 'List[_901.GearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_901.GearSetDesign))
        return value

    def set_active_gear_set_design(self, gear_set_design: '_901.GearSetDesign'):
    ...
    def add_gear_set_design(self, design: '_901.GearSetDesign'):
