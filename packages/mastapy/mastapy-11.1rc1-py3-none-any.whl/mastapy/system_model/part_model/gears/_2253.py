...
class FaceGear(_2255.Gear):
    ...
    @property
    def active_gear_design(self) -> '_940.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_940.FaceGearDesign':
        ...
        if _940.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
