...
class BevelGear(_2238.AGMAGleasonConicalGear):
    '''BevelGear
    ...
    @property
    def bevel_gear_design_of_type_zerol_bevel_gear_design(self) -> '_903.ZerolBevelGearDesign':
        ...
        if _903.ZerolBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_912.StraightBevelDiffGearDesign':
        ...
        if _912.StraightBevelDiffGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_gear_design(self) -> '_916.StraightBevelGearDesign':
        ...
        if _916.StraightBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_spiral_bevel_gear_design(self) -> '_920.SpiralBevelGearDesign':
        ...
        if _920.SpiralBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
