...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2288
from mastapy.system_model.part_model.gears import _2250, _2257
...
class CylindricalGearSet(_2257.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_978.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_978.CylindricalGearSetDesign':
        ...
        if _978.CylindricalGearSetDesign.TYPE not in self.wrapped.CylindricalGearSetDesign.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_set(self) -> '_2288.SuperchargerRotorSet':
        ...
        return constructor.new(_2288.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet is not None else None

    @property
    def cylindrical_gears(self) -> 'List[_2250.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2250.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_2036.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_2036.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_978.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_978.CylindricalGearSetDesign))
        return value
