...
from mastapy.system_model.part_model.gears import _2244, _2245
...
class BevelDifferentialGearSet(_2245.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def bevel_gear_set_design_of_type_zerol_bevel_gear_set_design(self) -> '_905.ZerolBevelGearSetDesign':
        ...
        if _905.ZerolBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_914.StraightBevelDiffGearSetDesign':
        ...
        if _914.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_918.StraightBevelGearSetDesign':
        ...
        if _918.StraightBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_spiral_bevel_gear_set_design(self) -> '_922.SpiralBevelGearSetDesign':
        ...
        if _922.SpiralBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gears(self) -> 'List[_2244.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2244.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_2030.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_2030.BevelGearMesh))
        return value
