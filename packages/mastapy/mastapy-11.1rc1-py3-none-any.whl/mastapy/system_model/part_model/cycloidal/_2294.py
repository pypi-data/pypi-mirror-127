...
from mastapy.system_model.part_model import _2187, _2163
...
from mastapy.system_model.connections_and_sockets.cycloidal import _2066
...
class CycloidalDisc(_2163.AbstractShaft):
    '''CycloidalDisc
    ...
    @property
    def load_sharing_settings(self) -> '_2187.LoadSharingSettings':
        ...
        return constructor.new(_2187.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings is not None else None
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2066.CycloidalDiscPlanetaryBearingSocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetaryBearingSockets, constructor.new(_2066.CycloidalDiscPlanetaryBearingSocket))
        return value
