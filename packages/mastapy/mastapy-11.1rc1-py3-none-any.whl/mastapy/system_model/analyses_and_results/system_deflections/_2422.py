...
class BevelDifferentialGearSetSystemDeflection(_2427.BevelGearSetSystemDeflection):
    '''BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3763.BevelDifferentialGearSetPowerFlow':
        ...
        return constructor.new(_3763.BevelDifferentialGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2423.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsSystemDeflection, constructor.new(_2423.BevelDifferentialGearSystemDeflection))
        return value

    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2421.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesSystemDeflection, constructor.new(_2421.BevelDifferentialGearMeshSystemDeflection))
        return value
