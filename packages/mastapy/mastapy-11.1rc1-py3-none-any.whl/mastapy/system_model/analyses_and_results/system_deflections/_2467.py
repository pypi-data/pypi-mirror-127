...
class CylindricalGearSystemDeflectionWithLTCAResults(_2465.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_810.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_810.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults is not None else None
