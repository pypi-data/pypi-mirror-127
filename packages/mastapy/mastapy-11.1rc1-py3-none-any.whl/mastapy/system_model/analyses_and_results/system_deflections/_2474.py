...
class FaceGearMeshSystemDeflection(_2479.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3804.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3804.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
