...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3811, _3756, _3763, _3768,
    _3781, _3784, _3800, _3806,
    _3815, _3819, _3822, _3825,
    _3835, _3854, _3860, _3863,
    _3879, _3882
)
from mastapy.gears.analysis import _1170, _1167
from mastapy.gears import _294
from mastapy import _7260
...
class GearSetSystemDeflection(_2526.SpecialisedAssemblySystemDeflection):
    '''GearSetSystemDeflection
    ...
    @property
    def assembly_design(self) -> '_2257.GearSet':
    ...
    @property
    def power_flow_results(self) -> '_3811.GearSetPowerFlow':
        ...
        if _3811.GearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_agma_gleason_conical_gear_set_power_flow(self) -> '_3756.AGMAGleasonConicalGearSetPowerFlow':
        ...
        if _3756.AGMAGleasonConicalGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_differential_gear_set_power_flow(self) -> '_3763.BevelDifferentialGearSetPowerFlow':
        ...
        if _3763.BevelDifferentialGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_gear_set_power_flow(self) -> '_3768.BevelGearSetPowerFlow':
        ...
        if _3768.BevelGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_concept_gear_set_power_flow(self) -> '_3781.ConceptGearSetPowerFlow':
        ...
        if _3781.ConceptGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_conical_gear_set_power_flow(self) -> '_3784.ConicalGearSetPowerFlow':
        ...
        if _3784.ConicalGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_cylindrical_gear_set_power_flow(self) -> '_3800.CylindricalGearSetPowerFlow':
        ...
        if _3800.CylindricalGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_face_gear_set_power_flow(self) -> '_3806.FaceGearSetPowerFlow':
        ...
        if _3806.FaceGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_hypoid_gear_set_power_flow(self) -> '_3815.HypoidGearSetPowerFlow':
        ...
        if _3815.HypoidGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_klingelnberg_cyclo_palloid_conical_gear_set_power_flow(self) -> '_3819.KlingelnbergCycloPalloidConicalGearSetPowerFlow':
        ...
        if _3819.KlingelnbergCycloPalloidConicalGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_power_flow(self) -> '_3822.KlingelnbergCycloPalloidHypoidGearSetPowerFlow':
        ...
        if _3822.KlingelnbergCycloPalloidHypoidGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_power_flow(self) -> '_3825.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow':
        ...
        if _3825.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_planetary_gear_set_power_flow(self) -> '_3835.PlanetaryGearSetPowerFlow':
        ...
        if _3835.PlanetaryGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_spiral_bevel_gear_set_power_flow(self) -> '_3854.SpiralBevelGearSetPowerFlow':
        ...
        if _3854.SpiralBevelGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_diff_gear_set_power_flow(self) -> '_3860.StraightBevelDiffGearSetPowerFlow':
        ...
        if _3860.StraightBevelDiffGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_gear_set_power_flow(self) -> '_3863.StraightBevelGearSetPowerFlow':
        ...
        if _3863.StraightBevelGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_worm_gear_set_power_flow(self) -> '_3879.WormGearSetPowerFlow':
        ...
        if _3879.WormGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_zerol_bevel_gear_set_power_flow(self) -> '_3882.ZerolBevelGearSetPowerFlow':
        ...
        if _3882.ZerolBevelGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    def analysis_for(self, gear_set_imp_detail: '_1170.GearSetImplementationDetail', gear_set_mode: '_294.GearSetModes') -> '_1167.GearSetImplementationAnalysis':
    ...
    def implementation_detail_results_failed_for(self, gear_set_imp_detail: '_1170.GearSetImplementationDetail', gear_set_mode: '_294.GearSetModes') -> 'bool':
    ...
    def perform_implementation_detail_analysis_with_progress(self, imp_detail: '_1170.GearSetImplementationDetail', gear_set_mode: '_294.GearSetModes', progress: '_7260.TaskProgress', run_all_planetary_meshes: Optional['bool'] = True):
    ...
    def perform_implementation_detail_analysis(self, imp_detail: '_1170.GearSetImplementationDetail', gear_set_mode: '_294.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True):
        ''' 'PerformImplementationDetailAnalysis' is the original name of this method.
