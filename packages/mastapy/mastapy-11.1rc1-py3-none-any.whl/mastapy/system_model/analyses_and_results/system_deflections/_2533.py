...
class StraightBevelDiffGearMeshSystemDeflection(_2426.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3858.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3858.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
