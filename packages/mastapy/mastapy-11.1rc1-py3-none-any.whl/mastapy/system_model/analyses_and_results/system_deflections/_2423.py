...
from mastapy.system_model.analyses_and_results.power_flows import _3762, _3764, _3765
...
class BevelDifferentialGearSystemDeflection(_2428.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3762.BevelDifferentialGearPowerFlow':
