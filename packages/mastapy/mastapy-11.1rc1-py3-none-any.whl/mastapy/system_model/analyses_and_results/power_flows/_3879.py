...
from mastapy.system_model.analyses_and_results.power_flows import _3878, _3877, _3811
...
class WormGearSetPowerFlow(_3811.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3878.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3878.WormGearPowerFlow))
        return value

    @property
    def worm_gears_power_flow(self) -> 'List[_3878.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_3878.WormGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3877.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3877.WormGearMeshPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_3877.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_3877.WormGearMeshPowerFlow))
        return value
