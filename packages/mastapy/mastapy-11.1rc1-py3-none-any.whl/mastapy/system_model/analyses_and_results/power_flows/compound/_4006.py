...
class WormGearCompoundPowerFlow(_3941.GearCompoundPowerFlow):
    '''WormGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3878.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3878.WormGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3878.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3878.WormGearPowerFlow))
        return value
