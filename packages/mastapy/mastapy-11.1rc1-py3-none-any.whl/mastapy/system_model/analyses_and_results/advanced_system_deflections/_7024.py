...
from mastapy.gears.gear_designs.cylindrical import _970, _963
...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7023, _7012, _7036
...
class CylindricalGearMeshAdvancedSystemDeflection(_7036.GearMeshAdvancedSystemDeflection):
    '''CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def gear_mesh_design(self) -> '_970.CylindricalGearMeshDesign':
        ...
        return constructor.new(_970.CylindricalGearMeshDesign)(self.wrapped.GearMeshDesign) if self.wrapped.GearMeshDesign is not None else None

    @property
    def point_with_maximum_contact_pressure(self) -> '_813.CylindricalGearMeshLoadedContactPoint':
        ...
        return constructor.new(_813.CylindricalGearMeshLoadedContactPoint)(self.wrapped.PointWithMaximumContactPressure) if self.wrapped.PointWithMaximumContactPressure is not None else None
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2460.CylindricalGearMeshSystemDeflectionTimestep]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshSystemDeflectionResults, constructor.new(_2460.CylindricalGearMeshSystemDeflectionTimestep))
        return value

    @property
    def gear_designs(self) -> 'List[_963.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDesigns, constructor.new(_963.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_7023.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedAnalyses, constructor.new(_7023.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_7012.ContactChartPerToothPass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MaxPressureContactChartForEachToothPassForGearA, constructor.new(_7012.ContactChartPerToothPass))
        return value
