...
class WormGearAdvancedSystemDeflection(_7035.GearAdvancedSystemDeflection):
    '''WormGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2558.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2558.WormGearSystemDeflection))
        return value
