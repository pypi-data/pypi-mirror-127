...
from mastapy.system_model.part_model.gears import _2240, _2242, _2243
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.static_loads import _6522, _6525, _6526
...
class BevelDifferentialGearAdvancedSystemDeflection(_6991.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_2240.BevelDifferentialGear':
    ...
    @property
    def component_load_case(self) -> '_6522.BevelDifferentialGearLoadCase':
        ...
        if _6522.BevelDifferentialGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2423.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2423.BevelDifferentialGearSystemDeflection))
        return value
