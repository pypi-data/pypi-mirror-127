...
from mastapy.system_model.part_model.gears import _2250, _2252
from mastapy.system_model.analyses_and_results.static_loads import _6560, _6565
from mastapy.gears.rating.cylindrical import _422
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7024, _7026, _7035
...
class CylindricalGearAdvancedSystemDeflection(_7035.GearAdvancedSystemDeflection):
    '''CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def gear_design(self) -> '_963.CylindricalGearDesign':
        ...
        if _963.CylindricalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def component_design(self) -> '_2250.CylindricalGear':
    ...
    @property
    def component_load_case(self) -> '_6560.CylindricalGearLoadCase':
        ...
        if _6560.CylindricalGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7024.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionMeshes, constructor.new(_7024.CylindricalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7026.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearAdvancedSystemDeflections, constructor.new(_7026.CylindricalMeshedGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7026.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionsInMeshes, constructor.new(_7026.CylindricalMeshedGearAdvancedSystemDeflection))
        return value
