...
from mastapy.system_model.analyses_and_results import _2409
...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_advanced_ltca(self) -> '_804.UseAdvancedLTCAOptions':
        ...
        return constructor.new(_804.UseAdvancedLTCAOptions)(value) if value is not None else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_804.UseAdvancedLTCAOptions'):
    ...
    @property
    def time_options(self) -> '_2409.TimeOptions':
        ...
        return constructor.new(_2409.TimeOptions)(self.wrapped.TimeOptions) if self.wrapped.TimeOptions is not None else None
