...
class HypoidGearMesh(_2026.AGMAGleasonConicalGearMesh):
    '''HypoidGearMesh
    ...
    @property
    def hypoid_gear_mesh_design(self) -> '_937.HypoidGearMeshDesign':
        ...
        return constructor.new(_937.HypoidGearMeshDesign)(self.wrapped.HypoidGearMeshDesign) if self.wrapped.HypoidGearMeshDesign is not None else None
