...
class FaceGearMesh(_2040.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_942.FaceGearMeshDesign':
        ...
        return constructor.new(_942.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign is not None else None
