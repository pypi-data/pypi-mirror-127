...
class WormGearMesh(_2040.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_909.WormGearMeshDesign':
        ...
        return constructor.new(_909.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign is not None else None
