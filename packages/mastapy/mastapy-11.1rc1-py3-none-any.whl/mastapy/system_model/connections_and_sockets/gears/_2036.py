...
from mastapy.system_model.part_model.gears import _2251, _2267, _2250
...
class CylindricalGearMesh(_2040.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2251.CylindricalGearSet':
        ...
        if _2251.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_design(self) -> '_970.CylindricalGearMeshDesign':
        ...
        return constructor.new(_970.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMeshDesign) if self.wrapped.CylindricalGearMeshDesign is not None else None
