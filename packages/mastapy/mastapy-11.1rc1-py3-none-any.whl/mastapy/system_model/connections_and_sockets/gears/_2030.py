...
class BevelGearMesh(_2026.AGMAGleasonConicalGearMesh):
    '''BevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design_of_type_zerol_bevel_gear_mesh_design(self) -> '_904.ZerolBevelGearMeshDesign':
        ...
        if _904.ZerolBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_straight_bevel_diff_gear_mesh_design(self) -> '_913.StraightBevelDiffGearMeshDesign':
        ...
        if _913.StraightBevelDiffGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_straight_bevel_gear_mesh_design(self) -> '_917.StraightBevelGearMeshDesign':
        ...
        if _917.StraightBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_spiral_bevel_gear_mesh_design(self) -> '_921.SpiralBevelGearMeshDesign':
        ...
        if _921.SpiralBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
