...
class HubController:
	...
	@AttemptRequests(success_codes=[200])
	def put_skus(self, skus: List[HubSku], seller_id: int):
	...
	@AttemptRequests(success_codes=[200])
	def put_skus_prices(self, seller_id: str, skus_prices: List[HubSkuPrice]):
	...
	@AttemptRequests(success_codes=[200])
	def put_skus_stocks(self, seller_id: str, skus_stocks: List[HubSkuStock]):
	...
	@AttemptRequests(success_codes=[200])
	def get_sellers_by_channel_type_and_plataform(self, channel_type: ChannelType, plataform: str):
	...
	@AttemptRequests(success_codes=[200])
	def put_seller_by_channel_sync_last_catalog(self, seller_channel_id: str, seller_channel_update_quantity: SellerChannelUpdateQuantity):
	...
	@AttemptRequests(success_codes=[200])
	def put_seller_by_channel_sync_last_price(self, seller_channel_id: str, seller_channel_update_quantity: SellerChannelUpdateQuantity):
	...
	@AttemptRequests(success_codes=[200])
	def put_seller_by_channel_sync_last_stock(self, seller_channel_id: str, seller_channel_update_quantity: SellerChannelUpdateQuantity):
