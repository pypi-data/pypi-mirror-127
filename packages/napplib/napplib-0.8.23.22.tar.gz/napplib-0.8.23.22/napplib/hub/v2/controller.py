...
class HubController:
	...
	@AttemptRequests(success_codes=[200])
	def put_sku_status(self, seller_id: int, sku_status: List[HubSkuStatus]) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/{seller_id}/skus/status', headers=self.headers, data=unpack_payload_dict(skus_status,remove_null=True))
	...
	@AttemptRequests(success_codes=[204])
	def put_seller_by_channel_sync_last_product(self, seller_channel_id: str, seller_channel_update_quantity: HubSellerChannelSyncProduct) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/last/catalog', headers=self.headers, data=unpack_payload_dict(seller_channel_update_quantity, remove_null=True))

	@AttemptRequests(success_codes=[204])
	def put_seller_by_channel_sync_full_product(self, seller_channel_id: str, seller_channel_update_quantity: HubSellerChannelSyncProduct) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/full/catalog', headers=self.headers, data=unpack_payload_dict(seller_channel_update_quantity, remove_null=True))

	@AttemptRequests(success_codes=[204])
	def put_seller_by_channel_sync_last_price(self, seller_channel_id: str, seller_channel_update_quantity: HubSellerChannelSyncPriceAndStock) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/last/price', headers=self.headers, data=unpack_payload_dict(seller_channel_update_quantity, remove_null=True))

	@AttemptRequests(success_codes=[204])
	def put_seller_by_channel_sync_full_price(self, seller_channel_id: str, seller_channel_update_quantity: HubSellerChannelSyncPriceAndStock) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/full/price', headers=self.headers, data=unpack_payload_dict(seller_channel_update_quantity, remove_null=True))

	@AttemptRequests(success_codes=[204])
	def put_seller_by_channel_sync_last_stock(self, seller_channel_id: str, seller_channel_update_quantity: HubSellerChannelSyncPriceAndStock) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/last/stock', headers=self.headers, data=unpack_payload_dict(seller_channel_update_quantity, remove_null=True))

	@AttemptRequests(success_codes=[204])
	def put_seller_by_channel_sync_full_stock(self, seller_channel_id: str, seller_channel_update_quantity: HubSellerChannelSyncPriceAndStock) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/full/stock', headers=self.headers, data=unpack_payload_dict(seller_channel_update_quantity, remove_null=True))
