...
class HubController:
	...
	def put_seller_by_channel_sync_last_product(self, seller_channel_id: str, entity: HubSellerChannelSyncProduct) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/last/catalog', headers=self.headers, data=unpack_payload_dict(entity, remove_null=True))
	...
	def put_seller_by_channel_sync_full_product(self, seller_channel_id: str, entity: HubSellerChannelSyncProduct) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/full/catalog', headers=self.headers, data=unpack_payload_dict(entity, remove_null=True))
	...
	def put_seller_by_channel_sync_last_price(self, seller_channel_id: str, entity: HubSellerChannelSyncPriceAndStock) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/last/price', headers=self.headers, data=unpack_payload_dict(entity, remove_null=True))
	...
	def put_seller_by_channel_sync_full_price(self, seller_channel_id: str, entity: HubSellerChannelSyncPriceAndStock) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/full/price', headers=self.headers, data=unpack_payload_dict(entity, remove_null=True))
	...
	def put_seller_by_channel_sync_last_stock(self, seller_channel_id: str, entity: HubSellerChannelSyncPriceAndStock) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/last/stock', headers=self.headers, data=unpack_payload_dict(entity, remove_null=True))
	...
	def put_seller_by_channel_sync_full_stock(self, seller_channel_id: str, entity: HubSellerChannelSyncPriceAndStock) -> requests.Response:
		return requests.put(f'{self.__get_endpoint_base()}/sellers/channels/{seller_channel_id}/sync/full/stock', headers=self.headers, data=unpack_payload_dict(entity, remove_null=True))
