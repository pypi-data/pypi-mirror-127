...
class AppConfigDataClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.8/reference/services/appconfigdata.html#AppConfigData.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.8/reference/services/appconfigdata.html#AppConfigData.Client.can_paginate)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.8/reference/services/appconfigdata.html#AppConfigData.Client.generate_presigned_url)
    ...
    def get_latest_configuration(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.8/reference/services/appconfigdata.html#AppConfigData.Client.get_latest_configuration)
    ...
    def start_configuration_session(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.8/reference/services/appconfigdata.html#AppConfigData.Client.start_configuration_session)
