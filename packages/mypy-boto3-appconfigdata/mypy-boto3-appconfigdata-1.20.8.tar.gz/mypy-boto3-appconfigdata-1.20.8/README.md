...
[boto3.AppConfigData 1.20.8](https://boto3.amazonaws.com/v1/documentation/api/1.20.8/reference/services/appconfigdata.html#AppConfigData)
...
- Install `boto-stubs[appconfigdata]` in your environment:
  `python -m pip install 'boto3-stubs[appconfigdata]'`
