    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              azure_auto.virtual_networks.public_ip_addresses.present:
                - name: value
    ...
    if not response_get["status"]:
        ...
        if response_get["status_code"] == 404:
            ...
            if not response_put["status"]:
                hub.log.debug(
                    f"Could not create Public IP Addresses {response_put['comment']}"
                )
                return StateReturn(
            ...
            hub.log.debug(
                f"Could not get Public IP Addresses {response_get['comment']}"
            )
        ...
        if not response_patch["status"]:
            hub.log.debug(
                f"Could not update Public IP Addresses {response_patch['comment']}"
            )
            return StateReturn(
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              azure_auto.virtual_networks.public_ip_addresses.absent:
                - name: value
                - resource_group_name: value
                - public_ip_address_name: value
    """
    ...
    if response_get["status"]:
        ...
        if not response_delete["status"]:
            hub.log.debug(
                f"Could not delete Public IP Addresses {response_delete['comment']}"
            )
            return StateReturn(
        ...
        hub.log.debug(f"Could not get Public IP Addresses {response_get['comment']}")
        return StateReturn(name=name, result=False, comment=response_get["comment"])
