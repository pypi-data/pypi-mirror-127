    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              azure_auto.virtual_networks.security_rules.present:
                - name: value
    ...
    if not response_get["status"]:
        ...
        if response_get["status_code"] == 404:
            ...
            if not response_put["status"]:
                hub.log.debug(
                    f"Could not create Security Rules {response_put['comment']}"
                )
                return StateReturn(
            ...
            hub.log.debug(f"Could not get Security Rules {response_get['comment']}")
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              azure_auto.virtual_networks.security_rules.absent:
                - name: value
                - resource_group_name: value
                - network_security_group_name: value
                - security_rule_name: value
    ...
    if response_get["status"]:
        ...
        if not response_delete["status"]:
            hub.log.debug(
                f"Could not delete Security Rules {response_delete['comment']}"
            )
            return StateReturn(
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            $ idem describe azure_auto.virtual_networks.security_rules
    """
    ...
    try:
        async for sg_page_result in hub.exec.azure.request.paginate(
            ctx,
