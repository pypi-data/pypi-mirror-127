    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              azure_auto.virtual_networks.virtual_networks.present:
                - name: value
    ...
    if not response_get["status"]:
        ...
        if response_get["status_code"] == 404:
            ...
            if not response_put["status"]:
                hub.log.debug(
                    f"Could not create Virtual Networks {response_put['comment']}"
                )
                return StateReturn(
            ...
            hub.log.debug(f"Could not get Virtual Networks {response_get['comment']}")
        ...
        if not response_patch["status"]:
            hub.log.debug(
                f"Could not update Virtual Networks {response_patch['comment']}"
            )
            return StateReturn(
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              azure_auto.virtual_networks.virtual_networks.absent:
                - name: value
                - resource_group_name: value
                - virtual_network_name: value
    """
    ...
    if response_get["status"]:
        ...
        if not response_delete["status"]:
            hub.log.debug(
                f"Could not delete Virtual Networks {response_delete['comment']}"
            )
            return StateReturn(
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            $ idem describe azure_auto.virtual_networks.virtual_networks
    """
