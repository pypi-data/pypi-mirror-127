    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              azure_auto.compute.virtual_machines.present:
                - name: value
    ...
    if not response_get["status"]:
        ...
        if response_get["status_code"] == 404:
            ...
            if not response_put["status"]:
                hub.log.debug(
                    f"Could not create Virtual Machines {response_put['comment']}"
                )
                return StateReturn(
            ...
            hub.log.debug(f"Could not get Virtual Machines {response_get['comment']}")
        ...
        if not response_patch["status"]:
            hub.log.debug(
                f"Could not update Virtual Machines {response_patch['comment']}"
            )
            return StateReturn(
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              azure_auto.compute.virtual_machines.absent:
                - name: value
                - resource_group_name: value
                - vm_name: value
    """
    ...
    if response_get["status"]:
        ...
        if not response_delete["status"]:
            hub.log.debug(
                f"Could not delete Virtual Machines {response_delete['comment']}"
            )
            return StateReturn(
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            $ idem describe azure_auto.compute.virtual_machines
    """
