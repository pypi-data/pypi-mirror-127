    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              azure_auto.resource_management.resource_groups.present:
                - name: value
    ...
    if not response_get["status"]:
        ...
        if response_get["status_code"] == 404:
            ...
            if not response_put["status"]:
                hub.log.debug(
                    f"Could not create Resource Groups {response_put['comment']}"
                )
                return StateReturn(
            ...
            hub.log.debug(f"Could not get Resource Groups {response_get['comment']}")
        ...
        if not response_patch["status"]:
            hub.log.debug(
                f"Could not update Resource Groups {response_patch['comment']}"
            )
            return StateReturn(
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              azure_auto.resource_management.resource_groups.absent:
                - name: value
                - resource_group_name: value
    """
    ...
    if response_get["status"]:
        ...
        if not response_delete["status"]:
            hub.log.debug(
                f"Could not delete Resource Groups {response_delete['comment']}"
            )
            return StateReturn(
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            $ idem describe azure_auto.resource_management.resource_groups
    """
