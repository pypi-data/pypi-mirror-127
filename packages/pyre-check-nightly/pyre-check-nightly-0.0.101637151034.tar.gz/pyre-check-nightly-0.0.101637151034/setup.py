...
def main() -> None:
    ...
    run(
        ...
        package_version="0.0.101637151034",
        module_name="pyre_check",
        runtime_dependencies=json.loads("""["async-generator", "click", "dataclasses;python_version=='3.6'", "dataclasses-json", "intervaltree", "libcst>=0.3.6", "psutil", "pyre-extensions", "pywatchman", "tabulate", "typing-extensions"]"""),
        long_description=long_description,
    )
