...
def save_xyz(f_name: str, labels: list, coords: np.ndarray,
    ...
    # Apply mask
    _labels = np.delete(_labels, _mask).tolist()
    _coords = np.delete(coords, _mask, axis=0)
...
def calculate_rmsd(coords_1: np.ndarray, coords_2: np.ndarray,
    ...
    # Apply masks
    _coords_1 = np.delete(_coords_1, _mask_1, axis=0)
    _coords_2 = np.delete(_coords_2, _mask_2, axis=0)
