...
class my_mysql():
    ...
    def __init__(self, host, user, database, password, port=3306, maxconnections=500, default_character_set="utf-8"):
        self.host = host
        self.user = user
        ...
        self.pool = PooledDB(pymysql, maxconnections=maxconnections, blocking=True,
                             host=host, user=user, passwd=password, db=database, port=port, setsession=[
            'SET AUTOCOMMIT = 1'])
