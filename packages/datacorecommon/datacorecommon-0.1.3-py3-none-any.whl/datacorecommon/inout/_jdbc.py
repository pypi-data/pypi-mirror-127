...
def oracle_executequery(_query:str, _user:str, _passw:str, _url:str) -> sparkdf:
  """
...
def oracle_readtable(_table:str, _user:str, _passw:str, _url:str, **kwargs) -> sparkdf:
  """
...
def postgres_executequery(_query:str, _user:str, _passw:str, _url:str) -> sparkdf:
  """
...
def postgres_readtable(_table:str, _user:str, _passw:str, _url:str, **kwargs) -> sparkdf:
  """
...
def bigquery_readtable(_project:str, _dataset:str, _table:str, **kwargs) -> sparkdf:
  """
...
def bigquery_writetable(_df:sparkdf, _project:str, _dataset:str, _table:str, _writemode='append', **kwargs):
  """
