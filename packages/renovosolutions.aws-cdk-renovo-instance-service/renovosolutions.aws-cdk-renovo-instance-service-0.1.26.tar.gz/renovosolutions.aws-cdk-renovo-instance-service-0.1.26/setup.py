    ...
    """
{
    ...
    "package_data": {
        "renovo-instance-service._jsii": [
            "cdk-library-renovo-instance-service@0.1.26.jsii.tgz"
        ],
        "renovo-instance-service": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "jsii>=1.43.0, <2.0.0",
        "publication>=0.0.3",
        "renovosolutions.aws-cdk-aspects-security-group>=0.1.22, <0.2.0",
        "renovosolutions.aws-cdk-managed-instance-role>=0.0.38, <0.0.39"
    ],
    "classifiers": [
