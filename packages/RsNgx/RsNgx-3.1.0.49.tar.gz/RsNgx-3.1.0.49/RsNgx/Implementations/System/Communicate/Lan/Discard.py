...
class Discard:
	...
	def set(self) -> None:
		...
		Snippet: driver.system.communicate.lan.discard.set() \n
		No command help available \n
		"""
		self._core.io.write(f'SYSTem:COMMunicate:LAN:DISCard')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SYSTem:COMMunicate:LAN:DISCard \n
		Snippet: driver.system.communicate.lan.discard.set_with_opc() \n
		No command help available \n
		...
		self._core.io.write_with_opc(f'SYSTem:COMMunicate:LAN:DISCard', opc_timeout_ms)
