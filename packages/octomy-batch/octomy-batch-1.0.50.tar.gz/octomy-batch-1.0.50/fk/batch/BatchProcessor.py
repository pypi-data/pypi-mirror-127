...
#            "last": self.db.get_jobs(limit=20),
#            "last_failed": self.db.get_jobs(limit=20, status=["failed"]),
#            "last_pending": self.db.get_jobs(limit=20, status=["pending"]),
#            "last_in_progress": self.db.get_jobs(limit=20, status=["in-progress"]),
