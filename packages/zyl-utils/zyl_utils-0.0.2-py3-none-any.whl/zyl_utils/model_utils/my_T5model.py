...
from ..data_utils.nlp_utils import DTUtils
...
class MyT5(T5Model):
    ...
    def __init__(self, model_type, model_name, args=None, tokenizer=None, use_cuda=True, cuda_device=-1, **kwargs):
        super(MyT5, self).__init__(self, model_type=model_type, model_name=model_name, args=args,
...
class MyDDPT5(DDPT5Model):
    ...
    def __init__(self, model_type, model_name, args=None, tokenizer=None, use_cuda=True, cuda_device=-1, **kwargs):
        super(MyDDPT5, self).__init__(self, model_type=model_type, model_name=model_name, args=args,
                                      tokenizer=tokenizer, use_cuda=use_cuda, cuda_device=cuda_device, **kwargs)
