      ...
      >
        <div class="content">
          <div class="list" ?narrow=${this.narrow}>
            ${null!==(t=this._error)&&void 0!==t&&t.message?a`<ha-alert alert-type="error" .rtl=${u(this.hass)}>
                  ${this._error.message}
                </ha-alert>`:""}
