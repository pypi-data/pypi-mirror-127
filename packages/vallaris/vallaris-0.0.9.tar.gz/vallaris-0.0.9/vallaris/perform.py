...
def CreateFeatures(storage, parameter):
    try:
        msgOption = parameter
        collection = msgOption['id']
        dataset_id = collection
...
def UpdateFeatures(storage, parameter):
    try:
        msgOption = parameter
...
def DeleteFeatures(storage, parameter):
    try:
        msgOption = parameter
        dataset_id = msgOption['collectionId']
        features_id = msgOption['featuresId']
...
def CreateCollection(storage, parameter):
    try:
        msgOption = parameter
...
def UpdateCollection(storage, parameter):
    try:
        msgOption = parameter
...
def DeleteCollection(storage, parameter):
    try:
        msgOption = parameter
        dataset_id = msgOption['id']
        VallarisServer = os.environ["VallarisServer"]
...
def CreateTile(storage, parameter):
    try:
        msgOption = parameter
