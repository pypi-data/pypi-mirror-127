...
class Filter:
    ...
    def __init__(self, field_name=None, lookup_expr=None, *, label=None,
                 ...
                 default=NOT_PROVIDED, null_skip=False, **kwargs):
    ...
    def get_value(self, value, exists):
        return value if exists and self.default == NOT_PROVIDED else self.default

    def skip(self, value, exists):
        return (
            self.null_skip and value in EMPTY_VALUES
            or not exists
        )
