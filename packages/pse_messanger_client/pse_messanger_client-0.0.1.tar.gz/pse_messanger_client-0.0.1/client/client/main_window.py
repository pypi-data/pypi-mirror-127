...
class ClientMainWindow(QMainWindow):
    ...
    def add_contact_window(self):
        ...
        print("def add_contact_window(self)")
        select_dialog.show()
    ...
    def message(self, message):
        ...
        '''
        print(f"message in message signal: {message}")
        print(f"message: {message[MESSAGE_TEXT]} from: {message[FROM]}")
        ...
        sender = message[FROM]
        print(
            f"Message in the main_window.py in message(): {message} ,sender: {message[FROM]}")
        print(f"self.current_chat: {self.current_chat}")
