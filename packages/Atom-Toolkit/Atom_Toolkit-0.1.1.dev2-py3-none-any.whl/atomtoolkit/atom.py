...
class Term:
    ...
    # TODO: A classmethod for returning a term with already known quantum numbers (or maybe just move that to
    #  __init__ and move the parsing to a classmethod, maybe both???). This would save a lot of computation, since a
    #  lot of terms are generated from parent terms that have already done the parsing work.
