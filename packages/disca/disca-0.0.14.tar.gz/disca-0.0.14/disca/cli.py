...
parser.add_argument('--run-bot', help='Run a disca bot on this client', action='store_true', default=False)
...
def disca_main(run=False):
    ...
    """
    from disca.client import Client, ClientConfig
    ...
    if args.shard_auto:
        from disca.gateway.sharder import AutoSharder
