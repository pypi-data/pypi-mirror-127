...
from disca import VERSION as disca_version
from requests import __version__ as requests_version
from disca.util.logging import LoggingClass
from disca.api.ratelimit import RateLimiter
...
class HTTPClient(LoggingClass):
    ...
    def __init__(self, token, after_request=None):
        ...
        self.session.headers.update({
            'User-Agent': 'DiscordBot (https://github.com/py57/disca {}) Python/{} requests/{}'.format(
                disca_version,
                py_version,
                requests_version),
        })
    ...
    def call(self, route, args=None, **kwargs):
        ...
        :class:`disca.api.http.Routes`) with a set of URL arguments, and keyword
