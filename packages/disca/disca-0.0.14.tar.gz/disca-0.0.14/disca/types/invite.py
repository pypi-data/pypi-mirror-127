from disca.types.base import SlottedModel, Field, datetime, enum
from disca.types.user import User
from disca.types.guild import Guild
...
class Invite(SlottedModel):
    ...
    target_user : :class:`disca.types.user.User`
    ...
    inviter : :class:`disca.types.user.User`
    ...
    @property
    def link(self):
        return 'https://discard.gg/{}'.format(self.code)
