...
from disca.types.user import User, Presence
from disca.types.channel import Channel, PermissionOverwrite
from disca.types.message import Message, MessageReactionEmoji
from disca.types.voice import VoiceState
from disca.types.guild import Guild, GuildMember, Role, GuildEmoji
from disca.types.base import Model, ModelMeta, Field, ListField, AutoDictField, UNSET, snowflake, datetime
from disca.util.string import underscore

# Mapping of discards event name to our event classes
EVENTS_MAP = {}
...
class Ready(GatewayEvent):
    ...
    guilds : list[:class:`disca.types.guild.Guild`
        All guilds this account is a member of. These are shallow guild objects.
    private_channels list[:class:`disca.types.channel.Channel`]
...
class GuildCreate(GatewayEvent):
    ...
    Attributes
    ----------
    guild : :class:`disca.types.guild.Guild`
...
class ChannelCreate(GatewayEvent):
    ...
    Attributes
    ----------
    channel : :class:`disca.types.channel.Channel`
...
class GuildEmojisUpdate(GatewayEvent):
    ...
    emojis : list[:class:`disca.types.guild.Emoji`]
...
class GuildMembersChunk(GatewayEvent):
    ...
    members : list[:class:`disca.types.guild.GuildMember`]
        The chunk of members.
    not_found : list[snowflake]
        An array of invalid requested guild members.
    presences : list[:class:`disca.types.user.Presence`]
...
class GuildMemberAdd(GatewayEvent):
    ...
    Attributes
    ----------
    member : :class:`disca.types.guild.GuildMember`
...
class GuildRoleCreate(GatewayEvent):
    ...
    role : :class:`disca.types.guild.Role`
...
class MessageCreate(GatewayEvent):
    ...
    Attributes
    ----------
    message : :class:`disca.types.message.Message`
...
class PresenceUpdate(GatewayEvent):
    ...
    Attributes
    ----------
    presence : :class:`disca.types.user.Presence`
...
class VoiceStateUpdate(GatewayEvent):
    ...
    Attributes
    ----------
    state : :class:`disca.models.voice.VoiceState`
...
class MessageReactionAdd(GatewayEvent):
    ...
    emoji : :class:`disca.types.message.MessageReactionEmoji`
