...
from disca.util.emitter import Priority
from disca.util.logging import LoggingClass
from disca.bot.command import Command, CommandError


# Contains a list of classes which will be excluded when auto discavering plugins
...
class Plugin(LoggingClass, PluginDeco):
    ...
    def register_command(self, func, *args, **kwargs):
        ...
        func : function
            The function to be registered.
        args
            Arguments to pass onto the :class:`disca.bot.command.Command` object.
        kwargs
            Keyword arguments to pass onto the :class:`disca.bot.command.Command`
            object.
        """
