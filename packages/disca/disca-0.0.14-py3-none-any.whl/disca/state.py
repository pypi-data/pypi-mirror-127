...
from disca.types.base import UNSET
from disca.util.config import Config
from disca.util.string import underscore
from disca.util.hashmap import HashMap, DefaultHashMap
...
class State(object):
    ...
    def on_guild_delete(self, event):
        ...
        if event.id in self.voice_clients:
            self.voice_clients[event.id].discannect()
    ...
    def on_voice_state_update(self, event):
        # Existing connection, we are either moving channels or discannecting
