...
from disca.api.http import Routes, HTTPClient, to_bytes
from disca.util.functional import optional
from disca.util.logging import LoggingClass
from disca.util.sanitize import S
from disca.types.user import User
from disca.types.message import Message
from disca.types.oauth import Application, Connection
from disca.types.guild import (
    Guild, GuildMember, GuildBan, GuildEmbed, PruneCount, Role, GuildEmoji,
    AuditLogEntry, Integration,
)
from disca.types.channel import Channel
from disca.types.invite import Invite
from disca.types.voice import VoiceRegion
from disca.types.webhook import Webhook
...
class APIClient(LoggingClass):
    """
    An abstraction over a :class:`disca.api.http.HTTPClient`, which composes
    ...
    token : str
        ...
        HTTP requests.
    client : Optional[:class:`disca.client.Client`]
    ...
    http : :class:`disca.http.HTTPClient`
