...
from disca.state import State, StateConfig
from disca.api.client import APIClient
from disca.gateway.client import GatewayClient
from disca.gateway.packets import OPCode
from disca.types.user import Status, Game
from disca.util.config import Config
from disca.util.emitter import Emitter
from disca.util.logging import LoggingClass
from disca.util.backdoor import DiscoBackdoorServer
...
class ClientConfig(Config):
    ...
    token : str
        ...
        `disca.util.token.is_valid_token` function.
    shard_id : int
...
class Client(LoggingClass):
    ...
    (`disca.api.client.APIClient`) and the realtime gateway API
    (`disca.gateway.client.GatewayClient`).
