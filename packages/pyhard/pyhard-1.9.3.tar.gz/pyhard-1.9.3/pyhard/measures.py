...
class ClassificationMeasures(Measures):
    ...
    :param target_col: name of the column that contains the labels of the instances (default None - uses the
        last column)
    ...
    def __init__(self, data: pd.DataFrame, ccp_alpha=None, target_col=None):
