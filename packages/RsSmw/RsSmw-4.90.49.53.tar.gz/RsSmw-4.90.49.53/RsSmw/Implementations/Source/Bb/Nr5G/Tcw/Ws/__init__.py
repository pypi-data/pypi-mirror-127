...
class Ws:
	"""Ws commands group definition. 29 total commands, 5 Sub-groups, 20 group commands"""
	...
	def get_trequire(self) -> enums.TestRequirment:
		...
		No command help available \n
			:return: test_requirement: No help available
		"""
	...
	def set_trequire(self, test_requirement: enums.TestRequirment) -> None:
		...
		No command help available \n
			:param test_requirement: No help available
		"""
	...
	def get_vdrf(self) -> int:
		...
		No command help available \n
			:return: virtual_dl_rf: No help available
		"""
	...
	def set_vdrf(self, virtual_dl_rf: int) -> None:
		...
		No command help available \n
			:param virtual_dl_rf: No help available
		"""
