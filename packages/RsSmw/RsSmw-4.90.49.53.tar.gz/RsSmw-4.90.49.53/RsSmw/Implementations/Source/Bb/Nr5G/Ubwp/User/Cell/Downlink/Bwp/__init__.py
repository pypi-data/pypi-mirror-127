...
class Bwp:
	"""Bwp commands group definition. 153 total commands, 19 Sub-groups, 0 group commands
	...
	@property
	def pdsch(self):
		"""pdsch commands group. 24 Sub-classes, 0 commands."""
	...
	@property
	def rmc(self):
		"""rmc commands group. 4 Sub-classes, 0 commands."""
