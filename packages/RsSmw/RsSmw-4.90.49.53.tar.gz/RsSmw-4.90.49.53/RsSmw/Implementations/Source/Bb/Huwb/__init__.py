...
class Huwb:
	"""Huwb commands group definition. 126 total commands, 12 Sub-groups, 11 group commands"""
	...
	def get_iinterval(self) -> float:
		...
		Sets the time of the interval separating two frames. \n
			:return: iinterval: float Range: 0 to 10000, Unit: µs
		"""
	...
	def set_iinterval(self, iinterval: float) -> None:
		...
		Sets the time of the interval separating two frames. \n
			:param iinterval: float Range: 0 to 10000, Unit: µs
		"""
