...
class Efrontend:
	"""Efrontend commands group definition. 29 total commands, 9 Sub-groups, 9 group commands"""
	...
	def get_cmode(self) -> enums.All:
		...
		Sets the mode of control connection betweenR&S SMW and external frontend. \n
			:return: fe_conn_mode: AUTO| LOCK| RXTX AUTO The lock of the communication channel is established automatically. LOCK The lock of the communication channel is fixed. RXTX Simultaneous Rx/Tx operation mode.
		"""
	...
	def set_cmode(self, fe_conn_mode: enums.All) -> None:
		...
		Sets the mode of control connection betweenR&S SMW and external frontend. \n
			:param fe_conn_mode: AUTO| LOCK| RXTX AUTO The lock of the communication channel is established automatically. LOCK The lock of the communication channel is fixed. RXTX Simultaneous Rx/Tx operation mode.
		"""
	...
	def get_rf_connector(self) -> enums.FenUmbRfCon:
		...
		Sets the active RF output connector at the connected RF frontend. \n
			:return: fe_output_path: NONE| RFA| RFB| RFC| RFD
		"""
	...
	def set_rf_connector(self, fe_output_path: enums.FenUmbRfCon) -> None:
		...
		Sets the active RF output connector at the connected RF frontend. \n
			:param fe_output_path: NONE| RFA| RFB| RFC| RFD
		"""
