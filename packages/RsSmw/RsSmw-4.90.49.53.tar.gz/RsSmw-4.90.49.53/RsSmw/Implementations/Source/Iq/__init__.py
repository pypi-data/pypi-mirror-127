...
class Iq:
	"""Iq commands group definition. 213 total commands, 5 Sub-groups, 5 group commands"""
	...
	def get_wb_state(self) -> bool:
		...
		Activates I/Q wideband mode. This setting automatically optimizes the settings for wideband modulation signals (> 5 MHz,
		State ON) . \n
			:return: wb_state: 0| 1| OFF| ON *RST: 0 (R&S SMW-B10) / 1 (R&S SMW-B9)
		"""
	...
	def set_wb_state(self, wb_state: bool) -> None:
		...
		Activates I/Q wideband mode. This setting automatically optimizes the settings for wideband modulation signals (> 5 MHz,
		State ON) . \n
			:param wb_state: 0| 1| OFF| ON *RST: 0 (R&S SMW-B10) / 1 (R&S SMW-B9)
		"""
