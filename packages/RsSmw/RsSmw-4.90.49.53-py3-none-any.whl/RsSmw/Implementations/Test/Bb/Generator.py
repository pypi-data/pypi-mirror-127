...
class Generator:
	...
	def get_source(self) -> enums.TestBbGenIqSour:
		...
		Selects the test signal source. \n
			:return: iq_source: SINE| CONStant| ARB SINE Generates a sine waveform. To determine the frequency, use command method RsSmw.Test.Bb.Generator.frequency. CONStant Uses a constant I/Q test signal. ARB Selects a signal generated generated by the ARB.
		"""
	...
	def set_source(self, iq_source: enums.TestBbGenIqSour) -> None:
		...
		Selects the test signal source. \n
			:param iq_source: SINE| CONStant| ARB SINE Generates a sine waveform. To determine the frequency, use command method RsSmw.Test.Bb.Generator.frequency. CONStant Uses a constant I/Q test signal. ARB Selects a signal generated generated by the ARB.
		"""
