...
class Alloc:
	"""Alloc commands group definition. 391 total commands, 30 Sub-groups, 0 group commands
	...
	@property
	def cs(self):
		"""cs commands group. 11 Sub-classes, 0 commands."""
	...
	@property
	def cw(self):
		"""cw commands group. 5 Sub-classes, 0 commands."""
