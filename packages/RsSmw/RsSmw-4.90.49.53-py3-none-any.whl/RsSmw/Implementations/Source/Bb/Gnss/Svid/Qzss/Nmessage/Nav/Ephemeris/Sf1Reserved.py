...
class Sf1Reserved:
	...
	def set(self, subfr_1_reserved: int, satelliteSvid=repcap.SatelliteSvid.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.svid.qzss.nmessage.nav.ephemeris.sf1Reserved.set(subfr_1_reserved = 1, satelliteSvid = repcap.SatelliteSvid.Default) \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:SVID{satelliteSvid_cmd_val}:QZSS:NMESsage:NAV:EPHemeris:SF1Reserved {param}')
