...
class Fconfig:
	"""Fconfig commands group definition. 19 total commands, 3 Sub-groups, 14 group commands"""
	...
	def get_mdl(self) -> enums.HrpUwbMaxDataLength:
		...
		No command help available \n
			:return: max_data_len: No help available
		"""
	...
	def set_mdl(self, max_data_len: enums.HrpUwbMaxDataLength) -> None:
		...
		No command help available \n
			:param max_data_len: No help available
		"""
	...
	def get_mfl(self) -> enums.HrpUwbMacFcsLength:
		...
		No command help available \n
			:return: mac_fcs_len: No help available
		"""
	...
	def set_mfl(self, mac_fcs_len: enums.HrpUwbMacFcsLength) -> None:
		...
		No command help available \n
			:param mac_fcs_len: No help available
		"""
