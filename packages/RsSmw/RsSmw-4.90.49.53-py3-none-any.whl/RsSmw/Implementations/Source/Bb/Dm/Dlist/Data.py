...
class Data:
	...
	def set_append(self, bits: List[str]) -> None:
		...
		like for example data lists that has just been created. Use the command BB:DM:DLISt:DATA first and enter modulation data
		in the list. *RST has no effect on data lists. \n
