...
class SymbolRate:
	...
	def get_source(self) -> enums.BbinSampRateMode:
		...
		Selects whether the sample rate is estimated based on the digital input signal or is a user-defined value. \n
			:return: source: DIN | HSDin | USER USER Enabled for BBIN:DIGital:INTerfaceDIN. Set the value with BBIN. DIN Enabled for BBIN:DIGital:SOURceCODER1|CODER2. Estimates the sample rate based on the digital input signal. HSDin Enabled for BBIN:DIGital:INTerfaceHSDin. *RST: USER (R&S SMW-B10) /HSDin (R&S SMW-B9)
		"""
	...
	def set_source(self, source: enums.BbinSampRateMode) -> None:
		...
		Selects whether the sample rate is estimated based on the digital input signal or is a user-defined value. \n
			:param source: DIN | HSDin | USER USER Enabled for BBIN:DIGital:INTerfaceDIN. Set the value with BBIN. DIN Enabled for BBIN:DIGital:SOURceCODER1|CODER2. Estimates the sample rate based on the digital input signal. HSDin Enabled for BBIN:DIGital:INTerfaceHSDin. *RST: USER (R&S SMW-B10) /HSDin (R&S SMW-B9)
		"""
	...
	def get_actual(self) -> float:
		...
		Sets the sample rate of the external digital baseband signal. \n
			:return: actual: float Range: 25E6 to max (depends on the installed options) max = 200E6 (R&S SMW-B10) max = 250E6 (R&S SMW-B9) max = 100E6|200E6 (for BBIN:DIGital:SOURceFADER1|FADER2) See also 'Supported Digital Interfaces Depending on the System Configuration'.
		"""
	...
	def set_actual(self, actual: float) -> None:
		...
		Sets the sample rate of the external digital baseband signal. \n
			:param actual: float Range: 25E6 to max (depends on the installed options) max = 200E6 (R&S SMW-B10) max = 250E6 (R&S SMW-B9) max = 100E6|200E6 (for BBIN:DIGital:SOURceFADER1|FADER2) See also 'Supported Digital Interfaces Depending on the System Configuration'.
		"""
