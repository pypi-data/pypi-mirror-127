...
class Measurement:
	...
	def get_state(self) -> bool:
		...
		Query the calculation status of the PEP and Level values. \n
			:return: measure_validity: 0| 1| OFF| ON 1|ON PEP and Level output values are valid 0|OFF PEP and Level output values are in calculation In the user interface, you recognize this state if '---.--' is indicated.
		"""
