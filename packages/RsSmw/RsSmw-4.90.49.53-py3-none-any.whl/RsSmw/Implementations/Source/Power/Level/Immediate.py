...
class Immediate:
	...
	def get_offset(self) -> float:
		...
		use the command [:​SOURce<hw>]:​POWer[:​LEVel][:​IMMediate][:​AMPLitude]. See 'Displayed RF Frequency and Level Values
		with Downstream Instruments'. Note: The level offset also affects the RF level sweep. \n
