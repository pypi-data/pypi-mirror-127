...
class Config:
	"""Config commands group definition. 2 total commands, 1 Sub-groups, 1 group commands"""
	...
	def get_select(self) -> str:
		...
		Loads the selected file from the default or the specified directory. Loaded are files with extension *.xxx.
