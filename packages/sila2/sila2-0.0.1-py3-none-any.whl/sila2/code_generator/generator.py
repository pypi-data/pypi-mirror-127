...
class CodeGenerator:
    ...
    @staticmethod
    def reformat_files(path: str) -> None:
        os.system(f"{sys.executable} -m isort --line-length 120 --quiet --profile black {path}")
        os.system(f"{sys.executable} -m black --line-length 120 --quiet {path}")
    ...
    def generate_errors(self, out_filename: str) -> None:
        ...
        CodeGenerator._generate_file(out_filename, content)

    def generate_init(self, out_filename: str) -> None:
        content = self.template_env.get_template("feature/init").render(
    ...
    def generate_base(self, out_filename: str) -> None:
        ...
        content = self.template_env.get_template("feature/base").render(
            feature=self.feature,
            imports=imports,
            metadata=metadata,
