...
class FBICrimeData:
    ...
    def national_arrest_count(self, offense: str, category: str, start_year: int, end_year: int, age_category: Optional[str] = None) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'nationalArrestCount', { 'offense': offense, 'category': category, 'startYear': start_year, 'endYear': end_year, 'ageCategory': age_category })
        return dict(res)
    def national_offense_count(self, offense: str, category: str) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'nationalOffenseCount', { 'offense': offense, 'category': category })
        return dict(res)
    def national_supplemental_count(self, offense: str, category: str, start_year: int, end_year: int) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'nationalSupplementalCount', { 'offense': offense, 'category': category, 'startYear': start_year, 'endYear': end_year })
        return dict(res)
    def national_victim_count(self, offense: str, category: str) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'nationalVictimCount', { 'offense': offense, 'category': category })
        return dict(res)
    def regional_arrest_count(self, region: str, offense: str, category: str, start_year: int, end_year: int) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'regionalArrestCount', { 'region': region, 'offense': offense, 'category': category, 'startYear': start_year, 'endYear': end_year })
        return dict(res)
    def regional_offense_count(self, region: str, offense: str, category: str) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'regionalOffenseCount', { 'region': region, 'offense': offense, 'category': category })
        return dict(res)
    def regional_victim_count(self, region: str, offense: str, category: str) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'regionalVictimCount', { 'region': region, 'offense': offense, 'category': category })
        return dict(res)
    def state_arrest_count(self, state: str, category: str, start_year: int, end_year: int) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'stateArrestCount', { 'state': state, 'category': category, 'startYear': start_year, 'endYear': end_year })
        return dict(res)
    def state_offense_count(self, state: str, offense: str, category: str) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'stateOffenseCount', { 'state': state, 'offense': offense, 'category': category })
        return dict(res)
    def state_supplemental_count(self, state: str, offense: str, category: str, start_year: int, end_year: int) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'stateSupplementalCount', { 'state': state, 'offense': offense, 'category': category, 'startYear': start_year, 'endYear': end_year })
        return dict(res)
    def state_victim_count(self, state: str, offense: str, category: str) -> dict:
        ...
        '''
        res = self._client._call('FBICrimeData', 'stateVictimCount', { 'state': state, 'offense': offense, 'category': category })
        return dict(res)
class Genius:
    '''
    The Genius service provides access to the Genius API, the world's
    ...
    def get_artist(self, id: int) -> List[dict]:
        ...
        :returns: 
        '''
        res = self._client._call('Genius', 'getArtist', { 'ID': id })
    ...
    def get_song(self, id: int) -> List[dict]:
        ...
        :returns: 
        '''
        res = self._client._call('Genius', 'getSong', { 'ID': id })
        return _common.vectorize(dict)(res)
    def get_song_lyrics(self, id: int) -> str:
        ...
        :returns: 
        '''
        res = self._client._call('Genius', 'getSongLyrics', { 'ID': id })
        return str(res)
    def get_songs_by_artist(self, id: int) -> List[dict]:
        ...
        :returns: 
        '''
        res = self._client._call('Genius', 'getSongsByArtist', { 'ID': id })
        return _common.vectorize(dict)(res)
    def search_songs(self, query: str) -> List[dict]:
        ...
        :returns: 
        '''
        res = self._client._call('Genius', 'searchSongs', { 'query': query })
        return _common.vectorize(dict)(res)
class Geolocation:
    '''
    The Geolocation Service provides access to the Google Places API and geocoding capabilities.
    ...
    def nearby_search(self, latitude: float, longitude: float, keyword: Optional[str] = None, radius: Optional[float] = None) -> List[dict]:
        ...
        '''
        res = self._client._call('Geolocation', 'nearbySearch', { 'latitude': latitude, 'longitude': longitude, 'keyword': keyword, 'radius': radius })
        return _common.vectorize(dict)(res)
