...
class RoxieInputBuilder:
    ...
    def prepare_data_file_str(self) -> str:
        ...
        # Add LAYER
        RoxieInputBuilder.append_to_outputs(outputs, 'LAYER', self.layer, suffix=' /')
        return '\n'.join(outputs)
    ...
    @staticmethod
    def append_to_outputs(outputs, keyword, df, suffix='') -> None:
        ...
        """
        outputs.append('')
        outputs.append(RoxieAPI.convert_bottom_header_table_to_str(df, keyword, suffix))
