...
class TestAnsysInputBuilder(unittest.TestCase):
    ...
    def test_update_ansys_input_template_15T_mech(self):
        # arrange
        template_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech.template')
        output_dir = create_resources_file_path('resources/tool_adapters/ansys/')
        index = 0
        ...
        # assert
        inp_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech_0.inp')
        inp_ref_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech_0_ref.inp')
    ...
    def test_update_ansys_input_template_15T_mech_post_roxie(self):
        # arrange
        template_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech_post_roxie.template')
        output_dir = create_resources_file_path('resources/tool_adapters/ansys/')
        index = 0
        ...
        # assert
        inp_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech_post_roxie_0.inp')
        inp_ref_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech_post_roxie_0_ref.inp')
    ...
    def test_update_ansys_input_template_15T_mech_solu(self):
        # arrange
        template_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech_solu.template')
        output_dir = create_resources_file_path('resources/tool_adapters/ansys/')
        index = 0
        ...
        # assert
        inp_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech_solu_0.inp')
        inp_ref_path = create_resources_file_path('resources/tool_adapters/ansys/15T_mech_solu_0_ref.inp')
