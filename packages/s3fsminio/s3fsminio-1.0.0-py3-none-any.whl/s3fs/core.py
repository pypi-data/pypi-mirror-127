...
class S3FileSystem(AsyncFileSystem):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if "AWS_ACCESS_KEY_ID" in os.environ and "AWS_SECRET_ACCESS_KEY" in os.environ and "S3_ENDPOINT" in os.environ:
            self.client_kwargs = {"aws_access_key_id": os.environ["AWS_ACCESS_KEY_ID"], "aws_secret_access_key": os.environ["AWS_SECRET_ACCESS_KEY"], "endpoint_url": os.environ["S3_ENDPOINT"], }
