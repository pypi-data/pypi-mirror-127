...
# --
  ...
  def patch_with_flat_dict(self, flat_patches: Dict) -> Optional[KR]:
    def modify(raw):
      for deep_key, value in flat_patches.items():
        utils.deep_setattr(raw, deep_key, value)
    return self.patch(modify)
