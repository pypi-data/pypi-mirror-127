...
class model_sampler_gpu(object):
    ...
    def crt(self, Xt_to_t1_t, p, dtype='dense'):
    ...
    def Sample_Phi(self, WSZS_t, Eta_t):
    ...
    def Sample_Theta(self, Xt_to_t1_t, c_j_t1, p_j_t, shape):
    ...
    # def conv_multi_sample(file, row, col, val, w1_nk1, d1_k1, _setting):
    #
    #     _structure = _setting._structure
    #
    ...
    #
    #     Batch_Para = np.array([_setting.K, _structure.K_S1, _structure.K_S2, _structure.K_S3, _structure.K_S4, word_total],
