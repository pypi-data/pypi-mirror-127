...
class sms:
    ...
    def get_report_by_id(sms_id,Token=''):
    ...
    def get_report_by_bachkey(PageID='',BatchKey='',Token=''):
    ...
    def get_receive_message_by_date(StartDate_SHAMSI='',EndDate_SHAMSI='',RowsPerPage='10',RequestedPageNumber='1',Token=''):
