...
api_key = '33ed171a8b484c03a6645e4cb966a49d'
...
create_grid('weather', 'daily', 'tn', '20200801', './tmp/output', cell_size=1000, elev_correction=lambda x: x * -0.0065, ignore_warped_dem_cache=False)
