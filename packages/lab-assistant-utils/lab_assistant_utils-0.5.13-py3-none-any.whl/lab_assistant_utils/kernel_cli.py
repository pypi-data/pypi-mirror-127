...
UID = int(os.environ.get('UID').encode('utf-8'))
GID = int(os.environ.get('GID').encode('utf-8'))
DOCKER_GID = int(os.environ.get('DOCKER_GID').encode('utf-8'))
