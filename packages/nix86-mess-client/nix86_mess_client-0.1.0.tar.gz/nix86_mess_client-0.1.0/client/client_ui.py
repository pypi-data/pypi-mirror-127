...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.label_contacts.setGeometry(QtCore.QRect(10, 10, 121, 16))
        ...
        self.btn_clear.setGeometry(QtCore.QRect(432, 450, 131, 31))
