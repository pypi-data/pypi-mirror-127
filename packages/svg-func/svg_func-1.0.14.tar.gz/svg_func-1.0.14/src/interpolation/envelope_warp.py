...
if __name__ == "__main__":
    ...
    svg,xml = main(svgpath=r"C:\Users\25790\Downloads\1637228907.184102923296_path.svg",c_svg='https://oss.looodesign.com/model_test/bg/templateSvg621_2.svg',file_path=r'C:\Users\25790\Downloads\result.svg', filetype='path',csvg_filetype='url',mode='random')
    # print(time.time()-st1)
