...
def main(svgpath=None,sample_n=10,filetype='path',c_svg=None,arch_per=0.3,pos='up',fix='top', mode='arch',file_path = None):
    ...
    if 'arch' in mode:
        ...
        s_points, target_tensor = simpleget_points_insvg(c_svg,filetype=filetype)
...
if __name__ == "__main__":
    ...
    svg,xml = main(svgpath=r"C:\Users\25790\Downloads\1637228907.184102923296_path.svg",c_svg='https://oss.looodesign.com/model_test/bg/templateSvg621_2.svg',file_path=r'C:\Users\25790\Downloads\result.svg', filetype='path',mode='random')
    # print(time.time()-st1)
