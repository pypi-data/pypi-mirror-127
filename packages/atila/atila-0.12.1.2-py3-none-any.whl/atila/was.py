...
class WebSocketPipedProcess (piped_process.PipedProcess):
    def __init__ (self, websocket, command):
    ...
    def log (self, line, *args):
        if not self.websocket:
            return
        self.websocket.send (line.strip ())
...
class WAS (wsgiappservice.AsyncServicableWAS):
    ...
    def WebSocketPipedProcess (self, command):
        return WebSocketPipedProcess (self.websocket, command)
