...
class cmnConfig:
    ...
    def getConfig(self, scriptPath: str, configFileDir: str = ''):
        ...
        # スクリプトファイルの絶対パス取得
        iniScriptPathAbs = pathlib.Path(os.path.abspath(os.path.dirname(scriptPath)))
        # iniファイルパス取得
        ...
        # 各設定値をインスタンス変数にセット
        self.setInstanceMemberValues(config_ini)
        
    def setInstanceMemberValues(self, _config_ini: list):
        ...
        self.setConfigValue('LogFileName',_config_ini,'DEFAULT','LOGFILE_NAME', str)
        self.setConfigValue('LogFolderName',_config_ini,'DEFAULT','LOGFOLDER_NAME', str)
        self.setConfigValue('LogFormat',_config_ini,'DEFAULT','LOGFORMAT', str)
        self.setConfigValue('LogLevel',_config_ini,'DEFAULT','LOGLEVEL', int)
